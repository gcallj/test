...
Generated: overfitting_diagnostic.py sobre 59 attempts (25 promoted) + 203 sweeps

## Executive summary

- Incumbent atual: fit=19.59, WR=66.7%, alpha=-8.08%, trades=34
- Historico: 59 attempts, 25 promoted (42.4%)

## 1. Wilson 95% CI para WR

- **WR observado**: 0.6667 (66.67%), com n=34 trades
- **Wilson 95% IC**: [0.4986, 0.8009] = [49.86%, 80.09%]
- **Veredito**: NAO significativamente melhor que 50% (IC cobre baseline)
- **Interpretacao**: com n=34 trades, o IC tem largura 30.23pp — amostra pequena, alta variancia
...
| 67 | 2026-04-20T22:17:18 | 23.71 | -8.17% |
| 135 | 2026-04-21T19:52:00 | 25.53 | -7.89% |
| 202 | 2026-04-20T15:07:48 | 23.64 | -8.23% |
...
- **Ganho medio de fit por sweep**: +0.4893
- **Desvio padrao dos deltas**: 25.7655
