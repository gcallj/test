...
_Generated: 2026-05-21T14:55:56+00:00_
...
- Total sweeps seen: **707**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **16.6%** (over 731 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 120 | 0 | 0 | 0 |
| `vote_threshold_long` | 118 | 0 | 0 | 0 |
| `score_strength_scaling` | 118 | 0 | 0 | 0 |
| `stop_atr_mult` | 117 | 0 | 0 | 0 |
| `min_signal_strength` | 117 | 0 | 0 | 0 |
| `entry_confirmation_days` | 116 | 0 | 0 | 0 |
| `volume_confirm_mode` | 116 | 0 | 1 | 0 |
| `time_stop_bars` | 116 | 0 | 0 | 0 |
| `ma_filter_period` | 116 | 0 | 1 | 0 |
| `vote_threshold_short` | 115 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 115 | 0 | 0 | 0 |
| `z_threshold` | 114 | 0 | 0 | 0 |
| `entry_aggressiveness` | 97 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 127 | 17% | 1 |
| `score_percentile_trigger` | 20 | 120 | 17% | 0 |
| `momentum_confirm_days` | 18 | 121 | 15% | 0 |
| `partial_take_level` | 8 | 127 | 6% | 1 |
| `signal_ema_span` | 7 | 119 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 119 | 5% | 0 |
| `entry_score_threshold` | 6 | 129 | 5% | 0 |
| `regime_threshold` | 6 | 136 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 116 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 126 | 4% | 0 |
| `ma_filter_mode` | 5 | 126 | 4% | 0 |
| `partial_take_pct` | 4 | 120 | 3% | 0 |
| `support_broken_gate` | 2 | 95 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 115 | 2% | 0 |
| `trailing_stop_mode` | 2 | 117 | 2% | 0 |
| `partial_take_pct_2` | 2 | 119 | 2% | 0 |
| `stop_tighten_factor` | 2 | 122 | 2% | 0 |
| `partial_take_level_2` | 2 | 122 | 2% | 0 |
| `resistance_overext_gate` | 1 | 95 | 1% | 0 |
| `vol_regime_mode` | 1 | 118 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T14:55:56+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
