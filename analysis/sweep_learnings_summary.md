...
_Generated: 2026-07-23T21:22:35+00:00_
...
- Total sweeps seen: **1490**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.0%** (over 1514 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 251 | 0 | 0 | 0 |
| `vote_threshold_long` | 250 | 0 | 0 | 0 |
| `score_strength_scaling` | 250 | 0 | 0 | 0 |
| `min_signal_strength` | 249 | 0 | 0 | 0 |
| `entry_confirmation_days` | 248 | 0 | 0 | 0 |
| `volume_confirm_mode` | 247 | 0 | 1 | 0 |
| `vote_threshold_short` | 247 | 0 | 1 | 0 |
| `ma_filter_period` | 247 | 0 | 1 | 0 |
| `time_stop_bars` | 246 | 0 | 0 | 0 |
| `z_threshold` | 246 | 0 | 0 | 0 |
| `stop_atr_mult` | 245 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 243 | 0 | 0 | 0 |
| `entry_aggressiveness` | 229 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 257 | 8% | 1 |
| `score_percentile_trigger` | 20 | 252 | 8% | 0 |
| `momentum_confirm_days` | 18 | 252 | 7% | 0 |
| `partial_take_level` | 8 | 258 | 3% | 1 |
| `signal_ema_span` | 7 | 251 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 247 | 2% | 0 |
| `entry_score_threshold` | 6 | 261 | 2% | 0 |
| `regime_threshold` | 6 | 267 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 244 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 257 | 2% | 0 |
| `ma_filter_mode` | 5 | 257 | 2% | 0 |
| `partial_take_pct` | 4 | 251 | 2% | 0 |
| `support_broken_gate` | 2 | 226 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 247 | 1% | 0 |
| `trailing_stop_mode` | 2 | 248 | 1% | 0 |
| `stop_tighten_factor` | 2 | 250 | 1% | 0 |
| `partial_take_pct_2` | 2 | 250 | 1% | 0 |
| `partial_take_level_2` | 2 | 253 | 1% | 0 |
| `resistance_overext_gate` | 1 | 226 | 0% | 0 |
| `vol_regime_mode` | 1 | 249 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-07-23T21:22:34+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
