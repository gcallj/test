...
_Generated: 2026-09-07T20:04:09+00:00_
...
- Total sweeps seen: **1768**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **6.8%** (over 1792 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 297 | 0 | 0 | 0 |
| `vote_threshold_long` | 297 | 0 | 0 | 0 |
| `score_strength_scaling` | 297 | 0 | 0 | 0 |
| `min_signal_strength` | 296 | 0 | 0 | 0 |
| `entry_confirmation_days` | 295 | 0 | 0 | 0 |
| `vote_threshold_short` | 294 | 0 | 1 | 0 |
| `time_stop_bars` | 293 | 0 | 0 | 0 |
| `z_threshold` | 293 | 0 | 0 | 0 |
| `volume_confirm_mode` | 293 | 0 | 1 | 0 |
| `ma_filter_period` | 293 | 0 | 1 | 0 |
| `stop_atr_mult` | 291 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 289 | 0 | 0 | 0 |
| `entry_aggressiveness` | 276 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 304 | 7% | 1 |
| `score_percentile_trigger` | 20 | 299 | 7% | 0 |
| `momentum_confirm_days` | 18 | 298 | 6% | 0 |
| `partial_take_level` | 8 | 304 | 3% | 1 |
| `signal_ema_span` | 7 | 298 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 293 | 2% | 0 |
| `entry_score_threshold` | 6 | 308 | 2% | 0 |
| `regime_threshold` | 6 | 313 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 290 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 303 | 2% | 0 |
| `ma_filter_mode` | 5 | 303 | 2% | 0 |
| `partial_take_pct` | 4 | 297 | 1% | 0 |
| `support_broken_gate` | 2 | 272 | 1% | 0 |
| `trailing_stop_mode` | 2 | 294 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 294 | 1% | 0 |
| `stop_tighten_factor` | 2 | 296 | 1% | 0 |
| `partial_take_pct_2` | 2 | 296 | 1% | 0 |
| `partial_take_level_2` | 2 | 299 | 1% | 0 |
| `resistance_overext_gate` | 1 | 272 | 0% | 0 |
| `vol_regime_mode` | 1 | 295 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-09-07T20:04:08+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
