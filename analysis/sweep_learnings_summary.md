...
_Generated: 2026-05-20T02:30:10+00:00_
...
- Total sweeps seen: **527**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **22.0%** (over 551 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 90 | 0 | 0 | 0 |
| `vote_threshold_long` | 88 | 0 | 0 | 0 |
| `score_strength_scaling` | 88 | 0 | 0 | 0 |
| `min_signal_strength` | 87 | 0 | 0 | 0 |
| `stop_atr_mult` | 87 | 0 | 0 | 0 |
| `entry_confirmation_days` | 86 | 0 | 0 | 0 |
| `volume_confirm_mode` | 86 | 0 | 1 | 0 |
| `time_stop_bars` | 86 | 0 | 0 | 0 |
| `ma_filter_period` | 86 | 0 | 1 | 0 |
| `vote_threshold_short` | 85 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 85 | 0 | 0 | 0 |
| `z_threshold` | 84 | 0 | 0 | 0 |
| `entry_aggressiveness` | 67 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 97 | 22% | 1 |
| `score_percentile_trigger` | 20 | 90 | 22% | 0 |
| `momentum_confirm_days` | 18 | 91 | 20% | 0 |
| `partial_take_level` | 8 | 97 | 8% | 1 |
| `signal_ema_span` | 7 | 89 | 8% | 0 |
| `max_loss_per_trade_pct` | 6 | 89 | 7% | 0 |
| `entry_score_threshold` | 6 | 99 | 6% | 0 |
| `regime_threshold` | 6 | 106 | 6% | 1 |
| `equity_drawdown_stop_pct` | 5 | 86 | 6% | 0 |
| `volatility_filter_percentile` | 5 | 96 | 5% | 0 |
| `ma_filter_mode` | 5 | 96 | 5% | 0 |
| `partial_take_pct` | 4 | 90 | 4% | 0 |
| `support_broken_gate` | 2 | 65 | 3% | 0 |
| `entry_discount_atr_frac` | 2 | 85 | 2% | 0 |
| `trailing_stop_mode` | 2 | 87 | 2% | 0 |
| `partial_take_pct_2` | 2 | 89 | 2% | 0 |
| `stop_tighten_factor` | 2 | 92 | 2% | 0 |
| `partial_take_level_2` | 2 | 92 | 2% | 0 |
| `resistance_overext_gate` | 1 | 65 | 2% | 0 |
| `vol_regime_mode` | 1 | 88 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T02:30:10+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
