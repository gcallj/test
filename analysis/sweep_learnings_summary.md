...
_Generated: 2026-05-23T01:49:21+00:00_
...
- Total sweeps seen: **893**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **13.2%** (over 917 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 151 | 0 | 0 | 0 |
| `vote_threshold_long` | 149 | 0 | 0 | 0 |
| `score_strength_scaling` | 149 | 0 | 0 | 0 |
| `stop_atr_mult` | 148 | 0 | 0 | 0 |
| `min_signal_strength` | 148 | 0 | 0 | 0 |
| `entry_confirmation_days` | 147 | 0 | 0 | 0 |
| `volume_confirm_mode` | 147 | 0 | 1 | 0 |
| `time_stop_bars` | 147 | 0 | 0 | 0 |
| `ma_filter_period` | 147 | 0 | 1 | 0 |
| `vote_threshold_short` | 146 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 146 | 0 | 0 | 0 |
| `z_threshold` | 145 | 0 | 0 | 0 |
| `entry_aggressiveness` | 128 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 158 | 13% | 1 |
| `score_percentile_trigger` | 20 | 151 | 13% | 0 |
| `momentum_confirm_days` | 18 | 152 | 12% | 0 |
| `partial_take_level` | 8 | 158 | 5% | 1 |
| `signal_ema_span` | 7 | 150 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 150 | 4% | 0 |
| `entry_score_threshold` | 6 | 160 | 4% | 0 |
| `regime_threshold` | 6 | 167 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 147 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 157 | 3% | 0 |
| `ma_filter_mode` | 5 | 157 | 3% | 0 |
| `partial_take_pct` | 4 | 151 | 3% | 0 |
| `support_broken_gate` | 2 | 126 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 146 | 1% | 0 |
| `trailing_stop_mode` | 2 | 148 | 1% | 0 |
| `partial_take_pct_2` | 2 | 150 | 1% | 0 |
| `stop_tighten_factor` | 2 | 153 | 1% | 0 |
| `partial_take_level_2` | 2 | 153 | 1% | 0 |
| `resistance_overext_gate` | 1 | 126 | 1% | 0 |
| `vol_regime_mode` | 1 | 149 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T01:49:20+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
