...
_Generated: 2026-08-01T02:49:00+00:00_
...
- Total sweeps seen: **1532**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.8%** (over 1556 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 258 | 0 | 0 | 0 |
| `vote_threshold_long` | 257 | 0 | 0 | 0 |
| `score_strength_scaling` | 257 | 0 | 0 | 0 |
| `min_signal_strength` | 256 | 0 | 0 | 0 |
| `entry_confirmation_days` | 255 | 0 | 0 | 0 |
| `volume_confirm_mode` | 254 | 0 | 1 | 0 |
| `vote_threshold_short` | 254 | 0 | 1 | 0 |
| `ma_filter_period` | 254 | 0 | 1 | 0 |
| `time_stop_bars` | 253 | 0 | 0 | 0 |
| `z_threshold` | 253 | 0 | 0 | 0 |
| `stop_atr_mult` | 252 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 250 | 0 | 0 | 0 |
| `entry_aggressiveness` | 236 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 264 | 8% | 1 |
| `score_percentile_trigger` | 20 | 259 | 8% | 0 |
| `momentum_confirm_days` | 18 | 259 | 7% | 0 |
| `partial_take_level` | 8 | 265 | 3% | 1 |
| `signal_ema_span` | 7 | 258 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 254 | 2% | 0 |
| `entry_score_threshold` | 6 | 268 | 2% | 0 |
| `regime_threshold` | 6 | 274 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 251 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 264 | 2% | 0 |
| `ma_filter_mode` | 5 | 264 | 2% | 0 |
| `partial_take_pct` | 4 | 258 | 2% | 0 |
| `support_broken_gate` | 2 | 233 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 254 | 1% | 0 |
| `trailing_stop_mode` | 2 | 255 | 1% | 0 |
| `stop_tighten_factor` | 2 | 257 | 1% | 0 |
| `partial_take_pct_2` | 2 | 257 | 1% | 0 |
| `partial_take_level_2` | 2 | 260 | 1% | 0 |
| `resistance_overext_gate` | 1 | 233 | 0% | 0 |
| `vol_regime_mode` | 1 | 256 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-01T02:48:59+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
