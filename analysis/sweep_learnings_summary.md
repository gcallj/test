...
_Generated: 2026-08-31T19:22:25+00:00_
...
- Total sweeps seen: **1696**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.0%** (over 1720 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 285 | 0 | 0 | 0 |
| `vote_threshold_long` | 285 | 0 | 0 | 0 |
| `score_strength_scaling` | 285 | 0 | 0 | 0 |
| `min_signal_strength` | 284 | 0 | 0 | 0 |
| `entry_confirmation_days` | 283 | 0 | 0 | 0 |
| `vote_threshold_short` | 282 | 0 | 1 | 0 |
| `time_stop_bars` | 281 | 0 | 0 | 0 |
| `volume_confirm_mode` | 281 | 0 | 1 | 0 |
| `z_threshold` | 281 | 0 | 0 | 0 |
| `ma_filter_period` | 281 | 0 | 1 | 0 |
| `stop_atr_mult` | 279 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 277 | 0 | 0 | 0 |
| `entry_aggressiveness` | 264 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 292 | 7% | 1 |
| `score_percentile_trigger` | 20 | 287 | 7% | 0 |
| `momentum_confirm_days` | 18 | 286 | 6% | 0 |
| `partial_take_level` | 8 | 292 | 3% | 1 |
| `signal_ema_span` | 7 | 286 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 281 | 2% | 0 |
| `entry_score_threshold` | 6 | 296 | 2% | 0 |
| `regime_threshold` | 6 | 301 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 278 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 291 | 2% | 0 |
| `ma_filter_mode` | 5 | 291 | 2% | 0 |
| `partial_take_pct` | 4 | 285 | 1% | 0 |
| `support_broken_gate` | 2 | 260 | 1% | 0 |
| `trailing_stop_mode` | 2 | 282 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 282 | 1% | 0 |
| `stop_tighten_factor` | 2 | 284 | 1% | 0 |
| `partial_take_pct_2` | 2 | 284 | 1% | 0 |
| `partial_take_level_2` | 2 | 287 | 1% | 0 |
| `resistance_overext_gate` | 1 | 260 | 0% | 0 |
| `vol_regime_mode` | 1 | 283 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-31T19:22:23+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
