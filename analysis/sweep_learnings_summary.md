...
_Generated: 2026-05-20T04:56:57+00:00_
...
- Total sweeps seen: **539**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **21.5%** (over 563 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 92 | 0 | 0 | 0 |
| `vote_threshold_long` | 90 | 0 | 0 | 0 |
| `score_strength_scaling` | 90 | 0 | 0 | 0 |
| `stop_atr_mult` | 89 | 0 | 0 | 0 |
| `min_signal_strength` | 89 | 0 | 0 | 0 |
| `entry_confirmation_days` | 88 | 0 | 0 | 0 |
| `volume_confirm_mode` | 88 | 0 | 1 | 0 |
| `time_stop_bars` | 88 | 0 | 0 | 0 |
| `ma_filter_period` | 88 | 0 | 1 | 0 |
| `vote_threshold_short` | 87 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 87 | 0 | 0 | 0 |
| `z_threshold` | 86 | 0 | 0 | 0 |
| `entry_aggressiveness` | 69 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 99 | 21% | 1 |
| `score_percentile_trigger` | 20 | 92 | 22% | 0 |
| `momentum_confirm_days` | 18 | 93 | 19% | 0 |
| `partial_take_level` | 8 | 99 | 8% | 1 |
| `signal_ema_span` | 7 | 91 | 8% | 0 |
| `max_loss_per_trade_pct` | 6 | 91 | 7% | 0 |
| `entry_score_threshold` | 6 | 101 | 6% | 0 |
| `regime_threshold` | 6 | 108 | 6% | 1 |
| `equity_drawdown_stop_pct` | 5 | 88 | 6% | 0 |
| `volatility_filter_percentile` | 5 | 98 | 5% | 0 |
| `ma_filter_mode` | 5 | 98 | 5% | 0 |
| `partial_take_pct` | 4 | 92 | 4% | 0 |
| `support_broken_gate` | 2 | 67 | 3% | 0 |
| `entry_discount_atr_frac` | 2 | 87 | 2% | 0 |
| `trailing_stop_mode` | 2 | 89 | 2% | 0 |
| `partial_take_pct_2` | 2 | 91 | 2% | 0 |
| `stop_tighten_factor` | 2 | 94 | 2% | 0 |
| `partial_take_level_2` | 2 | 94 | 2% | 0 |
| `resistance_overext_gate` | 1 | 67 | 1% | 0 |
| `vol_regime_mode` | 1 | 90 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T04:56:57+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
