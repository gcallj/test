...
_Generated: 2026-05-22T02:50:41+00:00_
...
- Total sweeps seen: **773**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **15.2%** (over 797 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 131 | 0 | 0 | 0 |
| `vote_threshold_long` | 129 | 0 | 0 | 0 |
| `score_strength_scaling` | 129 | 0 | 0 | 0 |
| `stop_atr_mult` | 128 | 0 | 0 | 0 |
| `min_signal_strength` | 128 | 0 | 0 | 0 |
| `time_stop_bars` | 127 | 0 | 0 | 0 |
| `entry_confirmation_days` | 127 | 0 | 0 | 0 |
| `volume_confirm_mode` | 127 | 0 | 1 | 0 |
| `ma_filter_period` | 127 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 126 | 0 | 0 | 0 |
| `vote_threshold_short` | 126 | 0 | 1 | 0 |
| `z_threshold` | 125 | 0 | 0 | 0 |
| `entry_aggressiveness` | 108 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 138 | 15% | 1 |
| `score_percentile_trigger` | 20 | 131 | 15% | 0 |
| `momentum_confirm_days` | 18 | 132 | 14% | 0 |
| `partial_take_level` | 8 | 138 | 6% | 1 |
| `signal_ema_span` | 7 | 130 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 130 | 5% | 0 |
| `entry_score_threshold` | 6 | 140 | 4% | 0 |
| `regime_threshold` | 6 | 147 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 127 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 137 | 4% | 0 |
| `ma_filter_mode` | 5 | 137 | 4% | 0 |
| `partial_take_pct` | 4 | 131 | 3% | 0 |
| `support_broken_gate` | 2 | 106 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 126 | 2% | 0 |
| `trailing_stop_mode` | 2 | 128 | 2% | 0 |
| `partial_take_pct_2` | 2 | 130 | 2% | 0 |
| `stop_tighten_factor` | 2 | 133 | 2% | 0 |
| `partial_take_level_2` | 2 | 133 | 2% | 0 |
| `resistance_overext_gate` | 1 | 106 | 1% | 0 |
| `vol_regime_mode` | 1 | 129 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-22T02:50:40+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
