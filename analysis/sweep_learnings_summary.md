...
_Generated: 2026-05-23T04:11:50+00:00_
...
- Total sweeps seen: **905**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **13.0%** (over 929 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 153 | 0 | 0 | 0 |
| `vote_threshold_long` | 151 | 0 | 0 | 0 |
| `score_strength_scaling` | 151 | 0 | 0 | 0 |
| `stop_atr_mult` | 150 | 0 | 0 | 0 |
| `min_signal_strength` | 150 | 0 | 0 | 0 |
| `time_stop_bars` | 149 | 0 | 0 | 0 |
| `entry_confirmation_days` | 149 | 0 | 0 | 0 |
| `volume_confirm_mode` | 149 | 0 | 1 | 0 |
| `ma_filter_period` | 149 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 148 | 0 | 0 | 0 |
| `vote_threshold_short` | 148 | 0 | 1 | 0 |
| `z_threshold` | 147 | 0 | 0 | 0 |
| `entry_aggressiveness` | 130 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 160 | 13% | 1 |
| `score_percentile_trigger` | 20 | 153 | 13% | 0 |
| `momentum_confirm_days` | 18 | 154 | 12% | 0 |
| `partial_take_level` | 8 | 160 | 5% | 1 |
| `signal_ema_span` | 7 | 152 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 152 | 4% | 0 |
| `entry_score_threshold` | 6 | 162 | 4% | 0 |
| `regime_threshold` | 6 | 169 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 149 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 159 | 3% | 0 |
| `ma_filter_mode` | 5 | 159 | 3% | 0 |
| `partial_take_pct` | 4 | 153 | 3% | 0 |
| `support_broken_gate` | 2 | 128 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 148 | 1% | 0 |
| `trailing_stop_mode` | 2 | 150 | 1% | 0 |
| `partial_take_pct_2` | 2 | 152 | 1% | 0 |
| `stop_tighten_factor` | 2 | 155 | 1% | 0 |
| `partial_take_level_2` | 2 | 155 | 1% | 0 |
| `resistance_overext_gate` | 1 | 128 | 1% | 0 |
| `vol_regime_mode` | 1 | 151 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T04:11:49+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
