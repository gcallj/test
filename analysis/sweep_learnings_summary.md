...
_Generated: 2026-08-09T07:32:55+00:00_
...
- Total sweeps seen: **1568**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.6%** (over 1592 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 264 | 0 | 0 | 0 |
| `vote_threshold_long` | 263 | 0 | 0 | 0 |
| `score_strength_scaling` | 263 | 0 | 0 | 0 |
| `min_signal_strength` | 262 | 0 | 0 | 0 |
| `entry_confirmation_days` | 261 | 0 | 0 | 0 |
| `volume_confirm_mode` | 260 | 0 | 1 | 0 |
| `vote_threshold_short` | 260 | 0 | 1 | 0 |
| `ma_filter_period` | 260 | 0 | 1 | 0 |
| `time_stop_bars` | 259 | 0 | 0 | 0 |
| `z_threshold` | 259 | 0 | 0 | 0 |
| `stop_atr_mult` | 258 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 256 | 0 | 0 | 0 |
| `entry_aggressiveness` | 242 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 270 | 8% | 1 |
| `score_percentile_trigger` | 20 | 265 | 8% | 0 |
| `momentum_confirm_days` | 18 | 265 | 7% | 0 |
| `partial_take_level` | 8 | 271 | 3% | 1 |
| `signal_ema_span` | 7 | 264 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 260 | 2% | 0 |
| `entry_score_threshold` | 6 | 274 | 2% | 0 |
| `regime_threshold` | 6 | 280 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 257 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 270 | 2% | 0 |
| `ma_filter_mode` | 5 | 270 | 2% | 0 |
| `partial_take_pct` | 4 | 264 | 2% | 0 |
| `support_broken_gate` | 2 | 239 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 260 | 1% | 0 |
| `trailing_stop_mode` | 2 | 261 | 1% | 0 |
| `stop_tighten_factor` | 2 | 263 | 1% | 0 |
| `partial_take_pct_2` | 2 | 263 | 1% | 0 |
| `partial_take_level_2` | 2 | 266 | 1% | 0 |
| `resistance_overext_gate` | 1 | 239 | 0% | 0 |
| `vol_regime_mode` | 1 | 262 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-09T07:32:53+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
