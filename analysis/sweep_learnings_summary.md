...
_Generated: 2026-05-19T01:36:36+00:00_
...
- Total sweeps seen: **395**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **28.9%** (over 419 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 68 | 0 | 0 | 0 |
| `vote_threshold_long` | 66 | 0 | 0 | 0 |
| `score_strength_scaling` | 66 | 0 | 0 | 0 |
| `stop_atr_mult` | 65 | 0 | 0 | 0 |
| `min_signal_strength` | 65 | 0 | 0 | 0 |
| `time_stop_bars` | 64 | 0 | 0 | 0 |
| `entry_confirmation_days` | 64 | 0 | 0 | 0 |
| `volume_confirm_mode` | 64 | 0 | 1 | 0 |
| `ma_filter_period` | 64 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 63 | 0 | 0 | 0 |
| `vote_threshold_short` | 63 | 0 | 1 | 0 |
| `z_threshold` | 62 | 0 | 0 | 0 |
| `entry_aggressiveness` | 45 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 75 | 28% | 1 |
| `score_percentile_trigger` | 20 | 68 | 29% | 0 |
| `momentum_confirm_days` | 18 | 69 | 26% | 0 |
| `partial_take_level` | 8 | 75 | 11% | 1 |
| `signal_ema_span` | 7 | 67 | 10% | 0 |
| `max_loss_per_trade_pct` | 6 | 67 | 9% | 0 |
| `entry_score_threshold` | 6 | 77 | 8% | 0 |
| `regime_threshold` | 6 | 84 | 7% | 1 |
| `equity_drawdown_stop_pct` | 5 | 64 | 8% | 0 |
| `volatility_filter_percentile` | 5 | 74 | 7% | 0 |
| `ma_filter_mode` | 5 | 74 | 7% | 0 |
| `partial_take_pct` | 4 | 68 | 6% | 0 |
| `support_broken_gate` | 2 | 43 | 5% | 0 |
| `entry_discount_atr_frac` | 2 | 63 | 3% | 0 |
| `trailing_stop_mode` | 2 | 65 | 3% | 0 |
| `partial_take_pct_2` | 2 | 67 | 3% | 0 |
| `stop_tighten_factor` | 2 | 70 | 3% | 0 |
| `partial_take_level_2` | 2 | 70 | 3% | 0 |
| `resistance_overext_gate` | 1 | 43 | 2% | 0 |
| `vol_regime_mode` | 1 | 66 | 2% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-19T01:36:35+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
