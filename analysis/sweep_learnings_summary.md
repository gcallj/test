...
_Generated: 2026-09-11T19:30:41+00:00_
...
- Total sweeps seen: **1792**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **6.7%** (over 1816 total attempts)
...
|---|---:|---:|---:|---:|
| `vote_threshold_long` | 301 | 0 | 0 | 0 |
| `score_strength_scaling` | 301 | 0 | 0 | 0 |
| `reward_risk_ratio` | 301 | 0 | 0 | 0 |
| `min_signal_strength` | 300 | 0 | 0 | 0 |
| `entry_confirmation_days` | 299 | 0 | 0 | 0 |
| `vote_threshold_short` | 298 | 0 | 1 | 0 |
| `z_threshold` | 297 | 0 | 0 | 0 |
| `time_stop_bars` | 297 | 0 | 0 | 0 |
| `volume_confirm_mode` | 297 | 0 | 1 | 0 |
| `ma_filter_period` | 297 | 0 | 1 | 0 |
| `stop_atr_mult` | 295 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 293 | 0 | 0 | 0 |
| `entry_aggressiveness` | 280 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 308 | 7% | 1 |
| `score_percentile_trigger` | 20 | 303 | 7% | 0 |
| `momentum_confirm_days` | 18 | 302 | 6% | 0 |
| `partial_take_level` | 8 | 308 | 3% | 1 |
| `signal_ema_span` | 7 | 302 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 297 | 2% | 0 |
| `entry_score_threshold` | 6 | 312 | 2% | 0 |
| `regime_threshold` | 6 | 317 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 294 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 307 | 2% | 0 |
| `ma_filter_mode` | 5 | 307 | 2% | 0 |
| `partial_take_pct` | 4 | 301 | 1% | 0 |
| `support_broken_gate` | 2 | 276 | 1% | 0 |
| `trailing_stop_mode` | 2 | 298 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 298 | 1% | 0 |
| `stop_tighten_factor` | 2 | 300 | 1% | 0 |
| `partial_take_pct_2` | 2 | 300 | 1% | 0 |
| `partial_take_level_2` | 2 | 303 | 1% | 0 |
| `resistance_overext_gate` | 1 | 276 | 0% | 0 |
| `vol_regime_mode` | 1 | 299 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-09-11T19:30:39+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
