...
_Generated: 2026-05-23T06:29:19+00:00_
...
- Total sweeps seen: **917**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.9%** (over 941 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 155 | 0 | 0 | 0 |
| `vote_threshold_long` | 153 | 0 | 0 | 0 |
| `score_strength_scaling` | 153 | 0 | 0 | 0 |
| `stop_atr_mult` | 152 | 0 | 0 | 0 |
| `min_signal_strength` | 152 | 0 | 0 | 0 |
| `time_stop_bars` | 151 | 0 | 0 | 0 |
| `entry_confirmation_days` | 151 | 0 | 0 | 0 |
| `volume_confirm_mode` | 151 | 0 | 1 | 0 |
| `ma_filter_period` | 151 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 150 | 0 | 0 | 0 |
| `vote_threshold_short` | 150 | 0 | 1 | 0 |
| `z_threshold` | 149 | 0 | 0 | 0 |
| `entry_aggressiveness` | 132 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 162 | 13% | 1 |
| `score_percentile_trigger` | 20 | 155 | 13% | 0 |
| `momentum_confirm_days` | 18 | 156 | 12% | 0 |
| `partial_take_level` | 8 | 162 | 5% | 1 |
| `signal_ema_span` | 7 | 154 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 154 | 4% | 0 |
| `entry_score_threshold` | 6 | 164 | 4% | 0 |
| `regime_threshold` | 6 | 171 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 151 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 161 | 3% | 0 |
| `ma_filter_mode` | 5 | 161 | 3% | 0 |
| `partial_take_pct` | 4 | 155 | 3% | 0 |
| `support_broken_gate` | 2 | 130 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 150 | 1% | 0 |
| `trailing_stop_mode` | 2 | 152 | 1% | 0 |
| `partial_take_pct_2` | 2 | 154 | 1% | 0 |
| `stop_tighten_factor` | 2 | 157 | 1% | 0 |
| `partial_take_level_2` | 2 | 157 | 1% | 0 |
| `resistance_overext_gate` | 1 | 130 | 1% | 0 |
| `vol_regime_mode` | 1 | 153 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T06:29:18+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
