...
_Generated: 2026-05-23T02:57:48+00:00_
...
- Total sweeps seen: **899**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **13.1%** (over 923 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 152 | 0 | 0 | 0 |
| `vote_threshold_long` | 150 | 0 | 0 | 0 |
| `score_strength_scaling` | 150 | 0 | 0 | 0 |
| `stop_atr_mult` | 149 | 0 | 0 | 0 |
| `min_signal_strength` | 149 | 0 | 0 | 0 |
| `time_stop_bars` | 148 | 0 | 0 | 0 |
| `entry_confirmation_days` | 148 | 0 | 0 | 0 |
| `volume_confirm_mode` | 148 | 0 | 1 | 0 |
| `ma_filter_period` | 148 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 147 | 0 | 0 | 0 |
| `vote_threshold_short` | 147 | 0 | 1 | 0 |
| `z_threshold` | 146 | 0 | 0 | 0 |
| `entry_aggressiveness` | 129 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 159 | 13% | 1 |
| `score_percentile_trigger` | 20 | 152 | 13% | 0 |
| `momentum_confirm_days` | 18 | 153 | 12% | 0 |
| `partial_take_level` | 8 | 159 | 5% | 1 |
| `signal_ema_span` | 7 | 151 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 151 | 4% | 0 |
| `entry_score_threshold` | 6 | 161 | 4% | 0 |
| `regime_threshold` | 6 | 168 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 148 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 158 | 3% | 0 |
| `ma_filter_mode` | 5 | 158 | 3% | 0 |
| `partial_take_pct` | 4 | 152 | 3% | 0 |
| `support_broken_gate` | 2 | 127 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 147 | 1% | 0 |
| `trailing_stop_mode` | 2 | 149 | 1% | 0 |
| `partial_take_pct_2` | 2 | 151 | 1% | 0 |
| `stop_tighten_factor` | 2 | 154 | 1% | 0 |
| `partial_take_level_2` | 2 | 154 | 1% | 0 |
| `resistance_overext_gate` | 1 | 127 | 1% | 0 |
| `vol_regime_mode` | 1 | 150 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T02:57:47+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
