...
_Generated: 2026-05-31T22:34:44+00:00_
...
- Total sweeps seen: **1191**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.0%** (over 1215 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 201 | 0 | 0 | 0 |
| `vote_threshold_long` | 199 | 0 | 0 | 0 |
| `score_strength_scaling` | 199 | 0 | 0 | 0 |
| `min_signal_strength` | 198 | 0 | 0 | 0 |
| `stop_atr_mult` | 197 | 0 | 0 | 0 |
| `volume_confirm_mode` | 197 | 0 | 1 | 0 |
| `entry_confirmation_days` | 197 | 0 | 0 | 0 |
| `ma_filter_period` | 197 | 0 | 1 | 0 |
| `time_stop_bars` | 196 | 0 | 0 | 0 |
| `vote_threshold_short` | 196 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 195 | 0 | 0 | 0 |
| `z_threshold` | 195 | 0 | 0 | 0 |
| `entry_aggressiveness` | 178 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 207 | 10% | 1 |
| `score_percentile_trigger` | 20 | 201 | 10% | 0 |
| `momentum_confirm_days` | 18 | 202 | 9% | 0 |
| `partial_take_level` | 8 | 208 | 4% | 1 |
| `signal_ema_span` | 7 | 200 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 199 | 3% | 0 |
| `entry_score_threshold` | 6 | 210 | 3% | 0 |
| `regime_threshold` | 6 | 217 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 196 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 207 | 2% | 0 |
| `ma_filter_mode` | 5 | 207 | 2% | 0 |
| `partial_take_pct` | 4 | 201 | 2% | 0 |
| `support_broken_gate` | 2 | 176 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 196 | 1% | 0 |
| `trailing_stop_mode` | 2 | 198 | 1% | 0 |
| `partial_take_pct_2` | 2 | 200 | 1% | 0 |
| `stop_tighten_factor` | 2 | 202 | 1% | 0 |
| `partial_take_level_2` | 2 | 203 | 1% | 0 |
| `resistance_overext_gate` | 1 | 176 | 1% | 0 |
| `vol_regime_mode` | 1 | 199 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-31T22:34:43+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
