...
_Generated: 2026-05-22T19:03:10+00:00_
...
- Total sweeps seen: **857**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **13.7%** (over 881 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 145 | 0 | 0 | 0 |
| `vote_threshold_long` | 143 | 0 | 0 | 0 |
| `score_strength_scaling` | 143 | 0 | 0 | 0 |
| `stop_atr_mult` | 142 | 0 | 0 | 0 |
| `min_signal_strength` | 142 | 0 | 0 | 0 |
| `time_stop_bars` | 141 | 0 | 0 | 0 |
| `entry_confirmation_days` | 141 | 0 | 0 | 0 |
| `volume_confirm_mode` | 141 | 0 | 1 | 0 |
| `ma_filter_period` | 141 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 140 | 0 | 0 | 0 |
| `vote_threshold_short` | 140 | 0 | 1 | 0 |
| `z_threshold` | 139 | 0 | 0 | 0 |
| `entry_aggressiveness` | 122 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 152 | 14% | 1 |
| `score_percentile_trigger` | 20 | 145 | 14% | 0 |
| `momentum_confirm_days` | 18 | 146 | 12% | 0 |
| `partial_take_level` | 8 | 152 | 5% | 1 |
| `signal_ema_span` | 7 | 144 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 144 | 4% | 0 |
| `entry_score_threshold` | 6 | 154 | 4% | 0 |
| `regime_threshold` | 6 | 161 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 141 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 151 | 3% | 0 |
| `ma_filter_mode` | 5 | 151 | 3% | 0 |
| `partial_take_pct` | 4 | 145 | 3% | 0 |
| `support_broken_gate` | 2 | 120 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 140 | 1% | 0 |
| `trailing_stop_mode` | 2 | 142 | 1% | 0 |
| `partial_take_pct_2` | 2 | 144 | 1% | 0 |
| `stop_tighten_factor` | 2 | 147 | 1% | 0 |
| `partial_take_level_2` | 2 | 147 | 1% | 0 |
| `resistance_overext_gate` | 1 | 120 | 1% | 0 |
| `vol_regime_mode` | 1 | 143 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-22T19:03:09+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
