...
_Generated: 2026-05-21T21:27:56+00:00_
...
- Total sweeps seen: **743**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **15.8%** (over 767 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 126 | 0 | 0 | 0 |
| `vote_threshold_long` | 124 | 0 | 0 | 0 |
| `score_strength_scaling` | 124 | 0 | 0 | 0 |
| `stop_atr_mult` | 123 | 0 | 0 | 0 |
| `min_signal_strength` | 123 | 0 | 0 | 0 |
| `time_stop_bars` | 122 | 0 | 0 | 0 |
| `entry_confirmation_days` | 122 | 0 | 0 | 0 |
| `volume_confirm_mode` | 122 | 0 | 1 | 0 |
| `ma_filter_period` | 122 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 121 | 0 | 0 | 0 |
| `vote_threshold_short` | 121 | 0 | 1 | 0 |
| `z_threshold` | 120 | 0 | 0 | 0 |
| `entry_aggressiveness` | 103 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 133 | 16% | 1 |
| `score_percentile_trigger` | 20 | 126 | 16% | 0 |
| `momentum_confirm_days` | 18 | 127 | 14% | 0 |
| `partial_take_level` | 8 | 133 | 6% | 1 |
| `signal_ema_span` | 7 | 125 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 125 | 5% | 0 |
| `entry_score_threshold` | 6 | 135 | 4% | 0 |
| `regime_threshold` | 6 | 142 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 122 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 132 | 4% | 0 |
| `ma_filter_mode` | 5 | 132 | 4% | 0 |
| `partial_take_pct` | 4 | 126 | 3% | 0 |
| `support_broken_gate` | 2 | 101 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 121 | 2% | 0 |
| `trailing_stop_mode` | 2 | 123 | 2% | 0 |
| `partial_take_pct_2` | 2 | 125 | 2% | 0 |
| `stop_tighten_factor` | 2 | 128 | 2% | 0 |
| `partial_take_level_2` | 2 | 128 | 2% | 0 |
| `resistance_overext_gate` | 1 | 101 | 1% | 0 |
| `vol_regime_mode` | 1 | 124 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T21:27:55+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
