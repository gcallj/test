...
_Generated: 2026-09-01T07:26:05+00:00_
...
- Total sweeps seen: **1708**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.0%** (over 1732 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 287 | 0 | 0 | 0 |
| `score_strength_scaling` | 287 | 0 | 0 | 0 |
| `vote_threshold_long` | 287 | 0 | 0 | 0 |
| `min_signal_strength` | 286 | 0 | 0 | 0 |
| `entry_confirmation_days` | 285 | 0 | 0 | 0 |
| `vote_threshold_short` | 284 | 0 | 1 | 0 |
| `time_stop_bars` | 283 | 0 | 0 | 0 |
| `volume_confirm_mode` | 283 | 0 | 1 | 0 |
| `z_threshold` | 283 | 0 | 0 | 0 |
| `ma_filter_period` | 283 | 0 | 1 | 0 |
| `stop_atr_mult` | 281 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 279 | 0 | 0 | 0 |
| `entry_aggressiveness` | 266 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 294 | 7% | 1 |
| `score_percentile_trigger` | 20 | 289 | 7% | 0 |
| `momentum_confirm_days` | 18 | 288 | 6% | 0 |
| `partial_take_level` | 8 | 294 | 3% | 1 |
| `signal_ema_span` | 7 | 288 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 283 | 2% | 0 |
| `entry_score_threshold` | 6 | 298 | 2% | 0 |
| `regime_threshold` | 6 | 303 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 280 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 293 | 2% | 0 |
| `ma_filter_mode` | 5 | 293 | 2% | 0 |
| `partial_take_pct` | 4 | 287 | 1% | 0 |
| `support_broken_gate` | 2 | 262 | 1% | 0 |
| `trailing_stop_mode` | 2 | 284 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 284 | 1% | 0 |
| `stop_tighten_factor` | 2 | 286 | 1% | 0 |
| `partial_take_pct_2` | 2 | 286 | 1% | 0 |
| `partial_take_level_2` | 2 | 289 | 1% | 0 |
| `resistance_overext_gate` | 1 | 262 | 0% | 0 |
| `vol_regime_mode` | 1 | 285 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-09-01T07:26:03+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
