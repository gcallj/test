...
_Generated: 2026-05-23T08:46:06+00:00_
...
- Total sweeps seen: **929**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.7%** (over 953 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 157 | 0 | 0 | 0 |
| `vote_threshold_long` | 155 | 0 | 0 | 0 |
| `score_strength_scaling` | 155 | 0 | 0 | 0 |
| `stop_atr_mult` | 154 | 0 | 0 | 0 |
| `min_signal_strength` | 154 | 0 | 0 | 0 |
| `entry_confirmation_days` | 153 | 0 | 0 | 0 |
| `volume_confirm_mode` | 153 | 0 | 1 | 0 |
| `time_stop_bars` | 153 | 0 | 0 | 0 |
| `ma_filter_period` | 153 | 0 | 1 | 0 |
| `vote_threshold_short` | 152 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 152 | 0 | 0 | 0 |
| `z_threshold` | 151 | 0 | 0 | 0 |
| `entry_aggressiveness` | 134 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 164 | 13% | 1 |
| `score_percentile_trigger` | 20 | 157 | 13% | 0 |
| `momentum_confirm_days` | 18 | 158 | 11% | 0 |
| `partial_take_level` | 8 | 164 | 5% | 1 |
| `signal_ema_span` | 7 | 156 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 156 | 4% | 0 |
| `entry_score_threshold` | 6 | 166 | 4% | 0 |
| `regime_threshold` | 6 | 173 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 153 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 163 | 3% | 0 |
| `ma_filter_mode` | 5 | 163 | 3% | 0 |
| `partial_take_pct` | 4 | 157 | 3% | 0 |
| `support_broken_gate` | 2 | 132 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 152 | 1% | 0 |
| `trailing_stop_mode` | 2 | 154 | 1% | 0 |
| `partial_take_pct_2` | 2 | 156 | 1% | 0 |
| `stop_tighten_factor` | 2 | 159 | 1% | 0 |
| `partial_take_level_2` | 2 | 159 | 1% | 0 |
| `resistance_overext_gate` | 1 | 132 | 1% | 0 |
| `vol_regime_mode` | 1 | 155 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T08:46:05+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
