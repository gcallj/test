...
_Generated: 2026-05-23T14:11:07+00:00_
...
- Total sweeps seen: **957**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.3%** (over 981 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 162 | 0 | 0 | 0 |
| `vote_threshold_long` | 160 | 0 | 0 | 0 |
| `score_strength_scaling` | 160 | 0 | 0 | 0 |
| `min_signal_strength` | 159 | 0 | 0 | 0 |
| `stop_atr_mult` | 158 | 0 | 0 | 0 |
| `volume_confirm_mode` | 158 | 0 | 1 | 0 |
| `entry_confirmation_days` | 158 | 0 | 0 | 0 |
| `ma_filter_period` | 158 | 0 | 1 | 0 |
| `time_stop_bars` | 157 | 0 | 0 | 0 |
| `vote_threshold_short` | 157 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 156 | 0 | 0 | 0 |
| `z_threshold` | 156 | 0 | 0 | 0 |
| `entry_aggressiveness` | 139 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 168 | 12% | 1 |
| `score_percentile_trigger` | 20 | 162 | 12% | 0 |
| `momentum_confirm_days` | 18 | 163 | 11% | 0 |
| `partial_take_level` | 8 | 169 | 5% | 1 |
| `signal_ema_span` | 7 | 161 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 160 | 4% | 0 |
| `entry_score_threshold` | 6 | 171 | 4% | 0 |
| `regime_threshold` | 6 | 178 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 157 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 168 | 3% | 0 |
| `ma_filter_mode` | 5 | 168 | 3% | 0 |
| `partial_take_pct` | 4 | 162 | 2% | 0 |
| `support_broken_gate` | 2 | 137 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 157 | 1% | 0 |
| `trailing_stop_mode` | 2 | 159 | 1% | 0 |
| `partial_take_pct_2` | 2 | 161 | 1% | 0 |
| `stop_tighten_factor` | 2 | 163 | 1% | 0 |
| `partial_take_level_2` | 2 | 164 | 1% | 0 |
| `resistance_overext_gate` | 1 | 137 | 1% | 0 |
| `vol_regime_mode` | 1 | 160 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T14:11:06+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
