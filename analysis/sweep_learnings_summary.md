...
_Generated: 2026-04-23T04:34:25+00:00_
...
- Total sweeps seen: **257**
- Total promotions: **108** (including 1 from codex log)
- Promotion rate: **38.4%** (over 281 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 45 | 0 | 0 | 0 |
| `score_strength_scaling` | 43 | 0 | 0 | 0 |
| `vote_threshold_long` | 43 | 0 | 0 | 0 |
| `stop_atr_mult` | 42 | 0 | 0 | 0 |
| `min_signal_strength` | 42 | 0 | 0 | 0 |
| `time_stop_bars` | 41 | 0 | 0 | 0 |
| `volume_confirm_mode` | 41 | 0 | 1 | 0 |
| `entry_confirmation_days` | 41 | 0 | 0 | 0 |
| `ma_filter_period` | 41 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 40 | 0 | 0 | 0 |
| `vote_threshold_short` | 40 | 0 | 1 | 0 |
| `z_threshold` | 39 | 0 | 0 | 0 |
| `entry_aggressiveness` | 22 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 19 | 52 | 37% | 1 |
| `score_percentile_trigger` | 16 | 45 | 36% | 0 |
| `momentum_confirm_days` | 15 | 46 | 33% | 0 |
| `signal_ema_span` | 7 | 44 | 16% | 0 |
| `max_loss_per_trade_pct` | 6 | 44 | 14% | 0 |
| `partial_take_level` | 6 | 52 | 12% | 1 |
| `entry_score_threshold` | 6 | 54 | 11% | 0 |
| `regime_threshold` | 6 | 61 | 10% | 1 |
| `equity_drawdown_stop_pct` | 5 | 41 | 12% | 0 |
| `ma_filter_mode` | 5 | 51 | 10% | 0 |
| `partial_take_pct` | 4 | 45 | 9% | 0 |
| `volatility_filter_percentile` | 3 | 51 | 6% | 0 |
| `support_broken_gate` | 2 | 20 | 10% | 0 |
| `entry_discount_atr_frac` | 2 | 40 | 5% | 0 |
| `trailing_stop_mode` | 2 | 42 | 5% | 0 |
| `partial_take_pct_2` | 2 | 44 | 5% | 0 |
| `stop_tighten_factor` | 2 | 47 | 4% | 0 |
| `partial_take_level_2` | 2 | 47 | 4% | 0 |
| `resistance_overext_gate` | 1 | 20 | 5% | 0 |
| `vol_regime_mode` | 1 | 43 | 2% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-04-23T04:34:25+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
