...
_Generated: 2026-05-24T11:45:50+00:00_
...
- Total sweeps seen: **1041**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **11.4%** (over 1065 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 176 | 0 | 0 | 0 |
| `vote_threshold_long` | 174 | 0 | 0 | 0 |
| `score_strength_scaling` | 174 | 0 | 0 | 0 |
| `min_signal_strength` | 173 | 0 | 0 | 0 |
| `volume_confirm_mode` | 172 | 0 | 1 | 0 |
| `stop_atr_mult` | 172 | 0 | 0 | 0 |
| `entry_confirmation_days` | 172 | 0 | 0 | 0 |
| `ma_filter_period` | 172 | 0 | 1 | 0 |
| `time_stop_bars` | 171 | 0 | 0 | 0 |
| `vote_threshold_short` | 171 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 170 | 0 | 0 | 0 |
| `z_threshold` | 170 | 0 | 0 | 0 |
| `entry_aggressiveness` | 153 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 182 | 12% | 1 |
| `score_percentile_trigger` | 20 | 176 | 11% | 0 |
| `momentum_confirm_days` | 18 | 177 | 10% | 0 |
| `partial_take_level` | 8 | 183 | 4% | 1 |
| `signal_ema_span` | 7 | 175 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 174 | 3% | 0 |
| `entry_score_threshold` | 6 | 185 | 3% | 0 |
| `regime_threshold` | 6 | 192 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 171 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 182 | 3% | 0 |
| `ma_filter_mode` | 5 | 182 | 3% | 0 |
| `partial_take_pct` | 4 | 176 | 2% | 0 |
| `support_broken_gate` | 2 | 151 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 171 | 1% | 0 |
| `trailing_stop_mode` | 2 | 173 | 1% | 0 |
| `partial_take_pct_2` | 2 | 175 | 1% | 0 |
| `stop_tighten_factor` | 2 | 177 | 1% | 0 |
| `partial_take_level_2` | 2 | 178 | 1% | 0 |
| `resistance_overext_gate` | 1 | 151 | 1% | 0 |
| `vol_regime_mode` | 1 | 174 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-24T11:45:49+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
