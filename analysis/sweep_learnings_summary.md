...
_Generated: 2026-05-23T12:16:17+00:00_
...
- Total sweeps seen: **947**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.5%** (over 971 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 160 | 0 | 0 | 0 |
| `vote_threshold_long` | 158 | 0 | 0 | 0 |
| `score_strength_scaling` | 158 | 0 | 0 | 0 |
| `stop_atr_mult` | 157 | 0 | 0 | 0 |
| `min_signal_strength` | 157 | 0 | 0 | 0 |
| `entry_confirmation_days` | 156 | 0 | 0 | 0 |
| `volume_confirm_mode` | 156 | 0 | 1 | 0 |
| `time_stop_bars` | 156 | 0 | 0 | 0 |
| `ma_filter_period` | 156 | 0 | 1 | 0 |
| `vote_threshold_short` | 155 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 155 | 0 | 0 | 0 |
| `z_threshold` | 154 | 0 | 0 | 0 |
| `entry_aggressiveness` | 137 | 0 | 0 | 0 |
...
| `score_percentile_trigger` | 20 | 160 | 12% | 0 |
| `momentum_confirm_days` | 18 | 161 | 11% | 0 |
| `partial_take_level` | 8 | 167 | 5% | 1 |
| `signal_ema_span` | 7 | 159 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 159 | 4% | 0 |
| `entry_score_threshold` | 6 | 169 | 4% | 0 |
| `regime_threshold` | 6 | 176 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 156 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 166 | 3% | 0 |
| `ma_filter_mode` | 5 | 166 | 3% | 0 |
| `partial_take_pct` | 4 | 160 | 2% | 0 |
| `support_broken_gate` | 2 | 135 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 155 | 1% | 0 |
| `trailing_stop_mode` | 2 | 157 | 1% | 0 |
| `partial_take_pct_2` | 2 | 159 | 1% | 0 |
| `stop_tighten_factor` | 2 | 162 | 1% | 0 |
| `partial_take_level_2` | 2 | 162 | 1% | 0 |
| `resistance_overext_gate` | 1 | 135 | 1% | 0 |
| `vol_regime_mode` | 1 | 158 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T12:16:16+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
