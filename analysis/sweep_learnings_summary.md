...
_Generated: 2026-05-23T18:53:31+00:00_
...
- Total sweeps seen: **981**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.0%** (over 1005 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 166 | 0 | 0 | 0 |
| `vote_threshold_long` | 164 | 0 | 0 | 0 |
| `score_strength_scaling` | 164 | 0 | 0 | 0 |
| `min_signal_strength` | 163 | 0 | 0 | 0 |
| `stop_atr_mult` | 162 | 0 | 0 | 0 |
| `entry_confirmation_days` | 162 | 0 | 0 | 0 |
| `volume_confirm_mode` | 162 | 0 | 1 | 0 |
| `ma_filter_period` | 162 | 0 | 1 | 0 |
| `vote_threshold_short` | 161 | 0 | 1 | 0 |
| `time_stop_bars` | 161 | 0 | 0 | 0 |
| `z_threshold` | 160 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 160 | 0 | 0 | 0 |
| `entry_aggressiveness` | 143 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 172 | 12% | 1 |
| `score_percentile_trigger` | 20 | 166 | 12% | 0 |
| `momentum_confirm_days` | 18 | 167 | 11% | 0 |
| `partial_take_level` | 8 | 173 | 5% | 1 |
| `signal_ema_span` | 7 | 165 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 164 | 4% | 0 |
| `entry_score_threshold` | 6 | 175 | 3% | 0 |
| `regime_threshold` | 6 | 182 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 161 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 172 | 3% | 0 |
| `ma_filter_mode` | 5 | 172 | 3% | 0 |
| `partial_take_pct` | 4 | 166 | 2% | 0 |
| `support_broken_gate` | 2 | 141 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 161 | 1% | 0 |
| `trailing_stop_mode` | 2 | 163 | 1% | 0 |
| `partial_take_pct_2` | 2 | 165 | 1% | 0 |
| `stop_tighten_factor` | 2 | 167 | 1% | 0 |
| `partial_take_level_2` | 2 | 168 | 1% | 0 |
| `resistance_overext_gate` | 1 | 141 | 1% | 0 |
| `vol_regime_mode` | 1 | 164 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T18:53:30+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
