...
_Generated: 2026-07-31T11:07:48+00:00_
...
- Total sweeps seen: **1520**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.8%** (over 1544 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 256 | 0 | 0 | 0 |
| `vote_threshold_long` | 255 | 0 | 0 | 0 |
| `score_strength_scaling` | 255 | 0 | 0 | 0 |
| `min_signal_strength` | 254 | 0 | 0 | 0 |
| `entry_confirmation_days` | 253 | 0 | 0 | 0 |
| `volume_confirm_mode` | 252 | 0 | 1 | 0 |
| `vote_threshold_short` | 252 | 0 | 1 | 0 |
| `ma_filter_period` | 252 | 0 | 1 | 0 |
| `time_stop_bars` | 251 | 0 | 0 | 0 |
| `z_threshold` | 251 | 0 | 0 | 0 |
| `stop_atr_mult` | 250 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 248 | 0 | 0 | 0 |
| `entry_aggressiveness` | 234 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 262 | 8% | 1 |
| `score_percentile_trigger` | 20 | 257 | 8% | 0 |
| `momentum_confirm_days` | 18 | 257 | 7% | 0 |
| `partial_take_level` | 8 | 263 | 3% | 1 |
| `signal_ema_span` | 7 | 256 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 252 | 2% | 0 |
| `entry_score_threshold` | 6 | 266 | 2% | 0 |
| `regime_threshold` | 6 | 272 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 249 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 262 | 2% | 0 |
| `ma_filter_mode` | 5 | 262 | 2% | 0 |
| `partial_take_pct` | 4 | 256 | 2% | 0 |
| `support_broken_gate` | 2 | 231 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 252 | 1% | 0 |
| `trailing_stop_mode` | 2 | 253 | 1% | 0 |
| `stop_tighten_factor` | 2 | 255 | 1% | 0 |
| `partial_take_pct_2` | 2 | 255 | 1% | 0 |
| `partial_take_level_2` | 2 | 258 | 1% | 0 |
| `resistance_overext_gate` | 1 | 231 | 0% | 0 |
| `vol_regime_mode` | 1 | 254 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-07-31T11:07:46+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
