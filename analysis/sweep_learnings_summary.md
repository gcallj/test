...
_Generated: 2026-05-20T22:31:23+00:00_
...
- Total sweeps seen: **629**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **18.5%** (over 653 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 107 | 0 | 0 | 0 |
| `vote_threshold_long` | 105 | 0 | 0 | 0 |
| `score_strength_scaling` | 105 | 0 | 0 | 0 |
| `min_signal_strength` | 104 | 0 | 0 | 0 |
| `stop_atr_mult` | 104 | 0 | 0 | 0 |
| `volume_confirm_mode` | 103 | 0 | 1 | 0 |
| `time_stop_bars` | 103 | 0 | 0 | 0 |
| `entry_confirmation_days` | 103 | 0 | 0 | 0 |
| `ma_filter_period` | 103 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 102 | 0 | 0 | 0 |
| `vote_threshold_short` | 102 | 0 | 1 | 0 |
| `z_threshold` | 101 | 0 | 0 | 0 |
| `entry_aggressiveness` | 84 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 114 | 18% | 1 |
| `score_percentile_trigger` | 20 | 107 | 19% | 0 |
| `momentum_confirm_days` | 18 | 108 | 17% | 0 |
| `partial_take_level` | 8 | 114 | 7% | 1 |
| `signal_ema_span` | 7 | 106 | 7% | 0 |
| `max_loss_per_trade_pct` | 6 | 106 | 6% | 0 |
| `entry_score_threshold` | 6 | 116 | 5% | 0 |
| `regime_threshold` | 6 | 123 | 5% | 1 |
| `equity_drawdown_stop_pct` | 5 | 103 | 5% | 0 |
| `volatility_filter_percentile` | 5 | 113 | 4% | 0 |
| `ma_filter_mode` | 5 | 113 | 4% | 0 |
| `partial_take_pct` | 4 | 107 | 4% | 0 |
| `support_broken_gate` | 2 | 82 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 102 | 2% | 0 |
| `trailing_stop_mode` | 2 | 104 | 2% | 0 |
| `partial_take_pct_2` | 2 | 106 | 2% | 0 |
| `stop_tighten_factor` | 2 | 109 | 2% | 0 |
| `partial_take_level_2` | 2 | 109 | 2% | 0 |
| `resistance_overext_gate` | 1 | 82 | 1% | 0 |
| `vol_regime_mode` | 1 | 105 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T22:31:23+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
