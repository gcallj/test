...
_Generated: 2026-07-04T15:17:06+00:00_
...
- Total sweeps seen: **1416**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.4%** (over 1440 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 239 | 0 | 0 | 0 |
| `vote_threshold_long` | 237 | 0 | 0 | 0 |
| `score_strength_scaling` | 237 | 0 | 0 | 0 |
| `min_signal_strength` | 236 | 0 | 0 | 0 |
| `entry_confirmation_days` | 235 | 0 | 0 | 0 |
| `volume_confirm_mode` | 235 | 0 | 1 | 0 |
| `ma_filter_period` | 235 | 0 | 1 | 0 |
| `vote_threshold_short` | 234 | 0 | 1 | 0 |
| `stop_atr_mult` | 233 | 0 | 0 | 0 |
| `time_stop_bars` | 233 | 0 | 0 | 0 |
| `z_threshold` | 233 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 231 | 0 | 0 | 0 |
| `entry_aggressiveness` | 216 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 244 | 9% | 1 |
| `score_percentile_trigger` | 20 | 239 | 8% | 0 |
| `momentum_confirm_days` | 18 | 240 | 8% | 0 |
| `partial_take_level` | 8 | 246 | 3% | 1 |
| `signal_ema_span` | 7 | 238 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 235 | 3% | 0 |
| `entry_score_threshold` | 6 | 248 | 2% | 0 |
| `regime_threshold` | 6 | 255 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 232 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 245 | 2% | 0 |
| `ma_filter_mode` | 5 | 245 | 2% | 0 |
| `partial_take_pct` | 4 | 239 | 2% | 0 |
| `support_broken_gate` | 2 | 214 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 234 | 1% | 0 |
| `trailing_stop_mode` | 2 | 236 | 1% | 0 |
| `stop_tighten_factor` | 2 | 238 | 1% | 0 |
| `partial_take_pct_2` | 2 | 238 | 1% | 0 |
| `partial_take_level_2` | 2 | 241 | 1% | 0 |
| `resistance_overext_gate` | 1 | 214 | 0% | 0 |
| `vol_regime_mode` | 1 | 237 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-07-04T15:17:05+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
