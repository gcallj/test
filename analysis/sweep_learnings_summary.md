...
_Generated: 2026-08-03T14:22:59+00:00_
...
- Total sweeps seen: **1544**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.7%** (over 1568 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 260 | 0 | 0 | 0 |
| `vote_threshold_long` | 259 | 0 | 0 | 0 |
| `score_strength_scaling` | 259 | 0 | 0 | 0 |
| `min_signal_strength` | 258 | 0 | 0 | 0 |
| `entry_confirmation_days` | 257 | 0 | 0 | 0 |
| `volume_confirm_mode` | 256 | 0 | 1 | 0 |
| `vote_threshold_short` | 256 | 0 | 1 | 0 |
| `ma_filter_period` | 256 | 0 | 1 | 0 |
| `time_stop_bars` | 255 | 0 | 0 | 0 |
| `z_threshold` | 255 | 0 | 0 | 0 |
| `stop_atr_mult` | 254 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 252 | 0 | 0 | 0 |
| `entry_aggressiveness` | 238 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 266 | 8% | 1 |
| `score_percentile_trigger` | 20 | 261 | 8% | 0 |
| `momentum_confirm_days` | 18 | 261 | 7% | 0 |
| `partial_take_level` | 8 | 267 | 3% | 1 |
| `signal_ema_span` | 7 | 260 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 256 | 2% | 0 |
| `entry_score_threshold` | 6 | 270 | 2% | 0 |
| `regime_threshold` | 6 | 276 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 253 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 266 | 2% | 0 |
| `ma_filter_mode` | 5 | 266 | 2% | 0 |
| `partial_take_pct` | 4 | 260 | 2% | 0 |
| `support_broken_gate` | 2 | 235 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 256 | 1% | 0 |
| `trailing_stop_mode` | 2 | 257 | 1% | 0 |
| `stop_tighten_factor` | 2 | 259 | 1% | 0 |
| `partial_take_pct_2` | 2 | 259 | 1% | 0 |
| `partial_take_level_2` | 2 | 262 | 1% | 0 |
| `resistance_overext_gate` | 1 | 235 | 0% | 0 |
| `vol_regime_mode` | 1 | 258 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-03T14:22:58+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
