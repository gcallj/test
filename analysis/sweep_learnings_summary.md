...
_Generated: 2026-05-20T14:48:43+00:00_
...
- Total sweeps seen: **587**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **19.8%** (over 611 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 100 | 0 | 0 | 0 |
| `vote_threshold_long` | 98 | 0 | 0 | 0 |
| `score_strength_scaling` | 98 | 0 | 0 | 0 |
| `stop_atr_mult` | 97 | 0 | 0 | 0 |
| `min_signal_strength` | 97 | 0 | 0 | 0 |
| `time_stop_bars` | 96 | 0 | 0 | 0 |
| `entry_confirmation_days` | 96 | 0 | 0 | 0 |
| `volume_confirm_mode` | 96 | 0 | 1 | 0 |
| `ma_filter_period` | 96 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 95 | 0 | 0 | 0 |
| `vote_threshold_short` | 95 | 0 | 1 | 0 |
| `z_threshold` | 94 | 0 | 0 | 0 |
| `entry_aggressiveness` | 77 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 107 | 20% | 1 |
| `score_percentile_trigger` | 20 | 100 | 20% | 0 |
| `momentum_confirm_days` | 18 | 101 | 18% | 0 |
| `partial_take_level` | 8 | 107 | 7% | 1 |
| `signal_ema_span` | 7 | 99 | 7% | 0 |
| `max_loss_per_trade_pct` | 6 | 99 | 6% | 0 |
| `entry_score_threshold` | 6 | 109 | 6% | 0 |
| `regime_threshold` | 6 | 116 | 5% | 1 |
| `equity_drawdown_stop_pct` | 5 | 96 | 5% | 0 |
| `volatility_filter_percentile` | 5 | 106 | 5% | 0 |
| `ma_filter_mode` | 5 | 106 | 5% | 0 |
| `partial_take_pct` | 4 | 100 | 4% | 0 |
| `support_broken_gate` | 2 | 75 | 3% | 0 |
| `entry_discount_atr_frac` | 2 | 95 | 2% | 0 |
| `trailing_stop_mode` | 2 | 97 | 2% | 0 |
| `partial_take_pct_2` | 2 | 99 | 2% | 0 |
| `stop_tighten_factor` | 2 | 102 | 2% | 0 |
| `partial_take_level_2` | 2 | 102 | 2% | 0 |
| `resistance_overext_gate` | 1 | 75 | 1% | 0 |
| `vol_regime_mode` | 1 | 98 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T14:48:42+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
