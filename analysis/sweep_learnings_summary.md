...
_Generated: 2026-08-10T21:02:08+00:00_
...
- Total sweeps seen: **1574**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.6%** (over 1598 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 265 | 0 | 0 | 0 |
| `vote_threshold_long` | 264 | 0 | 0 | 0 |
| `score_strength_scaling` | 264 | 0 | 0 | 0 |
| `min_signal_strength` | 263 | 0 | 0 | 0 |
| `entry_confirmation_days` | 262 | 0 | 0 | 0 |
| `volume_confirm_mode` | 261 | 0 | 1 | 0 |
| `vote_threshold_short` | 261 | 0 | 1 | 0 |
| `ma_filter_period` | 261 | 0 | 1 | 0 |
| `time_stop_bars` | 260 | 0 | 0 | 0 |
| `z_threshold` | 260 | 0 | 0 | 0 |
| `stop_atr_mult` | 259 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 257 | 0 | 0 | 0 |
| `entry_aggressiveness` | 243 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 271 | 8% | 1 |
| `score_percentile_trigger` | 20 | 266 | 8% | 0 |
| `momentum_confirm_days` | 18 | 266 | 7% | 0 |
| `partial_take_level` | 8 | 272 | 3% | 1 |
| `signal_ema_span` | 7 | 265 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 261 | 2% | 0 |
| `entry_score_threshold` | 6 | 275 | 2% | 0 |
| `regime_threshold` | 6 | 281 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 258 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 271 | 2% | 0 |
| `ma_filter_mode` | 5 | 271 | 2% | 0 |
| `partial_take_pct` | 4 | 265 | 2% | 0 |
| `support_broken_gate` | 2 | 240 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 261 | 1% | 0 |
| `trailing_stop_mode` | 2 | 262 | 1% | 0 |
| `stop_tighten_factor` | 2 | 264 | 1% | 0 |
| `partial_take_pct_2` | 2 | 264 | 1% | 0 |
| `partial_take_level_2` | 2 | 267 | 1% | 0 |
| `resistance_overext_gate` | 1 | 240 | 0% | 0 |
| `vol_regime_mode` | 1 | 263 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-10T21:02:07+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
