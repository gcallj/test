...
_Generated: 2026-05-21T20:24:49+00:00_
...
- Total sweeps seen: **737**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **15.9%** (over 761 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 125 | 0 | 0 | 0 |
| `vote_threshold_long` | 123 | 0 | 0 | 0 |
| `score_strength_scaling` | 123 | 0 | 0 | 0 |
| `stop_atr_mult` | 122 | 0 | 0 | 0 |
| `min_signal_strength` | 122 | 0 | 0 | 0 |
| `entry_confirmation_days` | 121 | 0 | 0 | 0 |
| `volume_confirm_mode` | 121 | 0 | 1 | 0 |
| `time_stop_bars` | 121 | 0 | 0 | 0 |
| `ma_filter_period` | 121 | 0 | 1 | 0 |
| `vote_threshold_short` | 120 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 120 | 0 | 0 | 0 |
| `z_threshold` | 119 | 0 | 0 | 0 |
| `entry_aggressiveness` | 102 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 132 | 16% | 1 |
| `score_percentile_trigger` | 20 | 125 | 16% | 0 |
| `momentum_confirm_days` | 18 | 126 | 14% | 0 |
| `partial_take_level` | 8 | 132 | 6% | 1 |
| `signal_ema_span` | 7 | 124 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 124 | 5% | 0 |
| `entry_score_threshold` | 6 | 134 | 4% | 0 |
| `regime_threshold` | 6 | 141 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 121 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 131 | 4% | 0 |
| `ma_filter_mode` | 5 | 131 | 4% | 0 |
| `partial_take_pct` | 4 | 125 | 3% | 0 |
| `support_broken_gate` | 2 | 100 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 120 | 2% | 0 |
| `trailing_stop_mode` | 2 | 122 | 2% | 0 |
| `partial_take_pct_2` | 2 | 124 | 2% | 0 |
| `stop_tighten_factor` | 2 | 127 | 2% | 0 |
| `partial_take_level_2` | 2 | 127 | 2% | 0 |
| `resistance_overext_gate` | 1 | 100 | 1% | 0 |
| `vol_regime_mode` | 1 | 123 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T20:24:48+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
