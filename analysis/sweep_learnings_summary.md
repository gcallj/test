...
_Generated: 2026-05-27T14:06:46+00:00_
...
- Total sweeps seen: **1119**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.6%** (over 1143 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 189 | 0 | 0 | 0 |
| `vote_threshold_long` | 187 | 0 | 0 | 0 |
| `score_strength_scaling` | 187 | 0 | 0 | 0 |
| `min_signal_strength` | 186 | 0 | 0 | 0 |
| `stop_atr_mult` | 185 | 0 | 0 | 0 |
| `entry_confirmation_days` | 185 | 0 | 0 | 0 |
| `volume_confirm_mode` | 185 | 0 | 1 | 0 |
| `ma_filter_period` | 185 | 0 | 1 | 0 |
| `time_stop_bars` | 184 | 0 | 0 | 0 |
| `vote_threshold_short` | 184 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 183 | 0 | 0 | 0 |
| `z_threshold` | 183 | 0 | 0 | 0 |
| `entry_aggressiveness` | 166 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 195 | 11% | 1 |
| `score_percentile_trigger` | 20 | 189 | 11% | 0 |
| `momentum_confirm_days` | 18 | 190 | 9% | 0 |
| `partial_take_level` | 8 | 196 | 4% | 1 |
| `signal_ema_span` | 7 | 188 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 187 | 3% | 0 |
| `entry_score_threshold` | 6 | 198 | 3% | 0 |
| `regime_threshold` | 6 | 205 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 184 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 195 | 3% | 0 |
| `ma_filter_mode` | 5 | 195 | 3% | 0 |
| `partial_take_pct` | 4 | 189 | 2% | 0 |
| `support_broken_gate` | 2 | 164 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 184 | 1% | 0 |
| `trailing_stop_mode` | 2 | 186 | 1% | 0 |
| `partial_take_pct_2` | 2 | 188 | 1% | 0 |
| `stop_tighten_factor` | 2 | 190 | 1% | 0 |
| `partial_take_level_2` | 2 | 191 | 1% | 0 |
| `resistance_overext_gate` | 1 | 164 | 1% | 0 |
| `vol_regime_mode` | 1 | 187 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-27T14:06:44+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
