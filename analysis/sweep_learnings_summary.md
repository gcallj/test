...
_Generated: 2026-05-23T15:22:52+00:00_
...
- Total sweeps seen: **963**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.3%** (over 987 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 163 | 0 | 0 | 0 |
| `vote_threshold_long` | 161 | 0 | 0 | 0 |
| `score_strength_scaling` | 161 | 0 | 0 | 0 |
| `min_signal_strength` | 160 | 0 | 0 | 0 |
| `stop_atr_mult` | 159 | 0 | 0 | 0 |
| `entry_confirmation_days` | 159 | 0 | 0 | 0 |
| `volume_confirm_mode` | 159 | 0 | 1 | 0 |
| `ma_filter_period` | 159 | 0 | 1 | 0 |
| `time_stop_bars` | 158 | 0 | 0 | 0 |
| `vote_threshold_short` | 158 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 157 | 0 | 0 | 0 |
| `z_threshold` | 157 | 0 | 0 | 0 |
| `entry_aggressiveness` | 140 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 169 | 12% | 1 |
| `score_percentile_trigger` | 20 | 163 | 12% | 0 |
| `momentum_confirm_days` | 18 | 164 | 11% | 0 |
| `partial_take_level` | 8 | 170 | 5% | 1 |
| `signal_ema_span` | 7 | 162 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 161 | 4% | 0 |
| `entry_score_threshold` | 6 | 172 | 3% | 0 |
| `regime_threshold` | 6 | 179 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 158 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 169 | 3% | 0 |
| `ma_filter_mode` | 5 | 169 | 3% | 0 |
| `partial_take_pct` | 4 | 163 | 2% | 0 |
| `support_broken_gate` | 2 | 138 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 158 | 1% | 0 |
| `trailing_stop_mode` | 2 | 160 | 1% | 0 |
| `partial_take_pct_2` | 2 | 162 | 1% | 0 |
| `stop_tighten_factor` | 2 | 164 | 1% | 0 |
| `partial_take_level_2` | 2 | 165 | 1% | 0 |
| `resistance_overext_gate` | 1 | 138 | 1% | 0 |
| `vol_regime_mode` | 1 | 161 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T15:22:51+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
