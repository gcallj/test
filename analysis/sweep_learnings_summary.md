...
_Generated: 2026-09-09T00:15:08+00:00_
...
- Total sweeps seen: **1780**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **6.7%** (over 1804 total attempts)
...
|---|---:|---:|---:|---:|
| `vote_threshold_long` | 299 | 0 | 0 | 0 |
| `score_strength_scaling` | 299 | 0 | 0 | 0 |
| `reward_risk_ratio` | 299 | 0 | 0 | 0 |
| `min_signal_strength` | 298 | 0 | 0 | 0 |
| `entry_confirmation_days` | 297 | 0 | 0 | 0 |
| `vote_threshold_short` | 296 | 0 | 1 | 0 |
| `z_threshold` | 295 | 0 | 0 | 0 |
| `time_stop_bars` | 295 | 0 | 0 | 0 |
| `volume_confirm_mode` | 295 | 0 | 1 | 0 |
| `ma_filter_period` | 295 | 0 | 1 | 0 |
| `stop_atr_mult` | 293 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 291 | 0 | 0 | 0 |
| `entry_aggressiveness` | 278 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 306 | 7% | 1 |
| `score_percentile_trigger` | 20 | 301 | 7% | 0 |
| `momentum_confirm_days` | 18 | 300 | 6% | 0 |
| `partial_take_level` | 8 | 306 | 3% | 1 |
| `signal_ema_span` | 7 | 300 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 295 | 2% | 0 |
| `entry_score_threshold` | 6 | 310 | 2% | 0 |
| `regime_threshold` | 6 | 315 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 292 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 305 | 2% | 0 |
| `ma_filter_mode` | 5 | 305 | 2% | 0 |
| `partial_take_pct` | 4 | 299 | 1% | 0 |
| `support_broken_gate` | 2 | 274 | 1% | 0 |
| `trailing_stop_mode` | 2 | 296 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 296 | 1% | 0 |
| `stop_tighten_factor` | 2 | 298 | 1% | 0 |
| `partial_take_pct_2` | 2 | 298 | 1% | 0 |
| `partial_take_level_2` | 2 | 301 | 1% | 0 |
| `resistance_overext_gate` | 1 | 274 | 0% | 0 |
| `vol_regime_mode` | 1 | 297 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-09-09T00:15:06+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
