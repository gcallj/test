...
_Generated: 2026-05-21T19:25:02+00:00_
...
- Total sweeps seen: **731**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **16.0%** (over 755 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 124 | 0 | 0 | 0 |
| `vote_threshold_long` | 122 | 0 | 0 | 0 |
| `score_strength_scaling` | 122 | 0 | 0 | 0 |
| `stop_atr_mult` | 121 | 0 | 0 | 0 |
| `min_signal_strength` | 121 | 0 | 0 | 0 |
| `time_stop_bars` | 120 | 0 | 0 | 0 |
| `entry_confirmation_days` | 120 | 0 | 0 | 0 |
| `volume_confirm_mode` | 120 | 0 | 1 | 0 |
| `ma_filter_period` | 120 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 119 | 0 | 0 | 0 |
| `vote_threshold_short` | 119 | 0 | 1 | 0 |
| `z_threshold` | 118 | 0 | 0 | 0 |
| `entry_aggressiveness` | 101 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 131 | 16% | 1 |
| `score_percentile_trigger` | 20 | 124 | 16% | 0 |
| `momentum_confirm_days` | 18 | 125 | 14% | 0 |
| `partial_take_level` | 8 | 131 | 6% | 1 |
| `signal_ema_span` | 7 | 123 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 123 | 5% | 0 |
| `entry_score_threshold` | 6 | 133 | 5% | 0 |
| `regime_threshold` | 6 | 140 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 120 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 130 | 4% | 0 |
| `ma_filter_mode` | 5 | 130 | 4% | 0 |
| `partial_take_pct` | 4 | 124 | 3% | 0 |
| `support_broken_gate` | 2 | 99 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 119 | 2% | 0 |
| `trailing_stop_mode` | 2 | 121 | 2% | 0 |
| `partial_take_pct_2` | 2 | 123 | 2% | 0 |
| `stop_tighten_factor` | 2 | 126 | 2% | 0 |
| `partial_take_level_2` | 2 | 126 | 2% | 0 |
| `resistance_overext_gate` | 1 | 99 | 1% | 0 |
| `vol_regime_mode` | 1 | 122 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T19:25:01+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
