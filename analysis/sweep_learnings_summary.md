...
_Generated: 2026-05-22T22:27:13+00:00_
...
- Total sweeps seen: **875**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **13.5%** (over 899 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 148 | 0 | 0 | 0 |
| `vote_threshold_long` | 146 | 0 | 0 | 0 |
| `score_strength_scaling` | 146 | 0 | 0 | 0 |
| `stop_atr_mult` | 145 | 0 | 0 | 0 |
| `min_signal_strength` | 145 | 0 | 0 | 0 |
| `entry_confirmation_days` | 144 | 0 | 0 | 0 |
| `volume_confirm_mode` | 144 | 0 | 1 | 0 |
| `time_stop_bars` | 144 | 0 | 0 | 0 |
| `ma_filter_period` | 144 | 0 | 1 | 0 |
| `vote_threshold_short` | 143 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 143 | 0 | 0 | 0 |
| `z_threshold` | 142 | 0 | 0 | 0 |
| `entry_aggressiveness` | 125 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 155 | 14% | 1 |
| `score_percentile_trigger` | 20 | 148 | 14% | 0 |
| `momentum_confirm_days` | 18 | 149 | 12% | 0 |
| `partial_take_level` | 8 | 155 | 5% | 1 |
| `signal_ema_span` | 7 | 147 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 147 | 4% | 0 |
| `entry_score_threshold` | 6 | 157 | 4% | 0 |
| `regime_threshold` | 6 | 164 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 144 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 154 | 3% | 0 |
| `ma_filter_mode` | 5 | 154 | 3% | 0 |
| `partial_take_pct` | 4 | 148 | 3% | 0 |
| `support_broken_gate` | 2 | 123 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 143 | 1% | 0 |
| `trailing_stop_mode` | 2 | 145 | 1% | 0 |
| `partial_take_pct_2` | 2 | 147 | 1% | 0 |
| `stop_tighten_factor` | 2 | 150 | 1% | 0 |
| `partial_take_level_2` | 2 | 150 | 1% | 0 |
| `resistance_overext_gate` | 1 | 123 | 1% | 0 |
| `vol_regime_mode` | 1 | 146 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-22T22:27:12+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
