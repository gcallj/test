...
_Generated: 2026-07-06T01:58:18+00:00_
...
- Total sweeps seen: **1422**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.4%** (over 1446 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 240 | 0 | 0 | 0 |
| `score_strength_scaling` | 238 | 0 | 0 | 0 |
| `vote_threshold_long` | 238 | 0 | 0 | 0 |
| `min_signal_strength` | 237 | 0 | 0 | 0 |
| `volume_confirm_mode` | 236 | 0 | 1 | 0 |
| `entry_confirmation_days` | 236 | 0 | 0 | 0 |
| `ma_filter_period` | 236 | 0 | 1 | 0 |
| `vote_threshold_short` | 235 | 0 | 1 | 0 |
| `stop_atr_mult` | 234 | 0 | 0 | 0 |
| `time_stop_bars` | 234 | 0 | 0 | 0 |
| `z_threshold` | 234 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 232 | 0 | 0 | 0 |
| `entry_aggressiveness` | 217 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 245 | 9% | 1 |
| `score_percentile_trigger` | 20 | 240 | 8% | 0 |
| `momentum_confirm_days` | 18 | 241 | 7% | 0 |
| `partial_take_level` | 8 | 247 | 3% | 1 |
| `signal_ema_span` | 7 | 239 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 236 | 3% | 0 |
| `entry_score_threshold` | 6 | 249 | 2% | 0 |
| `regime_threshold` | 6 | 256 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 233 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 246 | 2% | 0 |
| `ma_filter_mode` | 5 | 246 | 2% | 0 |
| `partial_take_pct` | 4 | 240 | 2% | 0 |
| `support_broken_gate` | 2 | 215 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 235 | 1% | 0 |
| `trailing_stop_mode` | 2 | 237 | 1% | 0 |
| `stop_tighten_factor` | 2 | 239 | 1% | 0 |
| `partial_take_pct_2` | 2 | 239 | 1% | 0 |
| `partial_take_level_2` | 2 | 242 | 1% | 0 |
| `resistance_overext_gate` | 1 | 215 | 0% | 0 |
| `vol_regime_mode` | 1 | 238 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-07-06T01:58:17+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
