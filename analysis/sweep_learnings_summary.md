...
_Generated: 2026-05-21T01:18:49+00:00_
...
- Total sweeps seen: **647**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **18.0%** (over 671 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 110 | 0 | 0 | 0 |
| `vote_threshold_long` | 108 | 0 | 0 | 0 |
| `score_strength_scaling` | 108 | 0 | 0 | 0 |
| `stop_atr_mult` | 107 | 0 | 0 | 0 |
| `min_signal_strength` | 107 | 0 | 0 | 0 |
| `time_stop_bars` | 106 | 0 | 0 | 0 |
| `entry_confirmation_days` | 106 | 0 | 0 | 0 |
| `volume_confirm_mode` | 106 | 0 | 1 | 0 |
| `ma_filter_period` | 106 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 105 | 0 | 0 | 0 |
| `vote_threshold_short` | 105 | 0 | 1 | 0 |
| `z_threshold` | 104 | 0 | 0 | 0 |
| `entry_aggressiveness` | 87 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 117 | 18% | 1 |
| `score_percentile_trigger` | 20 | 110 | 18% | 0 |
| `momentum_confirm_days` | 18 | 111 | 16% | 0 |
| `partial_take_level` | 8 | 117 | 7% | 1 |
| `signal_ema_span` | 7 | 109 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 109 | 6% | 0 |
| `entry_score_threshold` | 6 | 119 | 5% | 0 |
| `regime_threshold` | 6 | 126 | 5% | 1 |
| `equity_drawdown_stop_pct` | 5 | 106 | 5% | 0 |
| `volatility_filter_percentile` | 5 | 116 | 4% | 0 |
| `ma_filter_mode` | 5 | 116 | 4% | 0 |
| `partial_take_pct` | 4 | 110 | 4% | 0 |
| `support_broken_gate` | 2 | 85 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 105 | 2% | 0 |
| `trailing_stop_mode` | 2 | 107 | 2% | 0 |
| `partial_take_pct_2` | 2 | 109 | 2% | 0 |
| `stop_tighten_factor` | 2 | 112 | 2% | 0 |
| `partial_take_level_2` | 2 | 112 | 2% | 0 |
| `resistance_overext_gate` | 1 | 85 | 1% | 0 |
| `vol_regime_mode` | 1 | 108 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T01:18:49+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
