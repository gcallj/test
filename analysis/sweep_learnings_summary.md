...
_Generated: 2026-05-21T02:34:23+00:00_
...
- Total sweeps seen: **653**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **17.9%** (over 677 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 111 | 0 | 0 | 0 |
| `vote_threshold_long` | 109 | 0 | 0 | 0 |
| `score_strength_scaling` | 109 | 0 | 0 | 0 |
| `stop_atr_mult` | 108 | 0 | 0 | 0 |
| `min_signal_strength` | 108 | 0 | 0 | 0 |
| `time_stop_bars` | 107 | 0 | 0 | 0 |
| `entry_confirmation_days` | 107 | 0 | 0 | 0 |
| `volume_confirm_mode` | 107 | 0 | 1 | 0 |
| `ma_filter_period` | 107 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 106 | 0 | 0 | 0 |
| `vote_threshold_short` | 106 | 0 | 1 | 0 |
| `z_threshold` | 105 | 0 | 0 | 0 |
| `entry_aggressiveness` | 88 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 118 | 18% | 1 |
| `score_percentile_trigger` | 20 | 111 | 18% | 0 |
| `momentum_confirm_days` | 18 | 112 | 16% | 0 |
| `partial_take_level` | 8 | 118 | 7% | 1 |
| `signal_ema_span` | 7 | 110 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 110 | 5% | 0 |
| `entry_score_threshold` | 6 | 120 | 5% | 0 |
| `regime_threshold` | 6 | 127 | 5% | 1 |
| `equity_drawdown_stop_pct` | 5 | 107 | 5% | 0 |
| `volatility_filter_percentile` | 5 | 117 | 4% | 0 |
| `ma_filter_mode` | 5 | 117 | 4% | 0 |
| `partial_take_pct` | 4 | 111 | 4% | 0 |
| `support_broken_gate` | 2 | 86 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 106 | 2% | 0 |
| `trailing_stop_mode` | 2 | 108 | 2% | 0 |
| `partial_take_pct_2` | 2 | 110 | 2% | 0 |
| `stop_tighten_factor` | 2 | 113 | 2% | 0 |
| `partial_take_level_2` | 2 | 113 | 2% | 0 |
| `resistance_overext_gate` | 1 | 86 | 1% | 0 |
| `vol_regime_mode` | 1 | 109 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T02:34:22+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
