...
_Generated: 2026-06-04T04:14:37+00:00_
...
- Total sweeps seen: **1245**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.5%** (over 1269 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 210 | 0 | 0 | 0 |
| `vote_threshold_long` | 208 | 0 | 0 | 0 |
| `score_strength_scaling` | 208 | 0 | 0 | 0 |
| `min_signal_strength` | 207 | 0 | 0 | 0 |
| `stop_atr_mult` | 206 | 0 | 0 | 0 |
| `entry_confirmation_days` | 206 | 0 | 0 | 0 |
| `volume_confirm_mode` | 206 | 0 | 1 | 0 |
| `ma_filter_period` | 206 | 0 | 1 | 0 |
| `time_stop_bars` | 205 | 0 | 0 | 0 |
| `vote_threshold_short` | 205 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 204 | 0 | 0 | 0 |
| `z_threshold` | 204 | 0 | 0 | 0 |
| `entry_aggressiveness` | 187 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 216 | 10% | 1 |
| `score_percentile_trigger` | 20 | 210 | 10% | 0 |
| `momentum_confirm_days` | 18 | 211 | 9% | 0 |
| `partial_take_level` | 8 | 217 | 4% | 1 |
| `signal_ema_span` | 7 | 209 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 208 | 3% | 0 |
| `entry_score_threshold` | 6 | 219 | 3% | 0 |
| `regime_threshold` | 6 | 226 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 205 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 216 | 2% | 0 |
| `ma_filter_mode` | 5 | 216 | 2% | 0 |
| `partial_take_pct` | 4 | 210 | 2% | 0 |
| `support_broken_gate` | 2 | 185 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 205 | 1% | 0 |
| `trailing_stop_mode` | 2 | 207 | 1% | 0 |
| `partial_take_pct_2` | 2 | 209 | 1% | 0 |
| `stop_tighten_factor` | 2 | 211 | 1% | 0 |
| `partial_take_level_2` | 2 | 212 | 1% | 0 |
| `resistance_overext_gate` | 1 | 185 | 1% | 0 |
| `vol_regime_mode` | 1 | 208 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-04T04:14:36+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
