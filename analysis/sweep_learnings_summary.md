...
_Generated: 2026-08-21T12:26:05+00:00_
...
- Total sweeps seen: **1630**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.3%** (over 1654 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 274 | 0 | 0 | 0 |
| `score_strength_scaling` | 274 | 0 | 0 | 0 |
| `vote_threshold_long` | 274 | 0 | 0 | 0 |
| `min_signal_strength` | 273 | 0 | 0 | 0 |
| `entry_confirmation_days` | 272 | 0 | 0 | 0 |
| `vote_threshold_short` | 271 | 0 | 1 | 0 |
| `time_stop_bars` | 270 | 0 | 0 | 0 |
| `volume_confirm_mode` | 270 | 0 | 1 | 0 |
| `z_threshold` | 270 | 0 | 0 | 0 |
| `ma_filter_period` | 270 | 0 | 1 | 0 |
| `stop_atr_mult` | 268 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 266 | 0 | 0 | 0 |
| `entry_aggressiveness` | 253 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 281 | 7% | 1 |
| `score_percentile_trigger` | 20 | 276 | 7% | 0 |
| `momentum_confirm_days` | 18 | 275 | 7% | 0 |
| `partial_take_level` | 8 | 281 | 3% | 1 |
| `signal_ema_span` | 7 | 275 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 270 | 2% | 0 |
| `entry_score_threshold` | 6 | 285 | 2% | 0 |
| `regime_threshold` | 6 | 290 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 267 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 280 | 2% | 0 |
| `ma_filter_mode` | 5 | 280 | 2% | 0 |
| `partial_take_pct` | 4 | 274 | 1% | 0 |
| `support_broken_gate` | 2 | 249 | 1% | 0 |
| `trailing_stop_mode` | 2 | 271 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 271 | 1% | 0 |
| `stop_tighten_factor` | 2 | 273 | 1% | 0 |
| `partial_take_pct_2` | 2 | 273 | 1% | 0 |
| `partial_take_level_2` | 2 | 276 | 1% | 0 |
| `resistance_overext_gate` | 1 | 249 | 0% | 0 |
| `vol_regime_mode` | 1 | 272 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-21T12:26:04+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
