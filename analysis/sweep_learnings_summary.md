...
_Generated: 2026-05-24T02:05:19+00:00_
...
- Total sweeps seen: **1005**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **11.8%** (over 1029 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 170 | 0 | 0 | 0 |
| `vote_threshold_long` | 168 | 0 | 0 | 0 |
| `score_strength_scaling` | 168 | 0 | 0 | 0 |
| `min_signal_strength` | 167 | 0 | 0 | 0 |
| `stop_atr_mult` | 166 | 0 | 0 | 0 |
| `entry_confirmation_days` | 166 | 0 | 0 | 0 |
| `volume_confirm_mode` | 166 | 0 | 1 | 0 |
| `ma_filter_period` | 166 | 0 | 1 | 0 |
| `vote_threshold_short` | 165 | 0 | 1 | 0 |
| `time_stop_bars` | 165 | 0 | 0 | 0 |
| `z_threshold` | 164 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 164 | 0 | 0 | 0 |
| `entry_aggressiveness` | 147 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 176 | 12% | 1 |
| `score_percentile_trigger` | 20 | 170 | 12% | 0 |
| `momentum_confirm_days` | 18 | 171 | 11% | 0 |
| `partial_take_level` | 8 | 177 | 5% | 1 |
| `signal_ema_span` | 7 | 169 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 168 | 4% | 0 |
| `entry_score_threshold` | 6 | 179 | 3% | 0 |
| `regime_threshold` | 6 | 186 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 165 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 176 | 3% | 0 |
| `ma_filter_mode` | 5 | 176 | 3% | 0 |
| `partial_take_pct` | 4 | 170 | 2% | 0 |
| `support_broken_gate` | 2 | 145 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 165 | 1% | 0 |
| `trailing_stop_mode` | 2 | 167 | 1% | 0 |
| `partial_take_pct_2` | 2 | 169 | 1% | 0 |
| `stop_tighten_factor` | 2 | 171 | 1% | 0 |
| `partial_take_level_2` | 2 | 172 | 1% | 0 |
| `resistance_overext_gate` | 1 | 145 | 1% | 0 |
| `vol_regime_mode` | 1 | 168 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-24T02:05:17+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
