...
_Generated: 2026-06-08T18:13:06+00:00_
...
- Total sweeps seen: **1293**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.2%** (over 1317 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 218 | 0 | 0 | 0 |
| `vote_threshold_long` | 216 | 0 | 0 | 0 |
| `score_strength_scaling` | 216 | 0 | 0 | 0 |
| `min_signal_strength` | 215 | 0 | 0 | 0 |
| `stop_atr_mult` | 214 | 0 | 0 | 0 |
| `entry_confirmation_days` | 214 | 0 | 0 | 0 |
| `volume_confirm_mode` | 214 | 0 | 1 | 0 |
| `ma_filter_period` | 214 | 0 | 1 | 0 |
| `time_stop_bars` | 213 | 0 | 0 | 0 |
| `vote_threshold_short` | 213 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 212 | 0 | 0 | 0 |
| `z_threshold` | 212 | 0 | 0 | 0 |
| `entry_aggressiveness` | 195 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 224 | 9% | 1 |
| `score_percentile_trigger` | 20 | 218 | 9% | 0 |
| `momentum_confirm_days` | 18 | 219 | 8% | 0 |
| `partial_take_level` | 8 | 225 | 4% | 1 |
| `signal_ema_span` | 7 | 217 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 216 | 3% | 0 |
| `entry_score_threshold` | 6 | 227 | 3% | 0 |
| `regime_threshold` | 6 | 234 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 213 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 224 | 2% | 0 |
| `ma_filter_mode` | 5 | 224 | 2% | 0 |
| `partial_take_pct` | 4 | 218 | 2% | 0 |
| `support_broken_gate` | 2 | 193 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 213 | 1% | 0 |
| `trailing_stop_mode` | 2 | 215 | 1% | 0 |
| `partial_take_pct_2` | 2 | 217 | 1% | 0 |
| `stop_tighten_factor` | 2 | 219 | 1% | 0 |
| `partial_take_level_2` | 2 | 220 | 1% | 0 |
| `resistance_overext_gate` | 1 | 193 | 1% | 0 |
| `vol_regime_mode` | 1 | 216 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-08T18:13:05+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
