...
_Generated: 2026-07-25T12:45:32+00:00_
...
- Total sweeps seen: **1496**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.0%** (over 1520 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 252 | 0 | 0 | 0 |
| `vote_threshold_long` | 251 | 0 | 0 | 0 |
| `score_strength_scaling` | 251 | 0 | 0 | 0 |
| `min_signal_strength` | 250 | 0 | 0 | 0 |
| `entry_confirmation_days` | 249 | 0 | 0 | 0 |
| `volume_confirm_mode` | 248 | 0 | 1 | 0 |
| `vote_threshold_short` | 248 | 0 | 1 | 0 |
| `ma_filter_period` | 248 | 0 | 1 | 0 |
| `time_stop_bars` | 247 | 0 | 0 | 0 |
| `z_threshold` | 247 | 0 | 0 | 0 |
| `stop_atr_mult` | 246 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 244 | 0 | 0 | 0 |
| `entry_aggressiveness` | 230 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 258 | 8% | 1 |
| `score_percentile_trigger` | 20 | 253 | 8% | 0 |
| `momentum_confirm_days` | 18 | 253 | 7% | 0 |
| `partial_take_level` | 8 | 259 | 3% | 1 |
| `signal_ema_span` | 7 | 252 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 248 | 2% | 0 |
| `entry_score_threshold` | 6 | 262 | 2% | 0 |
| `regime_threshold` | 6 | 268 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 245 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 258 | 2% | 0 |
| `ma_filter_mode` | 5 | 258 | 2% | 0 |
| `partial_take_pct` | 4 | 252 | 2% | 0 |
| `support_broken_gate` | 2 | 227 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 248 | 1% | 0 |
| `trailing_stop_mode` | 2 | 249 | 1% | 0 |
| `stop_tighten_factor` | 2 | 251 | 1% | 0 |
| `partial_take_pct_2` | 2 | 251 | 1% | 0 |
| `partial_take_level_2` | 2 | 254 | 1% | 0 |
| `resistance_overext_gate` | 1 | 227 | 0% | 0 |
| `vol_regime_mode` | 1 | 250 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-07-25T12:45:31+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
