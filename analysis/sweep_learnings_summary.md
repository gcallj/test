...
_Generated: 2026-05-18T16:31:47+00:00_
...
- Total sweeps seen: **335**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **33.7%** (over 359 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 58 | 0 | 0 | 0 |
| `vote_threshold_long` | 56 | 0 | 0 | 0 |
| `score_strength_scaling` | 56 | 0 | 0 | 0 |
| `stop_atr_mult` | 55 | 0 | 0 | 0 |
| `min_signal_strength` | 55 | 0 | 0 | 0 |
| `time_stop_bars` | 54 | 0 | 0 | 0 |
| `entry_confirmation_days` | 54 | 0 | 0 | 0 |
| `volume_confirm_mode` | 54 | 0 | 1 | 0 |
| `ma_filter_period` | 54 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 53 | 0 | 0 | 0 |
| `vote_threshold_short` | 53 | 0 | 1 | 0 |
| `z_threshold` | 52 | 0 | 0 | 0 |
| `entry_aggressiveness` | 35 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 65 | 32% | 1 |
| `score_percentile_trigger` | 20 | 58 | 34% | 0 |
| `momentum_confirm_days` | 18 | 59 | 31% | 0 |
| `partial_take_level` | 8 | 65 | 12% | 1 |
| `signal_ema_span` | 7 | 57 | 12% | 0 |
| `max_loss_per_trade_pct` | 6 | 57 | 11% | 0 |
| `entry_score_threshold` | 6 | 67 | 9% | 0 |
| `regime_threshold` | 6 | 74 | 8% | 1 |
| `equity_drawdown_stop_pct` | 5 | 54 | 9% | 0 |
| `volatility_filter_percentile` | 5 | 64 | 8% | 0 |
| `ma_filter_mode` | 5 | 64 | 8% | 0 |
| `partial_take_pct` | 4 | 58 | 7% | 0 |
| `support_broken_gate` | 2 | 33 | 6% | 0 |
| `entry_discount_atr_frac` | 2 | 53 | 4% | 0 |
| `trailing_stop_mode` | 2 | 55 | 4% | 0 |
| `partial_take_pct_2` | 2 | 57 | 4% | 0 |
| `stop_tighten_factor` | 2 | 60 | 3% | 0 |
| `partial_take_level_2` | 2 | 60 | 3% | 0 |
| `resistance_overext_gate` | 1 | 33 | 3% | 0 |
| `vol_regime_mode` | 1 | 56 | 2% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-18T16:31:47+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
