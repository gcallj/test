...
_Generated: 2026-05-21T17:10:41+00:00_
...
- Total sweeps seen: **719**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **16.3%** (over 743 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 122 | 0 | 0 | 0 |
| `vote_threshold_long` | 120 | 0 | 0 | 0 |
| `score_strength_scaling` | 120 | 0 | 0 | 0 |
| `stop_atr_mult` | 119 | 0 | 0 | 0 |
| `min_signal_strength` | 119 | 0 | 0 | 0 |
| `time_stop_bars` | 118 | 0 | 0 | 0 |
| `entry_confirmation_days` | 118 | 0 | 0 | 0 |
| `volume_confirm_mode` | 118 | 0 | 1 | 0 |
| `ma_filter_period` | 118 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 117 | 0 | 0 | 0 |
| `vote_threshold_short` | 117 | 0 | 1 | 0 |
| `z_threshold` | 116 | 0 | 0 | 0 |
| `entry_aggressiveness` | 99 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 129 | 16% | 1 |
| `score_percentile_trigger` | 20 | 122 | 16% | 0 |
| `momentum_confirm_days` | 18 | 123 | 15% | 0 |
| `partial_take_level` | 8 | 129 | 6% | 1 |
| `signal_ema_span` | 7 | 121 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 121 | 5% | 0 |
| `entry_score_threshold` | 6 | 131 | 5% | 0 |
| `regime_threshold` | 6 | 138 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 118 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 128 | 4% | 0 |
| `ma_filter_mode` | 5 | 128 | 4% | 0 |
| `partial_take_pct` | 4 | 122 | 3% | 0 |
| `support_broken_gate` | 2 | 97 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 117 | 2% | 0 |
| `trailing_stop_mode` | 2 | 119 | 2% | 0 |
| `partial_take_pct_2` | 2 | 121 | 2% | 0 |
| `stop_tighten_factor` | 2 | 124 | 2% | 0 |
| `partial_take_level_2` | 2 | 124 | 2% | 0 |
| `resistance_overext_gate` | 1 | 97 | 1% | 0 |
| `vol_regime_mode` | 1 | 120 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T17:10:41+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
