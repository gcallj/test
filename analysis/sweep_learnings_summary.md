...
_Generated: 2026-05-20T03:32:39+00:00_
...
- Total sweeps seen: **533**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **21.7%** (over 557 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 91 | 0 | 0 | 0 |
| `vote_threshold_long` | 89 | 0 | 0 | 0 |
| `score_strength_scaling` | 89 | 0 | 0 | 0 |
| `stop_atr_mult` | 88 | 0 | 0 | 0 |
| `min_signal_strength` | 88 | 0 | 0 | 0 |
| `time_stop_bars` | 87 | 0 | 0 | 0 |
| `entry_confirmation_days` | 87 | 0 | 0 | 0 |
| `volume_confirm_mode` | 87 | 0 | 1 | 0 |
| `ma_filter_period` | 87 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 86 | 0 | 0 | 0 |
| `vote_threshold_short` | 86 | 0 | 1 | 0 |
| `z_threshold` | 85 | 0 | 0 | 0 |
| `entry_aggressiveness` | 68 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 98 | 21% | 1 |
| `score_percentile_trigger` | 20 | 91 | 22% | 0 |
| `momentum_confirm_days` | 18 | 92 | 20% | 0 |
| `partial_take_level` | 8 | 98 | 8% | 1 |
| `signal_ema_span` | 7 | 90 | 8% | 0 |
| `max_loss_per_trade_pct` | 6 | 90 | 7% | 0 |
| `entry_score_threshold` | 6 | 100 | 6% | 0 |
| `regime_threshold` | 6 | 107 | 6% | 1 |
| `equity_drawdown_stop_pct` | 5 | 87 | 6% | 0 |
| `volatility_filter_percentile` | 5 | 97 | 5% | 0 |
| `ma_filter_mode` | 5 | 97 | 5% | 0 |
| `partial_take_pct` | 4 | 91 | 4% | 0 |
| `support_broken_gate` | 2 | 66 | 3% | 0 |
| `entry_discount_atr_frac` | 2 | 86 | 2% | 0 |
| `trailing_stop_mode` | 2 | 88 | 2% | 0 |
| `partial_take_pct_2` | 2 | 90 | 2% | 0 |
| `stop_tighten_factor` | 2 | 93 | 2% | 0 |
| `partial_take_level_2` | 2 | 93 | 2% | 0 |
| `resistance_overext_gate` | 1 | 66 | 2% | 0 |
| `vol_regime_mode` | 1 | 89 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T03:32:38+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
