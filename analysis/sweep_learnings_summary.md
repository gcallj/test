...
_Generated: 2026-05-22T07:13:51+00:00_
...
- Total sweeps seen: **797**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **14.7%** (over 821 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 135 | 0 | 0 | 0 |
| `vote_threshold_long` | 133 | 0 | 0 | 0 |
| `score_strength_scaling` | 133 | 0 | 0 | 0 |
| `stop_atr_mult` | 132 | 0 | 0 | 0 |
| `min_signal_strength` | 132 | 0 | 0 | 0 |
| `entry_confirmation_days` | 131 | 0 | 0 | 0 |
| `volume_confirm_mode` | 131 | 0 | 1 | 0 |
| `time_stop_bars` | 131 | 0 | 0 | 0 |
| `ma_filter_period` | 131 | 0 | 1 | 0 |
| `vote_threshold_short` | 130 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 130 | 0 | 0 | 0 |
| `z_threshold` | 129 | 0 | 0 | 0 |
| `entry_aggressiveness` | 112 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 142 | 15% | 1 |
| `score_percentile_trigger` | 20 | 135 | 15% | 0 |
| `momentum_confirm_days` | 18 | 136 | 13% | 0 |
| `partial_take_level` | 8 | 142 | 6% | 1 |
| `signal_ema_span` | 7 | 134 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 134 | 4% | 0 |
| `entry_score_threshold` | 6 | 144 | 4% | 0 |
| `regime_threshold` | 6 | 151 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 131 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 141 | 4% | 0 |
| `ma_filter_mode` | 5 | 141 | 4% | 0 |
| `partial_take_pct` | 4 | 135 | 3% | 0 |
| `support_broken_gate` | 2 | 110 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 130 | 2% | 0 |
| `trailing_stop_mode` | 2 | 132 | 2% | 0 |
| `partial_take_pct_2` | 2 | 134 | 1% | 0 |
| `stop_tighten_factor` | 2 | 137 | 1% | 0 |
| `partial_take_level_2` | 2 | 137 | 1% | 0 |
| `resistance_overext_gate` | 1 | 110 | 1% | 0 |
| `vol_regime_mode` | 1 | 133 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-22T07:13:51+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
