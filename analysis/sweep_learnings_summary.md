...
_Generated: 2026-05-22T08:46:31+00:00_
...
- Total sweeps seen: **803**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **14.6%** (over 827 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 136 | 0 | 0 | 0 |
| `vote_threshold_long` | 134 | 0 | 0 | 0 |
| `score_strength_scaling` | 134 | 0 | 0 | 0 |
| `min_signal_strength` | 133 | 0 | 0 | 0 |
| `stop_atr_mult` | 133 | 0 | 0 | 0 |
| `entry_confirmation_days` | 132 | 0 | 0 | 0 |
| `volume_confirm_mode` | 132 | 0 | 1 | 0 |
| `time_stop_bars` | 132 | 0 | 0 | 0 |
| `ma_filter_period` | 132 | 0 | 1 | 0 |
| `vote_threshold_short` | 131 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 131 | 0 | 0 | 0 |
| `z_threshold` | 130 | 0 | 0 | 0 |
| `entry_aggressiveness` | 113 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 143 | 15% | 1 |
| `score_percentile_trigger` | 20 | 136 | 15% | 0 |
| `momentum_confirm_days` | 18 | 137 | 13% | 0 |
| `partial_take_level` | 8 | 143 | 6% | 1 |
| `signal_ema_span` | 7 | 135 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 135 | 4% | 0 |
| `entry_score_threshold` | 6 | 145 | 4% | 0 |
| `regime_threshold` | 6 | 152 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 132 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 142 | 4% | 0 |
| `ma_filter_mode` | 5 | 142 | 4% | 0 |
| `partial_take_pct` | 4 | 136 | 3% | 0 |
| `support_broken_gate` | 2 | 111 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 131 | 2% | 0 |
| `trailing_stop_mode` | 2 | 133 | 2% | 0 |
| `partial_take_pct_2` | 2 | 135 | 1% | 0 |
| `stop_tighten_factor` | 2 | 138 | 1% | 0 |
| `partial_take_level_2` | 2 | 138 | 1% | 0 |
| `resistance_overext_gate` | 1 | 111 | 1% | 0 |
| `vol_regime_mode` | 1 | 134 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-22T08:46:30+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
