...
_Generated: 2026-05-26T05:39:41+00:00_
...
- Total sweeps seen: **1101**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.8%** (over 1125 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 186 | 0 | 0 | 0 |
| `vote_threshold_long` | 184 | 0 | 0 | 0 |
| `score_strength_scaling` | 184 | 0 | 0 | 0 |
| `min_signal_strength` | 183 | 0 | 0 | 0 |
| `stop_atr_mult` | 182 | 0 | 0 | 0 |
| `entry_confirmation_days` | 182 | 0 | 0 | 0 |
| `volume_confirm_mode` | 182 | 0 | 1 | 0 |
| `ma_filter_period` | 182 | 0 | 1 | 0 |
| `vote_threshold_short` | 181 | 0 | 1 | 0 |
| `time_stop_bars` | 181 | 0 | 0 | 0 |
| `z_threshold` | 180 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 180 | 0 | 0 | 0 |
| `entry_aggressiveness` | 163 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 192 | 11% | 1 |
| `score_percentile_trigger` | 20 | 186 | 11% | 0 |
| `momentum_confirm_days` | 18 | 187 | 10% | 0 |
| `partial_take_level` | 8 | 193 | 4% | 1 |
| `signal_ema_span` | 7 | 185 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 184 | 3% | 0 |
| `entry_score_threshold` | 6 | 195 | 3% | 0 |
| `regime_threshold` | 6 | 202 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 181 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 192 | 3% | 0 |
| `ma_filter_mode` | 5 | 192 | 3% | 0 |
| `partial_take_pct` | 4 | 186 | 2% | 0 |
| `support_broken_gate` | 2 | 161 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 181 | 1% | 0 |
| `trailing_stop_mode` | 2 | 183 | 1% | 0 |
| `partial_take_pct_2` | 2 | 185 | 1% | 0 |
| `stop_tighten_factor` | 2 | 187 | 1% | 0 |
| `partial_take_level_2` | 2 | 188 | 1% | 0 |
| `resistance_overext_gate` | 1 | 161 | 1% | 0 |
| `vol_regime_mode` | 1 | 184 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-26T05:39:40+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
