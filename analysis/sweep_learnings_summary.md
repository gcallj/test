...
_Generated: 2026-05-20T23:32:02+00:00_
...
- Total sweeps seen: **635**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **18.4%** (over 659 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 108 | 0 | 0 | 0 |
| `vote_threshold_long` | 106 | 0 | 0 | 0 |
| `score_strength_scaling` | 106 | 0 | 0 | 0 |
| `stop_atr_mult` | 105 | 0 | 0 | 0 |
| `min_signal_strength` | 105 | 0 | 0 | 0 |
| `time_stop_bars` | 104 | 0 | 0 | 0 |
| `entry_confirmation_days` | 104 | 0 | 0 | 0 |
| `volume_confirm_mode` | 104 | 0 | 1 | 0 |
| `ma_filter_period` | 104 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 103 | 0 | 0 | 0 |
| `vote_threshold_short` | 103 | 0 | 1 | 0 |
| `z_threshold` | 102 | 0 | 0 | 0 |
| `entry_aggressiveness` | 85 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 115 | 18% | 1 |
| `score_percentile_trigger` | 20 | 108 | 19% | 0 |
| `momentum_confirm_days` | 18 | 109 | 17% | 0 |
| `partial_take_level` | 8 | 115 | 7% | 1 |
| `signal_ema_span` | 7 | 107 | 7% | 0 |
| `max_loss_per_trade_pct` | 6 | 107 | 6% | 0 |
| `entry_score_threshold` | 6 | 117 | 5% | 0 |
| `regime_threshold` | 6 | 124 | 5% | 1 |
| `equity_drawdown_stop_pct` | 5 | 104 | 5% | 0 |
| `volatility_filter_percentile` | 5 | 114 | 4% | 0 |
| `ma_filter_mode` | 5 | 114 | 4% | 0 |
| `partial_take_pct` | 4 | 108 | 4% | 0 |
| `support_broken_gate` | 2 | 83 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 103 | 2% | 0 |
| `trailing_stop_mode` | 2 | 105 | 2% | 0 |
| `partial_take_pct_2` | 2 | 107 | 2% | 0 |
| `stop_tighten_factor` | 2 | 110 | 2% | 0 |
| `partial_take_level_2` | 2 | 110 | 2% | 0 |
| `resistance_overext_gate` | 1 | 83 | 1% | 0 |
| `vol_regime_mode` | 1 | 106 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T23:32:01+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
