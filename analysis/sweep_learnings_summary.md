...
_Generated: 2026-09-05T05:59:43+00:00_
...
- Total sweeps seen: **1744**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **6.8%** (over 1768 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 293 | 0 | 0 | 0 |
| `vote_threshold_long` | 293 | 0 | 0 | 0 |
| `score_strength_scaling` | 293 | 0 | 0 | 0 |
| `min_signal_strength` | 292 | 0 | 0 | 0 |
| `entry_confirmation_days` | 291 | 0 | 0 | 0 |
| `vote_threshold_short` | 290 | 0 | 1 | 0 |
| `time_stop_bars` | 289 | 0 | 0 | 0 |
| `z_threshold` | 289 | 0 | 0 | 0 |
| `volume_confirm_mode` | 289 | 0 | 1 | 0 |
| `ma_filter_period` | 289 | 0 | 1 | 0 |
| `stop_atr_mult` | 287 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 285 | 0 | 0 | 0 |
| `entry_aggressiveness` | 272 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 300 | 7% | 1 |
| `score_percentile_trigger` | 20 | 295 | 7% | 0 |
| `momentum_confirm_days` | 18 | 294 | 6% | 0 |
| `partial_take_level` | 8 | 300 | 3% | 1 |
| `signal_ema_span` | 7 | 294 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 289 | 2% | 0 |
| `entry_score_threshold` | 6 | 304 | 2% | 0 |
| `regime_threshold` | 6 | 309 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 286 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 299 | 2% | 0 |
| `ma_filter_mode` | 5 | 299 | 2% | 0 |
| `partial_take_pct` | 4 | 293 | 1% | 0 |
| `support_broken_gate` | 2 | 268 | 1% | 0 |
| `trailing_stop_mode` | 2 | 290 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 290 | 1% | 0 |
| `stop_tighten_factor` | 2 | 292 | 1% | 0 |
| `partial_take_pct_2` | 2 | 292 | 1% | 0 |
| `partial_take_level_2` | 2 | 295 | 1% | 0 |
| `resistance_overext_gate` | 1 | 268 | 0% | 0 |
| `vol_regime_mode` | 1 | 291 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-09-05T05:59:42+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
