...
_Generated: 2026-05-28T01:15:29+00:00_
...
- Total sweeps seen: **1125**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.5%** (over 1149 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 190 | 0 | 0 | 0 |
| `vote_threshold_long` | 188 | 0 | 0 | 0 |
| `score_strength_scaling` | 188 | 0 | 0 | 0 |
| `min_signal_strength` | 187 | 0 | 0 | 0 |
| `entry_confirmation_days` | 186 | 0 | 0 | 0 |
| `stop_atr_mult` | 186 | 0 | 0 | 0 |
| `volume_confirm_mode` | 186 | 0 | 1 | 0 |
| `ma_filter_period` | 186 | 0 | 1 | 0 |
| `vote_threshold_short` | 185 | 0 | 1 | 0 |
| `time_stop_bars` | 185 | 0 | 0 | 0 |
| `z_threshold` | 184 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 184 | 0 | 0 | 0 |
| `entry_aggressiveness` | 167 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 196 | 11% | 1 |
| `score_percentile_trigger` | 20 | 190 | 11% | 0 |
| `momentum_confirm_days` | 18 | 191 | 9% | 0 |
| `partial_take_level` | 8 | 197 | 4% | 1 |
| `signal_ema_span` | 7 | 189 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 188 | 3% | 0 |
| `entry_score_threshold` | 6 | 199 | 3% | 0 |
| `regime_threshold` | 6 | 206 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 185 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 196 | 3% | 0 |
| `ma_filter_mode` | 5 | 196 | 3% | 0 |
| `partial_take_pct` | 4 | 190 | 2% | 0 |
| `support_broken_gate` | 2 | 165 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 185 | 1% | 0 |
| `trailing_stop_mode` | 2 | 187 | 1% | 0 |
| `partial_take_pct_2` | 2 | 189 | 1% | 0 |
| `stop_tighten_factor` | 2 | 191 | 1% | 0 |
| `partial_take_level_2` | 2 | 192 | 1% | 0 |
| `resistance_overext_gate` | 1 | 165 | 1% | 0 |
| `vol_regime_mode` | 1 | 188 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-28T01:15:29+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
