...
_Generated: 2026-05-23T22:29:23+00:00_
...
- Total sweeps seen: **993**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **11.9%** (over 1017 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 168 | 0 | 0 | 0 |
| `vote_threshold_long` | 166 | 0 | 0 | 0 |
| `score_strength_scaling` | 166 | 0 | 0 | 0 |
| `min_signal_strength` | 165 | 0 | 0 | 0 |
| `volume_confirm_mode` | 164 | 0 | 1 | 0 |
| `stop_atr_mult` | 164 | 0 | 0 | 0 |
| `entry_confirmation_days` | 164 | 0 | 0 | 0 |
| `ma_filter_period` | 164 | 0 | 1 | 0 |
| `time_stop_bars` | 163 | 0 | 0 | 0 |
| `vote_threshold_short` | 163 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 162 | 0 | 0 | 0 |
| `z_threshold` | 162 | 0 | 0 | 0 |
| `entry_aggressiveness` | 145 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 174 | 12% | 1 |
| `score_percentile_trigger` | 20 | 168 | 12% | 0 |
| `momentum_confirm_days` | 18 | 169 | 11% | 0 |
| `partial_take_level` | 8 | 175 | 5% | 1 |
| `signal_ema_span` | 7 | 167 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 166 | 4% | 0 |
| `entry_score_threshold` | 6 | 177 | 3% | 0 |
| `regime_threshold` | 6 | 184 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 163 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 174 | 3% | 0 |
| `ma_filter_mode` | 5 | 174 | 3% | 0 |
| `partial_take_pct` | 4 | 168 | 2% | 0 |
| `support_broken_gate` | 2 | 143 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 163 | 1% | 0 |
| `trailing_stop_mode` | 2 | 165 | 1% | 0 |
| `partial_take_pct_2` | 2 | 167 | 1% | 0 |
| `stop_tighten_factor` | 2 | 169 | 1% | 0 |
| `partial_take_level_2` | 2 | 170 | 1% | 0 |
| `resistance_overext_gate` | 1 | 143 | 1% | 0 |
| `vol_regime_mode` | 1 | 166 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T22:29:22+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
