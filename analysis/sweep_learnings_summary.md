...
_Generated: 2026-05-19T13:12:42+00:00_
...
- Total sweeps seen: **449**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **25.6%** (over 473 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 77 | 0 | 0 | 0 |
| `vote_threshold_long` | 75 | 0 | 0 | 0 |
| `score_strength_scaling` | 75 | 0 | 0 | 0 |
| `stop_atr_mult` | 74 | 0 | 0 | 0 |
| `min_signal_strength` | 74 | 0 | 0 | 0 |
| `entry_confirmation_days` | 73 | 0 | 0 | 0 |
| `volume_confirm_mode` | 73 | 0 | 1 | 0 |
| `time_stop_bars` | 73 | 0 | 0 | 0 |
| `ma_filter_period` | 73 | 0 | 1 | 0 |
| `vote_threshold_short` | 72 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 72 | 0 | 0 | 0 |
| `z_threshold` | 71 | 0 | 0 | 0 |
| `entry_aggressiveness` | 54 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 84 | 25% | 1 |
| `score_percentile_trigger` | 20 | 77 | 26% | 0 |
| `momentum_confirm_days` | 18 | 78 | 23% | 0 |
| `partial_take_level` | 8 | 84 | 10% | 1 |
| `signal_ema_span` | 7 | 76 | 9% | 0 |
| `max_loss_per_trade_pct` | 6 | 76 | 8% | 0 |
| `entry_score_threshold` | 6 | 86 | 7% | 0 |
| `regime_threshold` | 6 | 93 | 6% | 1 |
| `equity_drawdown_stop_pct` | 5 | 73 | 7% | 0 |
| `volatility_filter_percentile` | 5 | 83 | 6% | 0 |
| `ma_filter_mode` | 5 | 83 | 6% | 0 |
| `partial_take_pct` | 4 | 77 | 5% | 0 |
| `support_broken_gate` | 2 | 52 | 4% | 0 |
| `entry_discount_atr_frac` | 2 | 72 | 3% | 0 |
| `trailing_stop_mode` | 2 | 74 | 3% | 0 |
| `partial_take_pct_2` | 2 | 76 | 3% | 0 |
| `stop_tighten_factor` | 2 | 79 | 3% | 0 |
| `partial_take_level_2` | 2 | 79 | 3% | 0 |
| `resistance_overext_gate` | 1 | 52 | 2% | 0 |
| `vol_regime_mode` | 1 | 75 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-19T13:12:42+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
