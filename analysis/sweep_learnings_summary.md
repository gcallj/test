...
_Generated: 2026-06-21T09:15:35+00:00_
...
- Total sweeps seen: **1363**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.7%** (over 1387 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 230 | 0 | 0 | 0 |
| `vote_threshold_long` | 228 | 0 | 0 | 0 |
| `score_strength_scaling` | 228 | 0 | 0 | 0 |
| `min_signal_strength` | 227 | 0 | 0 | 0 |
| `entry_confirmation_days` | 226 | 0 | 0 | 0 |
| `volume_confirm_mode` | 226 | 0 | 1 | 0 |
| `ma_filter_period` | 226 | 0 | 1 | 0 |
| `stop_atr_mult` | 225 | 0 | 0 | 0 |
| `vote_threshold_short` | 225 | 0 | 1 | 0 |
| `time_stop_bars` | 224 | 0 | 0 | 0 |
| `z_threshold` | 224 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 223 | 0 | 0 | 0 |
| `entry_aggressiveness` | 207 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 235 | 9% | 1 |
| `score_percentile_trigger` | 20 | 230 | 9% | 0 |
| `momentum_confirm_days` | 18 | 231 | 8% | 0 |
| `partial_take_level` | 8 | 237 | 3% | 1 |
| `signal_ema_span` | 7 | 229 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 227 | 3% | 0 |
| `entry_score_threshold` | 6 | 239 | 3% | 0 |
| `regime_threshold` | 6 | 246 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 224 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 236 | 2% | 0 |
| `ma_filter_mode` | 5 | 236 | 2% | 0 |
| `partial_take_pct` | 4 | 230 | 2% | 0 |
| `support_broken_gate` | 2 | 205 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 225 | 1% | 0 |
| `trailing_stop_mode` | 2 | 227 | 1% | 0 |
| `partial_take_pct_2` | 2 | 229 | 1% | 0 |
| `stop_tighten_factor` | 2 | 230 | 1% | 0 |
| `partial_take_level_2` | 2 | 232 | 1% | 0 |
| `resistance_overext_gate` | 1 | 205 | 0% | 0 |
| `vol_regime_mode` | 1 | 228 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-21T09:15:34+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
