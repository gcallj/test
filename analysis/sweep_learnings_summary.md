...
_Generated: 2026-05-20T07:57:42+00:00_
...
- Total sweeps seen: **551**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **21.0%** (over 575 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 94 | 0 | 0 | 0 |
| `vote_threshold_long` | 92 | 0 | 0 | 0 |
| `score_strength_scaling` | 92 | 0 | 0 | 0 |
| `stop_atr_mult` | 91 | 0 | 0 | 0 |
| `min_signal_strength` | 91 | 0 | 0 | 0 |
| `time_stop_bars` | 90 | 0 | 0 | 0 |
| `entry_confirmation_days` | 90 | 0 | 0 | 0 |
| `volume_confirm_mode` | 90 | 0 | 1 | 0 |
| `ma_filter_period` | 90 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 89 | 0 | 0 | 0 |
| `vote_threshold_short` | 89 | 0 | 1 | 0 |
| `z_threshold` | 88 | 0 | 0 | 0 |
| `entry_aggressiveness` | 71 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 101 | 21% | 1 |
| `score_percentile_trigger` | 20 | 94 | 21% | 0 |
| `momentum_confirm_days` | 18 | 95 | 19% | 0 |
| `partial_take_level` | 8 | 101 | 8% | 1 |
| `signal_ema_span` | 7 | 93 | 8% | 0 |
| `max_loss_per_trade_pct` | 6 | 93 | 6% | 0 |
| `entry_score_threshold` | 6 | 103 | 6% | 0 |
| `regime_threshold` | 6 | 110 | 5% | 1 |
| `equity_drawdown_stop_pct` | 5 | 90 | 6% | 0 |
| `volatility_filter_percentile` | 5 | 100 | 5% | 0 |
| `ma_filter_mode` | 5 | 100 | 5% | 0 |
| `partial_take_pct` | 4 | 94 | 4% | 0 |
| `support_broken_gate` | 2 | 69 | 3% | 0 |
| `entry_discount_atr_frac` | 2 | 89 | 2% | 0 |
| `trailing_stop_mode` | 2 | 91 | 2% | 0 |
| `partial_take_pct_2` | 2 | 93 | 2% | 0 |
| `stop_tighten_factor` | 2 | 96 | 2% | 0 |
| `partial_take_level_2` | 2 | 96 | 2% | 0 |
| `resistance_overext_gate` | 1 | 69 | 1% | 0 |
| `vol_regime_mode` | 1 | 92 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T07:57:42+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
