...
_Generated: 2026-05-24T03:18:17+00:00_
...
- Total sweeps seen: **1011**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **11.7%** (over 1035 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 171 | 0 | 0 | 0 |
| `vote_threshold_long` | 169 | 0 | 0 | 0 |
| `score_strength_scaling` | 169 | 0 | 0 | 0 |
| `min_signal_strength` | 168 | 0 | 0 | 0 |
| `entry_confirmation_days` | 167 | 0 | 0 | 0 |
| `volume_confirm_mode` | 167 | 0 | 1 | 0 |
| `stop_atr_mult` | 167 | 0 | 0 | 0 |
| `ma_filter_period` | 167 | 0 | 1 | 0 |
| `vote_threshold_short` | 166 | 0 | 1 | 0 |
| `time_stop_bars` | 166 | 0 | 0 | 0 |
| `z_threshold` | 165 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 165 | 0 | 0 | 0 |
| `entry_aggressiveness` | 148 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 177 | 12% | 1 |
| `score_percentile_trigger` | 20 | 171 | 12% | 0 |
| `momentum_confirm_days` | 18 | 172 | 10% | 0 |
| `partial_take_level` | 8 | 178 | 4% | 1 |
| `signal_ema_span` | 7 | 170 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 169 | 4% | 0 |
| `entry_score_threshold` | 6 | 180 | 3% | 0 |
| `regime_threshold` | 6 | 187 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 166 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 177 | 3% | 0 |
| `ma_filter_mode` | 5 | 177 | 3% | 0 |
| `partial_take_pct` | 4 | 171 | 2% | 0 |
| `support_broken_gate` | 2 | 146 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 166 | 1% | 0 |
| `trailing_stop_mode` | 2 | 168 | 1% | 0 |
| `partial_take_pct_2` | 2 | 170 | 1% | 0 |
| `stop_tighten_factor` | 2 | 172 | 1% | 0 |
| `partial_take_level_2` | 2 | 173 | 1% | 0 |
| `resistance_overext_gate` | 1 | 146 | 1% | 0 |
| `vol_regime_mode` | 1 | 169 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-24T03:18:16+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
