...
_Generated: 2026-05-23T16:33:55+00:00_
...
- Total sweeps seen: **969**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.2%** (over 993 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 164 | 0 | 0 | 0 |
| `vote_threshold_long` | 162 | 0 | 0 | 0 |
| `score_strength_scaling` | 162 | 0 | 0 | 0 |
| `min_signal_strength` | 161 | 0 | 0 | 0 |
| `stop_atr_mult` | 160 | 0 | 0 | 0 |
| `entry_confirmation_days` | 160 | 0 | 0 | 0 |
| `volume_confirm_mode` | 160 | 0 | 1 | 0 |
| `ma_filter_period` | 160 | 0 | 1 | 0 |
| `time_stop_bars` | 159 | 0 | 0 | 0 |
| `vote_threshold_short` | 159 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 158 | 0 | 0 | 0 |
| `z_threshold` | 158 | 0 | 0 | 0 |
| `entry_aggressiveness` | 141 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 170 | 12% | 1 |
| `score_percentile_trigger` | 20 | 164 | 12% | 0 |
| `momentum_confirm_days` | 18 | 165 | 11% | 0 |
| `partial_take_level` | 8 | 171 | 5% | 1 |
| `signal_ema_span` | 7 | 163 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 162 | 4% | 0 |
| `entry_score_threshold` | 6 | 173 | 3% | 0 |
| `regime_threshold` | 6 | 180 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 159 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 170 | 3% | 0 |
| `ma_filter_mode` | 5 | 170 | 3% | 0 |
| `partial_take_pct` | 4 | 164 | 2% | 0 |
| `support_broken_gate` | 2 | 139 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 159 | 1% | 0 |
| `trailing_stop_mode` | 2 | 161 | 1% | 0 |
| `partial_take_pct_2` | 2 | 163 | 1% | 0 |
| `stop_tighten_factor` | 2 | 165 | 1% | 0 |
| `partial_take_level_2` | 2 | 166 | 1% | 0 |
| `resistance_overext_gate` | 1 | 139 | 1% | 0 |
| `vol_regime_mode` | 1 | 162 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T16:33:54+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
