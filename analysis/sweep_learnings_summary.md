...
_Generated: 2026-05-26T04:48:34+00:00_
...
- Total sweeps seen: **1095**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.8%** (over 1119 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 185 | 0 | 0 | 0 |
| `vote_threshold_long` | 183 | 0 | 0 | 0 |
| `score_strength_scaling` | 183 | 0 | 0 | 0 |
| `min_signal_strength` | 182 | 0 | 0 | 0 |
| `entry_confirmation_days` | 181 | 0 | 0 | 0 |
| `volume_confirm_mode` | 181 | 0 | 1 | 0 |
| `stop_atr_mult` | 181 | 0 | 0 | 0 |
| `ma_filter_period` | 181 | 0 | 1 | 0 |
| `vote_threshold_short` | 180 | 0 | 1 | 0 |
| `time_stop_bars` | 180 | 0 | 0 | 0 |
| `z_threshold` | 179 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 179 | 0 | 0 | 0 |
| `entry_aggressiveness` | 162 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 191 | 11% | 1 |
| `score_percentile_trigger` | 20 | 185 | 11% | 0 |
| `momentum_confirm_days` | 18 | 186 | 10% | 0 |
| `partial_take_level` | 8 | 192 | 4% | 1 |
| `signal_ema_span` | 7 | 184 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 183 | 3% | 0 |
| `entry_score_threshold` | 6 | 194 | 3% | 0 |
| `regime_threshold` | 6 | 201 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 180 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 191 | 3% | 0 |
| `ma_filter_mode` | 5 | 191 | 3% | 0 |
| `partial_take_pct` | 4 | 185 | 2% | 0 |
| `support_broken_gate` | 2 | 160 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 180 | 1% | 0 |
| `trailing_stop_mode` | 2 | 182 | 1% | 0 |
| `partial_take_pct_2` | 2 | 184 | 1% | 0 |
| `stop_tighten_factor` | 2 | 186 | 1% | 0 |
| `partial_take_level_2` | 2 | 187 | 1% | 0 |
| `resistance_overext_gate` | 1 | 160 | 1% | 0 |
| `vol_regime_mode` | 1 | 183 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-26T04:48:33+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
