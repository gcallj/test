...
_Generated: 2026-05-27T06:52:43+00:00_
...
- Total sweeps seen: **1113**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.6%** (over 1137 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 188 | 0 | 0 | 0 |
| `vote_threshold_long` | 186 | 0 | 0 | 0 |
| `score_strength_scaling` | 186 | 0 | 0 | 0 |
| `min_signal_strength` | 185 | 0 | 0 | 0 |
| `stop_atr_mult` | 184 | 0 | 0 | 0 |
| `entry_confirmation_days` | 184 | 0 | 0 | 0 |
| `volume_confirm_mode` | 184 | 0 | 1 | 0 |
| `ma_filter_period` | 184 | 0 | 1 | 0 |
| `time_stop_bars` | 183 | 0 | 0 | 0 |
| `vote_threshold_short` | 183 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 182 | 0 | 0 | 0 |
| `z_threshold` | 182 | 0 | 0 | 0 |
| `entry_aggressiveness` | 165 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 194 | 11% | 1 |
| `score_percentile_trigger` | 20 | 188 | 11% | 0 |
| `momentum_confirm_days` | 18 | 189 | 10% | 0 |
| `partial_take_level` | 8 | 195 | 4% | 1 |
| `signal_ema_span` | 7 | 187 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 186 | 3% | 0 |
| `entry_score_threshold` | 6 | 197 | 3% | 0 |
| `regime_threshold` | 6 | 204 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 183 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 194 | 3% | 0 |
| `ma_filter_mode` | 5 | 194 | 3% | 0 |
| `partial_take_pct` | 4 | 188 | 2% | 0 |
| `support_broken_gate` | 2 | 163 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 183 | 1% | 0 |
| `trailing_stop_mode` | 2 | 185 | 1% | 0 |
| `partial_take_pct_2` | 2 | 187 | 1% | 0 |
| `stop_tighten_factor` | 2 | 189 | 1% | 0 |
| `partial_take_level_2` | 2 | 190 | 1% | 0 |
| `resistance_overext_gate` | 1 | 163 | 1% | 0 |
| `vol_regime_mode` | 1 | 186 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-27T06:52:42+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
