...
_Generated: 2026-08-22T05:19:08+00:00_
...
- Total sweeps seen: **1642**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.3%** (over 1666 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 276 | 0 | 0 | 0 |
| `vote_threshold_long` | 276 | 0 | 0 | 0 |
| `score_strength_scaling` | 276 | 0 | 0 | 0 |
| `min_signal_strength` | 275 | 0 | 0 | 0 |
| `entry_confirmation_days` | 274 | 0 | 0 | 0 |
| `vote_threshold_short` | 273 | 0 | 1 | 0 |
| `time_stop_bars` | 272 | 0 | 0 | 0 |
| `volume_confirm_mode` | 272 | 0 | 1 | 0 |
| `z_threshold` | 272 | 0 | 0 | 0 |
| `ma_filter_period` | 272 | 0 | 1 | 0 |
| `stop_atr_mult` | 270 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 268 | 0 | 0 | 0 |
| `entry_aggressiveness` | 255 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 283 | 7% | 1 |
| `score_percentile_trigger` | 20 | 278 | 7% | 0 |
| `momentum_confirm_days` | 18 | 277 | 6% | 0 |
| `partial_take_level` | 8 | 283 | 3% | 1 |
| `signal_ema_span` | 7 | 277 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 272 | 2% | 0 |
| `entry_score_threshold` | 6 | 287 | 2% | 0 |
| `regime_threshold` | 6 | 292 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 269 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 282 | 2% | 0 |
| `ma_filter_mode` | 5 | 282 | 2% | 0 |
| `partial_take_pct` | 4 | 276 | 1% | 0 |
| `support_broken_gate` | 2 | 251 | 1% | 0 |
| `trailing_stop_mode` | 2 | 273 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 273 | 1% | 0 |
| `stop_tighten_factor` | 2 | 275 | 1% | 0 |
| `partial_take_pct_2` | 2 | 275 | 1% | 0 |
| `partial_take_level_2` | 2 | 278 | 1% | 0 |
| `resistance_overext_gate` | 1 | 251 | 0% | 0 |
| `vol_regime_mode` | 1 | 274 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-22T05:19:06+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
