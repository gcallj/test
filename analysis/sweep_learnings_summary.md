...
_Generated: 2026-07-09T04:08:59+00:00_
...
- Total sweeps seen: **1428**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.3%** (over 1452 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 241 | 0 | 0 | 0 |
| `vote_threshold_long` | 239 | 0 | 0 | 0 |
| `score_strength_scaling` | 239 | 0 | 0 | 0 |
| `min_signal_strength` | 238 | 0 | 0 | 0 |
| `entry_confirmation_days` | 237 | 0 | 0 | 0 |
| `volume_confirm_mode` | 237 | 0 | 1 | 0 |
| `ma_filter_period` | 237 | 0 | 1 | 0 |
| `vote_threshold_short` | 236 | 0 | 1 | 0 |
| `stop_atr_mult` | 235 | 0 | 0 | 0 |
| `time_stop_bars` | 235 | 0 | 0 | 0 |
| `z_threshold` | 235 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 233 | 0 | 0 | 0 |
| `entry_aggressiveness` | 218 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 246 | 9% | 1 |
| `score_percentile_trigger` | 20 | 241 | 8% | 0 |
| `momentum_confirm_days` | 18 | 242 | 7% | 0 |
| `partial_take_level` | 8 | 248 | 3% | 1 |
| `signal_ema_span` | 7 | 240 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 237 | 3% | 0 |
| `entry_score_threshold` | 6 | 250 | 2% | 0 |
| `regime_threshold` | 6 | 257 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 234 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 247 | 2% | 0 |
| `ma_filter_mode` | 5 | 247 | 2% | 0 |
| `partial_take_pct` | 4 | 241 | 2% | 0 |
| `support_broken_gate` | 2 | 216 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 236 | 1% | 0 |
| `trailing_stop_mode` | 2 | 238 | 1% | 0 |
| `stop_tighten_factor` | 2 | 240 | 1% | 0 |
| `partial_take_pct_2` | 2 | 240 | 1% | 0 |
| `partial_take_level_2` | 2 | 243 | 1% | 0 |
| `resistance_overext_gate` | 1 | 216 | 0% | 0 |
| `vol_regime_mode` | 1 | 239 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-07-09T04:08:58+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
