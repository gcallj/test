...
_Generated: 2026-05-21T00:34:38+00:00_
...
- Total sweeps seen: **641**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **18.2%** (over 665 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 109 | 0 | 0 | 0 |
| `vote_threshold_long` | 107 | 0 | 0 | 0 |
| `score_strength_scaling` | 107 | 0 | 0 | 0 |
| `stop_atr_mult` | 106 | 0 | 0 | 0 |
| `min_signal_strength` | 106 | 0 | 0 | 0 |
| `entry_confirmation_days` | 105 | 0 | 0 | 0 |
| `volume_confirm_mode` | 105 | 0 | 1 | 0 |
| `time_stop_bars` | 105 | 0 | 0 | 0 |
| `ma_filter_period` | 105 | 0 | 1 | 0 |
| `vote_threshold_short` | 104 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 104 | 0 | 0 | 0 |
| `z_threshold` | 103 | 0 | 0 | 0 |
| `entry_aggressiveness` | 86 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 116 | 18% | 1 |
| `score_percentile_trigger` | 20 | 109 | 18% | 0 |
| `momentum_confirm_days` | 18 | 110 | 16% | 0 |
| `partial_take_level` | 8 | 116 | 7% | 1 |
| `signal_ema_span` | 7 | 108 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 108 | 6% | 0 |
| `entry_score_threshold` | 6 | 118 | 5% | 0 |
| `regime_threshold` | 6 | 125 | 5% | 1 |
| `equity_drawdown_stop_pct` | 5 | 105 | 5% | 0 |
| `volatility_filter_percentile` | 5 | 115 | 4% | 0 |
| `ma_filter_mode` | 5 | 115 | 4% | 0 |
| `partial_take_pct` | 4 | 109 | 4% | 0 |
| `support_broken_gate` | 2 | 84 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 104 | 2% | 0 |
| `trailing_stop_mode` | 2 | 106 | 2% | 0 |
| `partial_take_pct_2` | 2 | 108 | 2% | 0 |
| `stop_tighten_factor` | 2 | 111 | 2% | 0 |
| `partial_take_level_2` | 2 | 111 | 2% | 0 |
| `resistance_overext_gate` | 1 | 84 | 1% | 0 |
| `vol_regime_mode` | 1 | 107 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T00:34:38+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
