...
_Generated: 2026-05-30T01:17:09+00:00_
...
- Total sweeps seen: **1149**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.3%** (over 1173 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 194 | 0 | 0 | 0 |
| `vote_threshold_long` | 192 | 0 | 0 | 0 |
| `score_strength_scaling` | 192 | 0 | 0 | 0 |
| `min_signal_strength` | 191 | 0 | 0 | 0 |
| `entry_confirmation_days` | 190 | 0 | 0 | 0 |
| `stop_atr_mult` | 190 | 0 | 0 | 0 |
| `volume_confirm_mode` | 190 | 0 | 1 | 0 |
| `ma_filter_period` | 190 | 0 | 1 | 0 |
| `vote_threshold_short` | 189 | 0 | 1 | 0 |
| `time_stop_bars` | 189 | 0 | 0 | 0 |
| `z_threshold` | 188 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 188 | 0 | 0 | 0 |
| `entry_aggressiveness` | 171 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 200 | 10% | 1 |
| `score_percentile_trigger` | 20 | 194 | 10% | 0 |
| `momentum_confirm_days` | 18 | 195 | 9% | 0 |
| `partial_take_level` | 8 | 201 | 4% | 1 |
| `signal_ema_span` | 7 | 193 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 192 | 3% | 0 |
| `entry_score_threshold` | 6 | 203 | 3% | 0 |
| `regime_threshold` | 6 | 210 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 189 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 200 | 2% | 0 |
| `ma_filter_mode` | 5 | 200 | 2% | 0 |
| `partial_take_pct` | 4 | 194 | 2% | 0 |
| `support_broken_gate` | 2 | 169 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 189 | 1% | 0 |
| `trailing_stop_mode` | 2 | 191 | 1% | 0 |
| `partial_take_pct_2` | 2 | 193 | 1% | 0 |
| `stop_tighten_factor` | 2 | 195 | 1% | 0 |
| `partial_take_level_2` | 2 | 196 | 1% | 0 |
| `resistance_overext_gate` | 1 | 169 | 1% | 0 |
| `vol_regime_mode` | 1 | 192 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-30T01:17:08+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
