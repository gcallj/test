...
_Generated: 2026-05-25T21:33:14+00:00_
...
- Total sweeps seen: **1083**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.9%** (over 1107 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 183 | 0 | 0 | 0 |
| `vote_threshold_long` | 181 | 0 | 0 | 0 |
| `score_strength_scaling` | 181 | 0 | 0 | 0 |
| `min_signal_strength` | 180 | 0 | 0 | 0 |
| `stop_atr_mult` | 179 | 0 | 0 | 0 |
| `entry_confirmation_days` | 179 | 0 | 0 | 0 |
| `volume_confirm_mode` | 179 | 0 | 1 | 0 |
| `ma_filter_period` | 179 | 0 | 1 | 0 |
| `time_stop_bars` | 178 | 0 | 0 | 0 |
| `vote_threshold_short` | 178 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 177 | 0 | 0 | 0 |
| `z_threshold` | 177 | 0 | 0 | 0 |
| `entry_aggressiveness` | 160 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 189 | 11% | 1 |
| `score_percentile_trigger` | 20 | 183 | 11% | 0 |
| `momentum_confirm_days` | 18 | 184 | 10% | 0 |
| `partial_take_level` | 8 | 190 | 4% | 1 |
| `signal_ema_span` | 7 | 182 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 181 | 3% | 0 |
| `entry_score_threshold` | 6 | 192 | 3% | 0 |
| `regime_threshold` | 6 | 199 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 178 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 189 | 3% | 0 |
| `ma_filter_mode` | 5 | 189 | 3% | 0 |
| `partial_take_pct` | 4 | 183 | 2% | 0 |
| `support_broken_gate` | 2 | 158 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 178 | 1% | 0 |
| `trailing_stop_mode` | 2 | 180 | 1% | 0 |
| `partial_take_pct_2` | 2 | 182 | 1% | 0 |
| `stop_tighten_factor` | 2 | 184 | 1% | 0 |
| `partial_take_level_2` | 2 | 185 | 1% | 0 |
| `resistance_overext_gate` | 1 | 158 | 1% | 0 |
| `vol_regime_mode` | 1 | 181 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-25T21:33:13+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
