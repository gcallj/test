...
_Generated: 2026-05-20T01:26:01+00:00_
...
- Total sweeps seen: **521**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **22.2%** (over 545 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 89 | 0 | 0 | 0 |
| `vote_threshold_long` | 87 | 0 | 0 | 0 |
| `score_strength_scaling` | 87 | 0 | 0 | 0 |
| `min_signal_strength` | 86 | 0 | 0 | 0 |
| `stop_atr_mult` | 86 | 0 | 0 | 0 |
| `entry_confirmation_days` | 85 | 0 | 0 | 0 |
| `volume_confirm_mode` | 85 | 0 | 1 | 0 |
| `time_stop_bars` | 85 | 0 | 0 | 0 |
| `ma_filter_period` | 85 | 0 | 1 | 0 |
| `vote_threshold_short` | 84 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 84 | 0 | 0 | 0 |
| `z_threshold` | 83 | 0 | 0 | 0 |
| `entry_aggressiveness` | 66 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 96 | 22% | 1 |
| `score_percentile_trigger` | 20 | 89 | 22% | 0 |
| `momentum_confirm_days` | 18 | 90 | 20% | 0 |
| `partial_take_level` | 8 | 96 | 8% | 1 |
| `signal_ema_span` | 7 | 88 | 8% | 0 |
| `max_loss_per_trade_pct` | 6 | 88 | 7% | 0 |
| `entry_score_threshold` | 6 | 98 | 6% | 0 |
| `regime_threshold` | 6 | 105 | 6% | 1 |
| `equity_drawdown_stop_pct` | 5 | 85 | 6% | 0 |
| `volatility_filter_percentile` | 5 | 95 | 5% | 0 |
| `ma_filter_mode` | 5 | 95 | 5% | 0 |
| `partial_take_pct` | 4 | 89 | 4% | 0 |
| `support_broken_gate` | 2 | 64 | 3% | 0 |
| `entry_discount_atr_frac` | 2 | 84 | 2% | 0 |
| `trailing_stop_mode` | 2 | 86 | 2% | 0 |
| `partial_take_pct_2` | 2 | 88 | 2% | 0 |
| `stop_tighten_factor` | 2 | 91 | 2% | 0 |
| `partial_take_level_2` | 2 | 91 | 2% | 0 |
| `resistance_overext_gate` | 1 | 64 | 2% | 0 |
| `vol_regime_mode` | 1 | 87 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T01:26:01+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
