...
_Generated: 2026-08-15T21:22:18+00:00_
...
- Total sweeps seen: **1586**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.5%** (over 1610 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 267 | 0 | 0 | 0 |
| `vote_threshold_long` | 266 | 0 | 0 | 0 |
| `score_strength_scaling` | 266 | 0 | 0 | 0 |
| `min_signal_strength` | 265 | 0 | 0 | 0 |
| `entry_confirmation_days` | 264 | 0 | 0 | 0 |
| `volume_confirm_mode` | 263 | 0 | 1 | 0 |
| `vote_threshold_short` | 263 | 0 | 1 | 0 |
| `ma_filter_period` | 263 | 0 | 1 | 0 |
| `time_stop_bars` | 262 | 0 | 0 | 0 |
| `z_threshold` | 262 | 0 | 0 | 0 |
| `stop_atr_mult` | 261 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 259 | 0 | 0 | 0 |
| `entry_aggressiveness` | 245 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 273 | 8% | 1 |
| `score_percentile_trigger` | 20 | 268 | 7% | 0 |
| `momentum_confirm_days` | 18 | 268 | 7% | 0 |
| `partial_take_level` | 8 | 274 | 3% | 1 |
| `signal_ema_span` | 7 | 267 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 263 | 2% | 0 |
| `entry_score_threshold` | 6 | 277 | 2% | 0 |
| `regime_threshold` | 6 | 283 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 260 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 273 | 2% | 0 |
| `ma_filter_mode` | 5 | 273 | 2% | 0 |
| `partial_take_pct` | 4 | 267 | 1% | 0 |
| `support_broken_gate` | 2 | 242 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 263 | 1% | 0 |
| `trailing_stop_mode` | 2 | 264 | 1% | 0 |
| `stop_tighten_factor` | 2 | 266 | 1% | 0 |
| `partial_take_pct_2` | 2 | 266 | 1% | 0 |
| `partial_take_level_2` | 2 | 269 | 1% | 0 |
| `resistance_overext_gate` | 1 | 242 | 0% | 0 |
| `vol_regime_mode` | 1 | 265 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-15T21:22:17+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
