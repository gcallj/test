...
_Generated: 2026-05-19T16:52:33+00:00_
...
- Total sweeps seen: **467**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **24.6%** (over 491 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 80 | 0 | 0 | 0 |
| `vote_threshold_long` | 78 | 0 | 0 | 0 |
| `score_strength_scaling` | 78 | 0 | 0 | 0 |
| `stop_atr_mult` | 77 | 0 | 0 | 0 |
| `min_signal_strength` | 77 | 0 | 0 | 0 |
| `entry_confirmation_days` | 76 | 0 | 0 | 0 |
| `volume_confirm_mode` | 76 | 0 | 1 | 0 |
| `time_stop_bars` | 76 | 0 | 0 | 0 |
| `ma_filter_period` | 76 | 0 | 1 | 0 |
| `vote_threshold_short` | 75 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 75 | 0 | 0 | 0 |
| `z_threshold` | 74 | 0 | 0 | 0 |
| `entry_aggressiveness` | 57 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 87 | 24% | 1 |
| `score_percentile_trigger` | 20 | 80 | 25% | 0 |
| `momentum_confirm_days` | 18 | 81 | 22% | 0 |
| `partial_take_level` | 8 | 87 | 9% | 1 |
| `signal_ema_span` | 7 | 79 | 9% | 0 |
| `max_loss_per_trade_pct` | 6 | 79 | 8% | 0 |
| `entry_score_threshold` | 6 | 89 | 7% | 0 |
| `regime_threshold` | 6 | 96 | 6% | 1 |
| `equity_drawdown_stop_pct` | 5 | 76 | 7% | 0 |
| `volatility_filter_percentile` | 5 | 86 | 6% | 0 |
| `ma_filter_mode` | 5 | 86 | 6% | 0 |
| `partial_take_pct` | 4 | 80 | 5% | 0 |
| `support_broken_gate` | 2 | 55 | 4% | 0 |
| `entry_discount_atr_frac` | 2 | 75 | 3% | 0 |
| `trailing_stop_mode` | 2 | 77 | 3% | 0 |
| `partial_take_pct_2` | 2 | 79 | 3% | 0 |
| `stop_tighten_factor` | 2 | 82 | 2% | 0 |
| `partial_take_level_2` | 2 | 82 | 2% | 0 |
| `resistance_overext_gate` | 1 | 55 | 2% | 0 |
| `vol_regime_mode` | 1 | 78 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-19T16:52:33+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
