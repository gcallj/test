...
_Generated: 2026-05-18T09:02:49+00:00_
...
- Total sweeps seen: **299**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **37.5%** (over 323 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 52 | 0 | 0 | 0 |
| `vote_threshold_long` | 50 | 0 | 0 | 0 |
| `score_strength_scaling` | 50 | 0 | 0 | 0 |
| `stop_atr_mult` | 49 | 0 | 0 | 0 |
| `min_signal_strength` | 49 | 0 | 0 | 0 |
| `entry_confirmation_days` | 48 | 0 | 0 | 0 |
| `volume_confirm_mode` | 48 | 0 | 1 | 0 |
| `time_stop_bars` | 48 | 0 | 0 | 0 |
| `ma_filter_period` | 48 | 0 | 1 | 0 |
| `vote_threshold_short` | 47 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 47 | 0 | 0 | 0 |
| `z_threshold` | 46 | 0 | 0 | 0 |
| `entry_aggressiveness` | 29 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 59 | 36% | 1 |
| `score_percentile_trigger` | 20 | 52 | 38% | 0 |
| `momentum_confirm_days` | 18 | 53 | 34% | 0 |
| `partial_take_level` | 8 | 59 | 14% | 1 |
| `signal_ema_span` | 7 | 51 | 14% | 0 |
| `max_loss_per_trade_pct` | 6 | 51 | 12% | 0 |
| `entry_score_threshold` | 6 | 61 | 10% | 0 |
| `regime_threshold` | 6 | 68 | 9% | 1 |
| `equity_drawdown_stop_pct` | 5 | 48 | 10% | 0 |
| `volatility_filter_percentile` | 5 | 58 | 9% | 0 |
| `ma_filter_mode` | 5 | 58 | 9% | 0 |
| `partial_take_pct` | 4 | 52 | 8% | 0 |
| `support_broken_gate` | 2 | 27 | 7% | 0 |
| `entry_discount_atr_frac` | 2 | 47 | 4% | 0 |
| `trailing_stop_mode` | 2 | 49 | 4% | 0 |
| `partial_take_pct_2` | 2 | 51 | 4% | 0 |
| `stop_tighten_factor` | 2 | 54 | 4% | 0 |
| `partial_take_level_2` | 2 | 54 | 4% | 0 |
| `resistance_overext_gate` | 1 | 27 | 4% | 0 |
| `vol_regime_mode` | 1 | 50 | 2% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-18T09:02:49+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
