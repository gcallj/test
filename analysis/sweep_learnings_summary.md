...
_Generated: 2026-08-21T13:35:12+00:00_
...
- Total sweeps seen: **1636**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.3%** (over 1660 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 275 | 0 | 0 | 0 |
| `vote_threshold_long` | 275 | 0 | 0 | 0 |
| `score_strength_scaling` | 275 | 0 | 0 | 0 |
| `min_signal_strength` | 274 | 0 | 0 | 0 |
| `entry_confirmation_days` | 273 | 0 | 0 | 0 |
| `vote_threshold_short` | 272 | 0 | 1 | 0 |
| `time_stop_bars` | 271 | 0 | 0 | 0 |
| `volume_confirm_mode` | 271 | 0 | 1 | 0 |
| `z_threshold` | 271 | 0 | 0 | 0 |
| `ma_filter_period` | 271 | 0 | 1 | 0 |
| `stop_atr_mult` | 269 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 267 | 0 | 0 | 0 |
| `entry_aggressiveness` | 254 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 282 | 7% | 1 |
| `score_percentile_trigger` | 20 | 277 | 7% | 0 |
| `momentum_confirm_days` | 18 | 276 | 7% | 0 |
| `partial_take_level` | 8 | 282 | 3% | 1 |
| `signal_ema_span` | 7 | 276 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 271 | 2% | 0 |
| `entry_score_threshold` | 6 | 286 | 2% | 0 |
| `regime_threshold` | 6 | 291 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 268 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 281 | 2% | 0 |
| `ma_filter_mode` | 5 | 281 | 2% | 0 |
| `partial_take_pct` | 4 | 275 | 1% | 0 |
| `support_broken_gate` | 2 | 250 | 1% | 0 |
| `trailing_stop_mode` | 2 | 272 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 272 | 1% | 0 |
| `stop_tighten_factor` | 2 | 274 | 1% | 0 |
| `partial_take_pct_2` | 2 | 274 | 1% | 0 |
| `partial_take_level_2` | 2 | 277 | 1% | 0 |
| `resistance_overext_gate` | 1 | 250 | 0% | 0 |
| `vol_regime_mode` | 1 | 273 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-21T13:35:10+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
