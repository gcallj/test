...
_Generated: 2026-05-23T21:18:05+00:00_
...
- Total sweeps seen: **987**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.0%** (over 1011 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 167 | 0 | 0 | 0 |
| `vote_threshold_long` | 165 | 0 | 0 | 0 |
| `score_strength_scaling` | 165 | 0 | 0 | 0 |
| `min_signal_strength` | 164 | 0 | 0 | 0 |
| `stop_atr_mult` | 163 | 0 | 0 | 0 |
| `entry_confirmation_days` | 163 | 0 | 0 | 0 |
| `volume_confirm_mode` | 163 | 0 | 1 | 0 |
| `ma_filter_period` | 163 | 0 | 1 | 0 |
| `time_stop_bars` | 162 | 0 | 0 | 0 |
| `vote_threshold_short` | 162 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 161 | 0 | 0 | 0 |
| `z_threshold` | 161 | 0 | 0 | 0 |
| `entry_aggressiveness` | 144 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 173 | 12% | 1 |
| `score_percentile_trigger` | 20 | 167 | 12% | 0 |
| `momentum_confirm_days` | 18 | 168 | 11% | 0 |
| `partial_take_level` | 8 | 174 | 5% | 1 |
| `signal_ema_span` | 7 | 166 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 165 | 4% | 0 |
| `entry_score_threshold` | 6 | 176 | 3% | 0 |
| `regime_threshold` | 6 | 183 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 162 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 173 | 3% | 0 |
| `ma_filter_mode` | 5 | 173 | 3% | 0 |
| `partial_take_pct` | 4 | 167 | 2% | 0 |
| `support_broken_gate` | 2 | 142 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 162 | 1% | 0 |
| `trailing_stop_mode` | 2 | 164 | 1% | 0 |
| `partial_take_pct_2` | 2 | 166 | 1% | 0 |
| `stop_tighten_factor` | 2 | 168 | 1% | 0 |
| `partial_take_level_2` | 2 | 169 | 1% | 0 |
| `resistance_overext_gate` | 1 | 142 | 1% | 0 |
| `vol_regime_mode` | 1 | 165 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T21:18:04+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
