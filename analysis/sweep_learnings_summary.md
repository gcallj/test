...
_Generated: 2026-04-21T12:07:32+00:00_
...
- Checkpoint fitness: `27.03896611378459`
- Total sweeps seen: **126**
- Total promotions: **55** (including 1 from codex log)
- Promotion rate: **36.7%** (over 150 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 23 | 0 | 0 | 0 |
| `score_strength_scaling` | 21 | 0 | 0 | 0 |
| `vote_threshold_long` | 21 | 0 | 0 | 0 |
| `stop_atr_mult` | 20 | 0 | 0 | 0 |
| `time_stop_bars` | 20 | 0 | 0 | 0 |
| `min_signal_strength` | 20 | 0 | 0 | 0 |
| `volume_confirm_mode` | 19 | 0 | 1 | 0 |
| `entry_confirmation_days` | 19 | 0 | 0 | 0 |
| `ma_filter_period` | 19 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 18 | 0 | 0 | 0 |
| `vote_threshold_short` | 18 | 0 | 1 | 0 |
| `z_threshold` | 17 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `momentum_confirm_days` | 8 | 24 | 33% | 0 |
| `consecutive_loss_cooldown` | 7 | 31 | 23% | 1 |
| `regime_threshold` | 6 | 39 | 15% | 1 |
| `equity_drawdown_stop_pct` | 5 | 19 | 26% | 0 |
| `score_percentile_trigger` | 5 | 23 | 22% | 0 |
| `partial_take_level` | 4 | 30 | 13% | 1 |
| `entry_score_threshold` | 4 | 32 | 12% | 0 |
| `max_loss_per_trade_pct` | 3 | 22 | 14% | 0 |
| `partial_take_pct` | 3 | 23 | 13% | 0 |
| `ma_filter_mode` | 3 | 29 | 10% | 0 |
| `partial_take_pct_2` | 2 | 22 | 9% | 0 |
| `signal_ema_span` | 2 | 22 | 9% | 0 |
| `stop_tighten_factor` | 2 | 25 | 8% | 0 |
| `entry_discount_atr_frac` | 1 | 18 | 6% | 0 |
| `trailing_stop_mode` | 1 | 20 | 5% | 0 |
| `vol_regime_mode` | 1 | 21 | 5% | 0 |
| `partial_take_level_2` | 1 | 25 | 4% | 0 |
| `volatility_filter_percentile` | 1 | 29 | 3% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-04-21T12:07:31+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
