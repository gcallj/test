...
_Generated: 2026-07-10T19:30:24+00:00_
...
- Total sweeps seen: **1434**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.3%** (over 1458 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 242 | 0 | 0 | 0 |
| `score_strength_scaling` | 240 | 0 | 0 | 0 |
| `vote_threshold_long` | 240 | 0 | 0 | 0 |
| `min_signal_strength` | 239 | 0 | 0 | 0 |
| `volume_confirm_mode` | 238 | 0 | 1 | 0 |
| `entry_confirmation_days` | 238 | 0 | 0 | 0 |
| `ma_filter_period` | 238 | 0 | 1 | 0 |
| `vote_threshold_short` | 237 | 0 | 1 | 0 |
| `stop_atr_mult` | 236 | 0 | 0 | 0 |
| `time_stop_bars` | 236 | 0 | 0 | 0 |
| `z_threshold` | 236 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 234 | 0 | 0 | 0 |
| `entry_aggressiveness` | 219 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 247 | 9% | 1 |
| `score_percentile_trigger` | 20 | 242 | 8% | 0 |
| `momentum_confirm_days` | 18 | 243 | 7% | 0 |
| `partial_take_level` | 8 | 249 | 3% | 1 |
| `signal_ema_span` | 7 | 241 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 238 | 3% | 0 |
| `entry_score_threshold` | 6 | 251 | 2% | 0 |
| `regime_threshold` | 6 | 258 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 235 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 248 | 2% | 0 |
| `ma_filter_mode` | 5 | 248 | 2% | 0 |
| `partial_take_pct` | 4 | 242 | 2% | 0 |
| `support_broken_gate` | 2 | 217 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 237 | 1% | 0 |
| `trailing_stop_mode` | 2 | 239 | 1% | 0 |
| `stop_tighten_factor` | 2 | 241 | 1% | 0 |
| `partial_take_pct_2` | 2 | 241 | 1% | 0 |
| `partial_take_level_2` | 2 | 244 | 1% | 0 |
| `resistance_overext_gate` | 1 | 217 | 0% | 0 |
| `vol_regime_mode` | 1 | 240 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-07-10T19:30:23+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
