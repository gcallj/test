...
_Generated: 2026-08-23T17:41:12+00:00_
...
- Total sweeps seen: **1648**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.2%** (over 1672 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 277 | 0 | 0 | 0 |
| `vote_threshold_long` | 277 | 0 | 0 | 0 |
| `score_strength_scaling` | 277 | 0 | 0 | 0 |
| `min_signal_strength` | 276 | 0 | 0 | 0 |
| `entry_confirmation_days` | 275 | 0 | 0 | 0 |
| `vote_threshold_short` | 274 | 0 | 1 | 0 |
| `time_stop_bars` | 273 | 0 | 0 | 0 |
| `volume_confirm_mode` | 273 | 0 | 1 | 0 |
| `z_threshold` | 273 | 0 | 0 | 0 |
| `ma_filter_period` | 273 | 0 | 1 | 0 |
| `stop_atr_mult` | 271 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 269 | 0 | 0 | 0 |
| `entry_aggressiveness` | 256 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 284 | 7% | 1 |
| `score_percentile_trigger` | 20 | 279 | 7% | 0 |
| `momentum_confirm_days` | 18 | 278 | 6% | 0 |
| `partial_take_level` | 8 | 284 | 3% | 1 |
| `signal_ema_span` | 7 | 278 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 273 | 2% | 0 |
| `entry_score_threshold` | 6 | 288 | 2% | 0 |
| `regime_threshold` | 6 | 293 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 270 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 283 | 2% | 0 |
| `ma_filter_mode` | 5 | 283 | 2% | 0 |
| `partial_take_pct` | 4 | 277 | 1% | 0 |
| `support_broken_gate` | 2 | 252 | 1% | 0 |
| `trailing_stop_mode` | 2 | 274 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 274 | 1% | 0 |
| `stop_tighten_factor` | 2 | 276 | 1% | 0 |
| `partial_take_pct_2` | 2 | 276 | 1% | 0 |
| `partial_take_level_2` | 2 | 279 | 1% | 0 |
| `resistance_overext_gate` | 1 | 252 | 0% | 0 |
| `vol_regime_mode` | 1 | 275 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-23T17:41:11+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
