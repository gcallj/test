...
_Generated: 2026-05-26T00:00:06+00:00_
...
- Total sweeps seen: **1089**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.9%** (over 1113 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 184 | 0 | 0 | 0 |
| `vote_threshold_long` | 182 | 0 | 0 | 0 |
| `score_strength_scaling` | 182 | 0 | 0 | 0 |
| `min_signal_strength` | 181 | 0 | 0 | 0 |
| `stop_atr_mult` | 180 | 0 | 0 | 0 |
| `entry_confirmation_days` | 180 | 0 | 0 | 0 |
| `volume_confirm_mode` | 180 | 0 | 1 | 0 |
| `ma_filter_period` | 180 | 0 | 1 | 0 |
| `time_stop_bars` | 179 | 0 | 0 | 0 |
| `vote_threshold_short` | 179 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 178 | 0 | 0 | 0 |
| `z_threshold` | 178 | 0 | 0 | 0 |
| `entry_aggressiveness` | 161 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 190 | 11% | 1 |
| `score_percentile_trigger` | 20 | 184 | 11% | 0 |
| `momentum_confirm_days` | 18 | 185 | 10% | 0 |
| `partial_take_level` | 8 | 191 | 4% | 1 |
| `signal_ema_span` | 7 | 183 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 182 | 3% | 0 |
| `entry_score_threshold` | 6 | 193 | 3% | 0 |
| `regime_threshold` | 6 | 200 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 179 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 190 | 3% | 0 |
| `ma_filter_mode` | 5 | 190 | 3% | 0 |
| `partial_take_pct` | 4 | 184 | 2% | 0 |
| `support_broken_gate` | 2 | 159 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 179 | 1% | 0 |
| `trailing_stop_mode` | 2 | 181 | 1% | 0 |
| `partial_take_pct_2` | 2 | 183 | 1% | 0 |
| `stop_tighten_factor` | 2 | 185 | 1% | 0 |
| `partial_take_level_2` | 2 | 186 | 1% | 0 |
| `resistance_overext_gate` | 1 | 159 | 1% | 0 |
| `vol_regime_mode` | 1 | 182 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-26T00:00:05+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
