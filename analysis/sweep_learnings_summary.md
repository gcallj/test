...
_Generated: 2026-07-31T14:44:15+00:00_
...
- Total sweeps seen: **1526**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.8%** (over 1550 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 257 | 0 | 0 | 0 |
| `vote_threshold_long` | 256 | 0 | 0 | 0 |
| `score_strength_scaling` | 256 | 0 | 0 | 0 |
| `min_signal_strength` | 255 | 0 | 0 | 0 |
| `entry_confirmation_days` | 254 | 0 | 0 | 0 |
| `volume_confirm_mode` | 253 | 0 | 1 | 0 |
| `vote_threshold_short` | 253 | 0 | 1 | 0 |
| `ma_filter_period` | 253 | 0 | 1 | 0 |
| `time_stop_bars` | 252 | 0 | 0 | 0 |
| `z_threshold` | 252 | 0 | 0 | 0 |
| `stop_atr_mult` | 251 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 249 | 0 | 0 | 0 |
| `entry_aggressiveness` | 235 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 263 | 8% | 1 |
| `score_percentile_trigger` | 20 | 258 | 8% | 0 |
| `momentum_confirm_days` | 18 | 258 | 7% | 0 |
| `partial_take_level` | 8 | 264 | 3% | 1 |
| `signal_ema_span` | 7 | 257 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 253 | 2% | 0 |
| `entry_score_threshold` | 6 | 267 | 2% | 0 |
| `regime_threshold` | 6 | 273 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 250 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 263 | 2% | 0 |
| `ma_filter_mode` | 5 | 263 | 2% | 0 |
| `partial_take_pct` | 4 | 257 | 2% | 0 |
| `support_broken_gate` | 2 | 232 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 253 | 1% | 0 |
| `trailing_stop_mode` | 2 | 254 | 1% | 0 |
| `stop_tighten_factor` | 2 | 256 | 1% | 0 |
| `partial_take_pct_2` | 2 | 256 | 1% | 0 |
| `partial_take_level_2` | 2 | 259 | 1% | 0 |
| `resistance_overext_gate` | 1 | 232 | 0% | 0 |
| `vol_regime_mode` | 1 | 255 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-07-31T14:44:14+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
