...
_Generated: 2026-09-22T07:21:23+00:00_
...
- Total sweeps seen: **1828**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **6.5%** (over 1852 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 307 | 0 | 0 | 0 |
| `vote_threshold_long` | 307 | 0 | 0 | 0 |
| `score_strength_scaling` | 307 | 0 | 0 | 0 |
| `min_signal_strength` | 306 | 0 | 0 | 0 |
| `entry_confirmation_days` | 305 | 0 | 0 | 0 |
| `vote_threshold_short` | 304 | 0 | 1 | 0 |
| `time_stop_bars` | 303 | 0 | 0 | 0 |
| `z_threshold` | 303 | 0 | 0 | 0 |
| `volume_confirm_mode` | 303 | 0 | 1 | 0 |
| `ma_filter_period` | 303 | 0 | 1 | 0 |
| `stop_atr_mult` | 301 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 299 | 0 | 0 | 0 |
| `entry_aggressiveness` | 286 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 314 | 7% | 1 |
| `score_percentile_trigger` | 20 | 309 | 6% | 0 |
| `momentum_confirm_days` | 18 | 308 | 6% | 0 |
| `partial_take_level` | 8 | 314 | 3% | 1 |
| `signal_ema_span` | 7 | 308 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 303 | 2% | 0 |
| `entry_score_threshold` | 6 | 318 | 2% | 0 |
| `regime_threshold` | 6 | 323 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 300 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 313 | 2% | 0 |
| `ma_filter_mode` | 5 | 313 | 2% | 0 |
| `partial_take_pct` | 4 | 307 | 1% | 0 |
| `support_broken_gate` | 2 | 282 | 1% | 0 |
| `trailing_stop_mode` | 2 | 304 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 304 | 1% | 0 |
| `stop_tighten_factor` | 2 | 306 | 1% | 0 |
| `partial_take_pct_2` | 2 | 306 | 1% | 0 |
| `partial_take_level_2` | 2 | 309 | 1% | 0 |
| `resistance_overext_gate` | 1 | 282 | 0% | 0 |
| `vol_regime_mode` | 1 | 305 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-09-22T07:21:21+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
