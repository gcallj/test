...
_Generated: 2026-05-29T15:07:53+00:00_
...
- Total sweeps seen: **1143**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.4%** (over 1167 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 193 | 0 | 0 | 0 |
| `vote_threshold_long` | 191 | 0 | 0 | 0 |
| `score_strength_scaling` | 191 | 0 | 0 | 0 |
| `min_signal_strength` | 190 | 0 | 0 | 0 |
| `entry_confirmation_days` | 189 | 0 | 0 | 0 |
| `stop_atr_mult` | 189 | 0 | 0 | 0 |
| `volume_confirm_mode` | 189 | 0 | 1 | 0 |
| `ma_filter_period` | 189 | 0 | 1 | 0 |
| `vote_threshold_short` | 188 | 0 | 1 | 0 |
| `time_stop_bars` | 188 | 0 | 0 | 0 |
| `z_threshold` | 187 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 187 | 0 | 0 | 0 |
| `entry_aggressiveness` | 170 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 199 | 11% | 1 |
| `score_percentile_trigger` | 20 | 193 | 10% | 0 |
| `momentum_confirm_days` | 18 | 194 | 9% | 0 |
| `partial_take_level` | 8 | 200 | 4% | 1 |
| `signal_ema_span` | 7 | 192 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 191 | 3% | 0 |
| `entry_score_threshold` | 6 | 202 | 3% | 0 |
| `regime_threshold` | 6 | 209 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 188 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 199 | 3% | 0 |
| `ma_filter_mode` | 5 | 199 | 3% | 0 |
| `partial_take_pct` | 4 | 193 | 2% | 0 |
| `support_broken_gate` | 2 | 168 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 188 | 1% | 0 |
| `trailing_stop_mode` | 2 | 190 | 1% | 0 |
| `partial_take_pct_2` | 2 | 192 | 1% | 0 |
| `stop_tighten_factor` | 2 | 194 | 1% | 0 |
| `partial_take_level_2` | 2 | 195 | 1% | 0 |
| `resistance_overext_gate` | 1 | 168 | 1% | 0 |
| `vol_regime_mode` | 1 | 191 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-29T15:07:52+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
