...
_Generated: 2026-05-22T15:41:27+00:00_
...
- Total sweeps seen: **839**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **14.0%** (over 863 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 142 | 0 | 0 | 0 |
| `vote_threshold_long` | 140 | 0 | 0 | 0 |
| `score_strength_scaling` | 140 | 0 | 0 | 0 |
| `stop_atr_mult` | 139 | 0 | 0 | 0 |
| `min_signal_strength` | 139 | 0 | 0 | 0 |
| `entry_confirmation_days` | 138 | 0 | 0 | 0 |
| `volume_confirm_mode` | 138 | 0 | 1 | 0 |
| `time_stop_bars` | 138 | 0 | 0 | 0 |
| `ma_filter_period` | 138 | 0 | 1 | 0 |
| `vote_threshold_short` | 137 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 137 | 0 | 0 | 0 |
| `z_threshold` | 136 | 0 | 0 | 0 |
| `entry_aggressiveness` | 119 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 149 | 14% | 1 |
| `score_percentile_trigger` | 20 | 142 | 14% | 0 |
| `momentum_confirm_days` | 18 | 143 | 13% | 0 |
| `partial_take_level` | 8 | 149 | 5% | 1 |
| `signal_ema_span` | 7 | 141 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 141 | 4% | 0 |
| `entry_score_threshold` | 6 | 151 | 4% | 0 |
| `regime_threshold` | 6 | 158 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 138 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 148 | 3% | 0 |
| `ma_filter_mode` | 5 | 148 | 3% | 0 |
| `partial_take_pct` | 4 | 142 | 3% | 0 |
| `support_broken_gate` | 2 | 117 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 137 | 1% | 0 |
| `trailing_stop_mode` | 2 | 139 | 1% | 0 |
| `partial_take_pct_2` | 2 | 141 | 1% | 0 |
| `stop_tighten_factor` | 2 | 144 | 1% | 0 |
| `partial_take_level_2` | 2 | 144 | 1% | 0 |
| `resistance_overext_gate` | 1 | 117 | 1% | 0 |
| `vol_regime_mode` | 1 | 140 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-22T15:41:26+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
