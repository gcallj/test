...
_Generated: 2026-04-21T04:07:49+00:00_
...
- Total sweeps seen: **96**
- Total promotions: **47** (including 1 from codex log)
- Promotion rate: **39.2%** (over 120 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 18 | 0 | 0 | 0 |
| `vote_threshold_long` | 16 | 0 | 0 | 0 |
| `score_strength_scaling` | 16 | 0 | 0 | 0 |
| `stop_atr_mult` | 15 | 0 | 0 | 0 |
| `time_stop_bars` | 15 | 0 | 0 | 0 |
| `min_signal_strength` | 15 | 0 | 0 | 0 |
| `entry_confirmation_days` | 14 | 0 | 0 | 0 |
| `volume_confirm_mode` | 14 | 0 | 1 | 0 |
| `ma_filter_period` | 14 | 0 | 1 | 0 |
| `entry_discount_atr_frac` | 13 | 0 | 0 | 0 |
| `vote_threshold_short` | 13 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 13 | 0 | 0 | 0 |
| `z_threshold` | 12 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `momentum_confirm_days` | 8 | 19 | 42% | 0 |
| `consecutive_loss_cooldown` | 6 | 26 | 23% | 1 |
| `regime_threshold` | 6 | 34 | 18% | 1 |
| `equity_drawdown_stop_pct` | 5 | 14 | 36% | 0 |
| `score_percentile_trigger` | 4 | 18 | 22% | 0 |
| `partial_take_level` | 4 | 25 | 16% | 1 |
| `partial_take_pct` | 3 | 18 | 17% | 0 |
| `entry_score_threshold` | 3 | 27 | 11% | 0 |
| `max_loss_per_trade_pct` | 2 | 17 | 12% | 0 |
| `signal_ema_span` | 2 | 17 | 12% | 0 |
| `ma_filter_mode` | 2 | 24 | 8% | 0 |
| `trailing_stop_mode` | 1 | 15 | 7% | 0 |
| `vol_regime_mode` | 1 | 16 | 6% | 0 |
| `partial_take_pct_2` | 1 | 17 | 6% | 0 |
| `stop_tighten_factor` | 1 | 20 | 5% | 0 |
| `partial_take_level_2` | 1 | 20 | 5% | 0 |
| `volatility_filter_percentile` | 1 | 24 | 4% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-04-21T04:07:49+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
