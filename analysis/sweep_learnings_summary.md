...
_Generated: 2026-05-19T06:31:44+00:00_
...
- Total sweeps seen: **419**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **27.3%** (over 443 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 72 | 0 | 0 | 0 |
| `vote_threshold_long` | 70 | 0 | 0 | 0 |
| `score_strength_scaling` | 70 | 0 | 0 | 0 |
| `min_signal_strength` | 69 | 0 | 0 | 0 |
| `stop_atr_mult` | 69 | 0 | 0 | 0 |
| `volume_confirm_mode` | 68 | 0 | 1 | 0 |
| `time_stop_bars` | 68 | 0 | 0 | 0 |
| `entry_confirmation_days` | 68 | 0 | 0 | 0 |
| `ma_filter_period` | 68 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 67 | 0 | 0 | 0 |
| `vote_threshold_short` | 67 | 0 | 1 | 0 |
| `z_threshold` | 66 | 0 | 0 | 0 |
| `entry_aggressiveness` | 49 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 79 | 27% | 1 |
| `score_percentile_trigger` | 20 | 72 | 28% | 0 |
| `momentum_confirm_days` | 18 | 73 | 25% | 0 |
| `partial_take_level` | 8 | 79 | 10% | 1 |
| `signal_ema_span` | 7 | 71 | 10% | 0 |
| `max_loss_per_trade_pct` | 6 | 71 | 8% | 0 |
| `entry_score_threshold` | 6 | 81 | 7% | 0 |
| `regime_threshold` | 6 | 88 | 7% | 1 |
| `equity_drawdown_stop_pct` | 5 | 68 | 7% | 0 |
| `volatility_filter_percentile` | 5 | 78 | 6% | 0 |
| `ma_filter_mode` | 5 | 78 | 6% | 0 |
| `partial_take_pct` | 4 | 72 | 6% | 0 |
| `support_broken_gate` | 2 | 47 | 4% | 0 |
| `entry_discount_atr_frac` | 2 | 67 | 3% | 0 |
| `trailing_stop_mode` | 2 | 69 | 3% | 0 |
| `partial_take_pct_2` | 2 | 71 | 3% | 0 |
| `stop_tighten_factor` | 2 | 74 | 3% | 0 |
| `partial_take_level_2` | 2 | 74 | 3% | 0 |
| `resistance_overext_gate` | 1 | 47 | 2% | 0 |
| `vol_regime_mode` | 1 | 70 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-19T06:31:44+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
