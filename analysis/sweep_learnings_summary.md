...
_Generated: 2026-06-07T20:43:11+00:00_
...
- Total sweeps seen: **1287**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.2%** (over 1311 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 217 | 0 | 0 | 0 |
| `vote_threshold_long` | 215 | 0 | 0 | 0 |
| `score_strength_scaling` | 215 | 0 | 0 | 0 |
| `min_signal_strength` | 214 | 0 | 0 | 0 |
| `stop_atr_mult` | 213 | 0 | 0 | 0 |
| `volume_confirm_mode` | 213 | 0 | 1 | 0 |
| `entry_confirmation_days` | 213 | 0 | 0 | 0 |
| `ma_filter_period` | 213 | 0 | 1 | 0 |
| `time_stop_bars` | 212 | 0 | 0 | 0 |
| `vote_threshold_short` | 212 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 211 | 0 | 0 | 0 |
| `z_threshold` | 211 | 0 | 0 | 0 |
| `entry_aggressiveness` | 194 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 223 | 9% | 1 |
| `score_percentile_trigger` | 20 | 217 | 9% | 0 |
| `momentum_confirm_days` | 18 | 218 | 8% | 0 |
| `partial_take_level` | 8 | 224 | 4% | 1 |
| `signal_ema_span` | 7 | 216 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 215 | 3% | 0 |
| `entry_score_threshold` | 6 | 226 | 3% | 0 |
| `regime_threshold` | 6 | 233 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 212 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 223 | 2% | 0 |
| `ma_filter_mode` | 5 | 223 | 2% | 0 |
| `partial_take_pct` | 4 | 217 | 2% | 0 |
| `support_broken_gate` | 2 | 192 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 212 | 1% | 0 |
| `trailing_stop_mode` | 2 | 214 | 1% | 0 |
| `partial_take_pct_2` | 2 | 216 | 1% | 0 |
| `stop_tighten_factor` | 2 | 218 | 1% | 0 |
| `partial_take_level_2` | 2 | 219 | 1% | 0 |
| `resistance_overext_gate` | 1 | 192 | 1% | 0 |
| `vol_regime_mode` | 1 | 215 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-07T20:43:10+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
