...
_Generated: 2026-06-03T23:26:39+00:00_
...
- Total sweeps seen: **1239**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.6%** (over 1263 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 209 | 0 | 0 | 0 |
| `vote_threshold_long` | 207 | 0 | 0 | 0 |
| `score_strength_scaling` | 207 | 0 | 0 | 0 |
| `min_signal_strength` | 206 | 0 | 0 | 0 |
| `stop_atr_mult` | 205 | 0 | 0 | 0 |
| `entry_confirmation_days` | 205 | 0 | 0 | 0 |
| `volume_confirm_mode` | 205 | 0 | 1 | 0 |
| `ma_filter_period` | 205 | 0 | 1 | 0 |
| `time_stop_bars` | 204 | 0 | 0 | 0 |
| `vote_threshold_short` | 204 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 203 | 0 | 0 | 0 |
| `z_threshold` | 203 | 0 | 0 | 0 |
| `entry_aggressiveness` | 186 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 215 | 10% | 1 |
| `score_percentile_trigger` | 20 | 209 | 10% | 0 |
| `momentum_confirm_days` | 18 | 210 | 9% | 0 |
| `partial_take_level` | 8 | 216 | 4% | 1 |
| `signal_ema_span` | 7 | 208 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 207 | 3% | 0 |
| `entry_score_threshold` | 6 | 218 | 3% | 0 |
| `regime_threshold` | 6 | 225 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 204 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 215 | 2% | 0 |
| `ma_filter_mode` | 5 | 215 | 2% | 0 |
| `partial_take_pct` | 4 | 209 | 2% | 0 |
| `support_broken_gate` | 2 | 184 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 204 | 1% | 0 |
| `trailing_stop_mode` | 2 | 206 | 1% | 0 |
| `partial_take_pct_2` | 2 | 208 | 1% | 0 |
| `stop_tighten_factor` | 2 | 210 | 1% | 0 |
| `partial_take_level_2` | 2 | 211 | 1% | 0 |
| `resistance_overext_gate` | 1 | 184 | 1% | 0 |
| `vol_regime_mode` | 1 | 207 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-03T23:26:38+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
