...
_Generated: 2026-05-24T00:54:24+00:00_
...
- Total sweeps seen: **999**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **11.8%** (over 1023 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 169 | 0 | 0 | 0 |
| `vote_threshold_long` | 167 | 0 | 0 | 0 |
| `score_strength_scaling` | 167 | 0 | 0 | 0 |
| `min_signal_strength` | 166 | 0 | 0 | 0 |
| `stop_atr_mult` | 165 | 0 | 0 | 0 |
| `entry_confirmation_days` | 165 | 0 | 0 | 0 |
| `volume_confirm_mode` | 165 | 0 | 1 | 0 |
| `ma_filter_period` | 165 | 0 | 1 | 0 |
| `time_stop_bars` | 164 | 0 | 0 | 0 |
| `vote_threshold_short` | 164 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 163 | 0 | 0 | 0 |
| `z_threshold` | 163 | 0 | 0 | 0 |
| `entry_aggressiveness` | 146 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 175 | 12% | 1 |
| `score_percentile_trigger` | 20 | 169 | 12% | 0 |
| `momentum_confirm_days` | 18 | 170 | 11% | 0 |
| `partial_take_level` | 8 | 176 | 5% | 1 |
| `signal_ema_span` | 7 | 168 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 167 | 4% | 0 |
| `entry_score_threshold` | 6 | 178 | 3% | 0 |
| `regime_threshold` | 6 | 185 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 164 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 175 | 3% | 0 |
| `ma_filter_mode` | 5 | 175 | 3% | 0 |
| `partial_take_pct` | 4 | 169 | 2% | 0 |
| `support_broken_gate` | 2 | 144 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 164 | 1% | 0 |
| `trailing_stop_mode` | 2 | 166 | 1% | 0 |
| `partial_take_pct_2` | 2 | 168 | 1% | 0 |
| `stop_tighten_factor` | 2 | 170 | 1% | 0 |
| `partial_take_level_2` | 2 | 171 | 1% | 0 |
| `resistance_overext_gate` | 1 | 144 | 1% | 0 |
| `vol_regime_mode` | 1 | 167 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-24T00:54:23+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
