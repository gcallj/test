...
_Generated: 2026-05-23T11:07:31+00:00_
...
- Total sweeps seen: **941**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.5%** (over 965 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 159 | 0 | 0 | 0 |
| `vote_threshold_long` | 157 | 0 | 0 | 0 |
| `score_strength_scaling` | 157 | 0 | 0 | 0 |
| `stop_atr_mult` | 156 | 0 | 0 | 0 |
| `min_signal_strength` | 156 | 0 | 0 | 0 |
| `entry_confirmation_days` | 155 | 0 | 0 | 0 |
| `volume_confirm_mode` | 155 | 0 | 1 | 0 |
| `time_stop_bars` | 155 | 0 | 0 | 0 |
| `ma_filter_period` | 155 | 0 | 1 | 0 |
| `vote_threshold_short` | 154 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 154 | 0 | 0 | 0 |
| `z_threshold` | 153 | 0 | 0 | 0 |
| `entry_aggressiveness` | 136 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 166 | 13% | 1 |
| `score_percentile_trigger` | 20 | 159 | 13% | 0 |
| `momentum_confirm_days` | 18 | 160 | 11% | 0 |
| `partial_take_level` | 8 | 166 | 5% | 1 |
| `signal_ema_span` | 7 | 158 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 158 | 4% | 0 |
| `entry_score_threshold` | 6 | 168 | 4% | 0 |
| `regime_threshold` | 6 | 175 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 155 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 165 | 3% | 0 |
| `ma_filter_mode` | 5 | 165 | 3% | 0 |
| `partial_take_pct` | 4 | 159 | 3% | 0 |
| `support_broken_gate` | 2 | 134 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 154 | 1% | 0 |
| `trailing_stop_mode` | 2 | 156 | 1% | 0 |
| `partial_take_pct_2` | 2 | 158 | 1% | 0 |
| `stop_tighten_factor` | 2 | 161 | 1% | 0 |
| `partial_take_level_2` | 2 | 161 | 1% | 0 |
| `resistance_overext_gate` | 1 | 134 | 1% | 0 |
| `vol_regime_mode` | 1 | 157 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T11:07:30+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
