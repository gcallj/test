...
_Generated: 2026-05-19T07:49:35+00:00_
...
- Total sweeps seen: **425**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **26.9%** (over 449 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 73 | 0 | 0 | 0 |
| `vote_threshold_long` | 71 | 0 | 0 | 0 |
| `score_strength_scaling` | 71 | 0 | 0 | 0 |
| `min_signal_strength` | 70 | 0 | 0 | 0 |
| `stop_atr_mult` | 70 | 0 | 0 | 0 |
| `entry_confirmation_days` | 69 | 0 | 0 | 0 |
| `volume_confirm_mode` | 69 | 0 | 1 | 0 |
| `time_stop_bars` | 69 | 0 | 0 | 0 |
| `ma_filter_period` | 69 | 0 | 1 | 0 |
| `vote_threshold_short` | 68 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 68 | 0 | 0 | 0 |
| `z_threshold` | 67 | 0 | 0 | 0 |
| `entry_aggressiveness` | 50 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 80 | 26% | 1 |
| `score_percentile_trigger` | 20 | 73 | 27% | 0 |
| `momentum_confirm_days` | 18 | 74 | 24% | 0 |
| `partial_take_level` | 8 | 80 | 10% | 1 |
| `signal_ema_span` | 7 | 72 | 10% | 0 |
| `max_loss_per_trade_pct` | 6 | 72 | 8% | 0 |
| `entry_score_threshold` | 6 | 82 | 7% | 0 |
| `regime_threshold` | 6 | 89 | 7% | 1 |
| `equity_drawdown_stop_pct` | 5 | 69 | 7% | 0 |
| `volatility_filter_percentile` | 5 | 79 | 6% | 0 |
| `ma_filter_mode` | 5 | 79 | 6% | 0 |
| `partial_take_pct` | 4 | 73 | 5% | 0 |
| `support_broken_gate` | 2 | 48 | 4% | 0 |
| `entry_discount_atr_frac` | 2 | 68 | 3% | 0 |
| `trailing_stop_mode` | 2 | 70 | 3% | 0 |
| `partial_take_pct_2` | 2 | 72 | 3% | 0 |
| `stop_tighten_factor` | 2 | 75 | 3% | 0 |
| `partial_take_level_2` | 2 | 75 | 3% | 0 |
| `resistance_overext_gate` | 1 | 48 | 2% | 0 |
| `vol_regime_mode` | 1 | 71 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-19T07:49:35+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
