...
_Generated: 2026-05-21T22:32:43+00:00_
...
- Total sweeps seen: **749**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **15.7%** (over 773 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 127 | 0 | 0 | 0 |
| `vote_threshold_long` | 125 | 0 | 0 | 0 |
| `score_strength_scaling` | 125 | 0 | 0 | 0 |
| `min_signal_strength` | 124 | 0 | 0 | 0 |
| `stop_atr_mult` | 124 | 0 | 0 | 0 |
| `volume_confirm_mode` | 123 | 0 | 1 | 0 |
| `time_stop_bars` | 123 | 0 | 0 | 0 |
| `entry_confirmation_days` | 123 | 0 | 0 | 0 |
| `ma_filter_period` | 123 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 122 | 0 | 0 | 0 |
| `vote_threshold_short` | 122 | 0 | 1 | 0 |
| `z_threshold` | 121 | 0 | 0 | 0 |
| `entry_aggressiveness` | 104 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 134 | 16% | 1 |
| `score_percentile_trigger` | 20 | 127 | 16% | 0 |
| `momentum_confirm_days` | 18 | 128 | 14% | 0 |
| `partial_take_level` | 8 | 134 | 6% | 1 |
| `signal_ema_span` | 7 | 126 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 126 | 5% | 0 |
| `entry_score_threshold` | 6 | 136 | 4% | 0 |
| `regime_threshold` | 6 | 143 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 123 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 133 | 4% | 0 |
| `ma_filter_mode` | 5 | 133 | 4% | 0 |
| `partial_take_pct` | 4 | 127 | 3% | 0 |
| `support_broken_gate` | 2 | 102 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 122 | 2% | 0 |
| `trailing_stop_mode` | 2 | 124 | 2% | 0 |
| `partial_take_pct_2` | 2 | 126 | 2% | 0 |
| `stop_tighten_factor` | 2 | 129 | 2% | 0 |
| `partial_take_level_2` | 2 | 129 | 2% | 0 |
| `resistance_overext_gate` | 1 | 102 | 1% | 0 |
| `vol_regime_mode` | 1 | 125 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T22:32:43+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
