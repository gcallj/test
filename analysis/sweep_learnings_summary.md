...
_Generated: 2026-06-04T18:09:21+00:00_
...
- Total sweeps seen: **1257**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.4%** (over 1281 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 212 | 0 | 0 | 0 |
| `vote_threshold_long` | 210 | 0 | 0 | 0 |
| `score_strength_scaling` | 210 | 0 | 0 | 0 |
| `min_signal_strength` | 209 | 0 | 0 | 0 |
| `entry_confirmation_days` | 208 | 0 | 0 | 0 |
| `stop_atr_mult` | 208 | 0 | 0 | 0 |
| `volume_confirm_mode` | 208 | 0 | 1 | 0 |
| `ma_filter_period` | 208 | 0 | 1 | 0 |
| `vote_threshold_short` | 207 | 0 | 1 | 0 |
| `time_stop_bars` | 207 | 0 | 0 | 0 |
| `z_threshold` | 206 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 206 | 0 | 0 | 0 |
| `entry_aggressiveness` | 189 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 218 | 10% | 1 |
| `score_percentile_trigger` | 20 | 212 | 9% | 0 |
| `momentum_confirm_days` | 18 | 213 | 8% | 0 |
| `partial_take_level` | 8 | 219 | 4% | 1 |
| `signal_ema_span` | 7 | 211 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 210 | 3% | 0 |
| `entry_score_threshold` | 6 | 221 | 3% | 0 |
| `regime_threshold` | 6 | 228 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 207 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 218 | 2% | 0 |
| `ma_filter_mode` | 5 | 218 | 2% | 0 |
| `partial_take_pct` | 4 | 212 | 2% | 0 |
| `support_broken_gate` | 2 | 187 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 207 | 1% | 0 |
| `trailing_stop_mode` | 2 | 209 | 1% | 0 |
| `partial_take_pct_2` | 2 | 211 | 1% | 0 |
| `stop_tighten_factor` | 2 | 213 | 1% | 0 |
| `partial_take_level_2` | 2 | 214 | 1% | 0 |
| `resistance_overext_gate` | 1 | 187 | 1% | 0 |
| `vol_regime_mode` | 1 | 210 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-04T18:09:20+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
