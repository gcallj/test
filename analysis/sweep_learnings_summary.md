...
_Generated: 2026-05-31T19:03:33+00:00_
...
- Total sweeps seen: **1185**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.0%** (over 1209 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 200 | 0 | 0 | 0 |
| `vote_threshold_long` | 198 | 0 | 0 | 0 |
| `score_strength_scaling` | 198 | 0 | 0 | 0 |
| `min_signal_strength` | 197 | 0 | 0 | 0 |
| `stop_atr_mult` | 196 | 0 | 0 | 0 |
| `entry_confirmation_days` | 196 | 0 | 0 | 0 |
| `volume_confirm_mode` | 196 | 0 | 1 | 0 |
| `ma_filter_period` | 196 | 0 | 1 | 0 |
| `time_stop_bars` | 195 | 0 | 0 | 0 |
| `vote_threshold_short` | 195 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 194 | 0 | 0 | 0 |
| `z_threshold` | 194 | 0 | 0 | 0 |
| `entry_aggressiveness` | 177 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 206 | 10% | 1 |
| `score_percentile_trigger` | 20 | 200 | 10% | 0 |
| `momentum_confirm_days` | 18 | 201 | 9% | 0 |
| `partial_take_level` | 8 | 207 | 4% | 1 |
| `signal_ema_span` | 7 | 199 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 198 | 3% | 0 |
| `entry_score_threshold` | 6 | 209 | 3% | 0 |
| `regime_threshold` | 6 | 216 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 195 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 206 | 2% | 0 |
| `ma_filter_mode` | 5 | 206 | 2% | 0 |
| `partial_take_pct` | 4 | 200 | 2% | 0 |
| `support_broken_gate` | 2 | 175 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 195 | 1% | 0 |
| `trailing_stop_mode` | 2 | 197 | 1% | 0 |
| `partial_take_pct_2` | 2 | 199 | 1% | 0 |
| `stop_tighten_factor` | 2 | 201 | 1% | 0 |
| `partial_take_level_2` | 2 | 202 | 1% | 0 |
| `resistance_overext_gate` | 1 | 175 | 1% | 0 |
| `vol_regime_mode` | 1 | 198 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-31T19:03:33+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
