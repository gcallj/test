...
_Generated: 2026-08-26T03:09:42+00:00_
...
- Total sweeps seen: **1654**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.2%** (over 1678 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 278 | 0 | 0 | 0 |
| `score_strength_scaling` | 278 | 0 | 0 | 0 |
| `vote_threshold_long` | 278 | 0 | 0 | 0 |
| `min_signal_strength` | 277 | 0 | 0 | 0 |
| `entry_confirmation_days` | 276 | 0 | 0 | 0 |
| `vote_threshold_short` | 275 | 0 | 1 | 0 |
| `time_stop_bars` | 274 | 0 | 0 | 0 |
| `volume_confirm_mode` | 274 | 0 | 1 | 0 |
| `z_threshold` | 274 | 0 | 0 | 0 |
| `ma_filter_period` | 274 | 0 | 1 | 0 |
| `stop_atr_mult` | 272 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 270 | 0 | 0 | 0 |
| `entry_aggressiveness` | 257 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 285 | 7% | 1 |
| `score_percentile_trigger` | 20 | 280 | 7% | 0 |
| `momentum_confirm_days` | 18 | 279 | 6% | 0 |
| `partial_take_level` | 8 | 285 | 3% | 1 |
| `signal_ema_span` | 7 | 279 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 274 | 2% | 0 |
| `entry_score_threshold` | 6 | 289 | 2% | 0 |
| `regime_threshold` | 6 | 294 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 271 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 284 | 2% | 0 |
| `ma_filter_mode` | 5 | 284 | 2% | 0 |
| `partial_take_pct` | 4 | 278 | 1% | 0 |
| `support_broken_gate` | 2 | 253 | 1% | 0 |
| `trailing_stop_mode` | 2 | 275 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 275 | 1% | 0 |
| `stop_tighten_factor` | 2 | 277 | 1% | 0 |
| `partial_take_pct_2` | 2 | 277 | 1% | 0 |
| `partial_take_level_2` | 2 | 280 | 1% | 0 |
| `resistance_overext_gate` | 1 | 253 | 0% | 0 |
| `vol_regime_mode` | 1 | 276 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-26T03:09:41+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
