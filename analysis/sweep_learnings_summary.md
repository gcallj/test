...
_Generated: 2026-05-20T06:31:26+00:00_
...
- Total sweeps seen: **545**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **21.3%** (over 569 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 93 | 0 | 0 | 0 |
| `vote_threshold_long` | 91 | 0 | 0 | 0 |
| `score_strength_scaling` | 91 | 0 | 0 | 0 |
| `min_signal_strength` | 90 | 0 | 0 | 0 |
| `stop_atr_mult` | 90 | 0 | 0 | 0 |
| `entry_confirmation_days` | 89 | 0 | 0 | 0 |
| `volume_confirm_mode` | 89 | 0 | 1 | 0 |
| `time_stop_bars` | 89 | 0 | 0 | 0 |
| `ma_filter_period` | 89 | 0 | 1 | 0 |
| `vote_threshold_short` | 88 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 88 | 0 | 0 | 0 |
| `z_threshold` | 87 | 0 | 0 | 0 |
| `entry_aggressiveness` | 70 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 100 | 21% | 1 |
| `score_percentile_trigger` | 20 | 93 | 22% | 0 |
| `momentum_confirm_days` | 18 | 94 | 19% | 0 |
| `partial_take_level` | 8 | 100 | 8% | 1 |
| `signal_ema_span` | 7 | 92 | 8% | 0 |
| `max_loss_per_trade_pct` | 6 | 92 | 7% | 0 |
| `entry_score_threshold` | 6 | 102 | 6% | 0 |
| `regime_threshold` | 6 | 109 | 6% | 1 |
| `equity_drawdown_stop_pct` | 5 | 89 | 6% | 0 |
| `volatility_filter_percentile` | 5 | 99 | 5% | 0 |
| `ma_filter_mode` | 5 | 99 | 5% | 0 |
| `partial_take_pct` | 4 | 93 | 4% | 0 |
| `support_broken_gate` | 2 | 68 | 3% | 0 |
| `entry_discount_atr_frac` | 2 | 88 | 2% | 0 |
| `trailing_stop_mode` | 2 | 90 | 2% | 0 |
| `partial_take_pct_2` | 2 | 92 | 2% | 0 |
| `stop_tighten_factor` | 2 | 95 | 2% | 0 |
| `partial_take_level_2` | 2 | 95 | 2% | 0 |
| `resistance_overext_gate` | 1 | 68 | 1% | 0 |
| `vol_regime_mode` | 1 | 91 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T06:31:26+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
