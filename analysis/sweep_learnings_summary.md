...
_Generated: 2026-06-23T10:53:38+00:00_
...
- Total sweeps seen: **1375**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.6%** (over 1399 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 232 | 0 | 0 | 0 |
| `score_strength_scaling` | 230 | 0 | 0 | 0 |
| `vote_threshold_long` | 230 | 0 | 0 | 0 |
| `min_signal_strength` | 229 | 0 | 0 | 0 |
| `volume_confirm_mode` | 228 | 0 | 1 | 0 |
| `entry_confirmation_days` | 228 | 0 | 0 | 0 |
| `ma_filter_period` | 228 | 0 | 1 | 0 |
| `stop_atr_mult` | 227 | 0 | 0 | 0 |
| `vote_threshold_short` | 227 | 0 | 1 | 0 |
| `time_stop_bars` | 226 | 0 | 0 | 0 |
| `z_threshold` | 226 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 225 | 0 | 0 | 0 |
| `entry_aggressiveness` | 209 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 237 | 9% | 1 |
| `score_percentile_trigger` | 20 | 232 | 9% | 0 |
| `momentum_confirm_days` | 18 | 233 | 8% | 0 |
| `partial_take_level` | 8 | 239 | 3% | 1 |
| `signal_ema_span` | 7 | 231 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 229 | 3% | 0 |
| `entry_score_threshold` | 6 | 241 | 2% | 0 |
| `regime_threshold` | 6 | 248 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 226 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 238 | 2% | 0 |
| `ma_filter_mode` | 5 | 238 | 2% | 0 |
| `partial_take_pct` | 4 | 232 | 2% | 0 |
| `support_broken_gate` | 2 | 207 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 227 | 1% | 0 |
| `trailing_stop_mode` | 2 | 229 | 1% | 0 |
| `partial_take_pct_2` | 2 | 231 | 1% | 0 |
| `stop_tighten_factor` | 2 | 232 | 1% | 0 |
| `partial_take_level_2` | 2 | 234 | 1% | 0 |
| `resistance_overext_gate` | 1 | 207 | 0% | 0 |
| `vol_regime_mode` | 1 | 230 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-23T10:53:37+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
