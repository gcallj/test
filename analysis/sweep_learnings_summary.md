...
_Generated: 2026-05-23T05:20:14+00:00_
...
- Total sweeps seen: **911**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.9%** (over 935 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 154 | 0 | 0 | 0 |
| `vote_threshold_long` | 152 | 0 | 0 | 0 |
| `score_strength_scaling` | 152 | 0 | 0 | 0 |
| `stop_atr_mult` | 151 | 0 | 0 | 0 |
| `min_signal_strength` | 151 | 0 | 0 | 0 |
| `time_stop_bars` | 150 | 0 | 0 | 0 |
| `entry_confirmation_days` | 150 | 0 | 0 | 0 |
| `volume_confirm_mode` | 150 | 0 | 1 | 0 |
| `ma_filter_period` | 150 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 149 | 0 | 0 | 0 |
| `vote_threshold_short` | 149 | 0 | 1 | 0 |
| `z_threshold` | 148 | 0 | 0 | 0 |
| `entry_aggressiveness` | 131 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 161 | 13% | 1 |
| `score_percentile_trigger` | 20 | 154 | 13% | 0 |
| `momentum_confirm_days` | 18 | 155 | 12% | 0 |
| `partial_take_level` | 8 | 161 | 5% | 1 |
| `signal_ema_span` | 7 | 153 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 153 | 4% | 0 |
| `entry_score_threshold` | 6 | 163 | 4% | 0 |
| `regime_threshold` | 6 | 170 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 150 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 160 | 3% | 0 |
| `ma_filter_mode` | 5 | 160 | 3% | 0 |
| `partial_take_pct` | 4 | 154 | 3% | 0 |
| `support_broken_gate` | 2 | 129 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 149 | 1% | 0 |
| `trailing_stop_mode` | 2 | 151 | 1% | 0 |
| `partial_take_pct_2` | 2 | 153 | 1% | 0 |
| `stop_tighten_factor` | 2 | 156 | 1% | 0 |
| `partial_take_level_2` | 2 | 156 | 1% | 0 |
| `resistance_overext_gate` | 1 | 129 | 1% | 0 |
| `vol_regime_mode` | 1 | 152 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T05:20:14+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
