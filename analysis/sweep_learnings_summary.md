...
_Generated: 2026-05-18T09:52:36+00:00_
...
- Total sweeps seen: **305**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **36.8%** (over 329 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 53 | 0 | 0 | 0 |
| `vote_threshold_long` | 51 | 0 | 0 | 0 |
| `score_strength_scaling` | 51 | 0 | 0 | 0 |
| `stop_atr_mult` | 50 | 0 | 0 | 0 |
| `min_signal_strength` | 50 | 0 | 0 | 0 |
| `time_stop_bars` | 49 | 0 | 0 | 0 |
| `entry_confirmation_days` | 49 | 0 | 0 | 0 |
| `volume_confirm_mode` | 49 | 0 | 1 | 0 |
| `ma_filter_period` | 49 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 48 | 0 | 0 | 0 |
| `vote_threshold_short` | 48 | 0 | 1 | 0 |
| `z_threshold` | 47 | 0 | 0 | 0 |
| `entry_aggressiveness` | 30 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 60 | 35% | 1 |
| `score_percentile_trigger` | 20 | 53 | 38% | 0 |
| `momentum_confirm_days` | 18 | 54 | 33% | 0 |
| `partial_take_level` | 8 | 60 | 13% | 1 |
| `signal_ema_span` | 7 | 52 | 13% | 0 |
| `max_loss_per_trade_pct` | 6 | 52 | 12% | 0 |
| `entry_score_threshold` | 6 | 62 | 10% | 0 |
| `regime_threshold` | 6 | 69 | 9% | 1 |
| `equity_drawdown_stop_pct` | 5 | 49 | 10% | 0 |
| `volatility_filter_percentile` | 5 | 59 | 8% | 0 |
| `ma_filter_mode` | 5 | 59 | 8% | 0 |
| `partial_take_pct` | 4 | 53 | 8% | 0 |
| `support_broken_gate` | 2 | 28 | 7% | 0 |
| `entry_discount_atr_frac` | 2 | 48 | 4% | 0 |
| `trailing_stop_mode` | 2 | 50 | 4% | 0 |
| `partial_take_pct_2` | 2 | 52 | 4% | 0 |
| `stop_tighten_factor` | 2 | 55 | 4% | 0 |
| `partial_take_level_2` | 2 | 55 | 4% | 0 |
| `resistance_overext_gate` | 1 | 28 | 4% | 0 |
| `vol_regime_mode` | 1 | 51 | 2% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-18T09:52:36+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
