...
_Generated: 2026-05-28T07:53:39+00:00_
...
- Total sweeps seen: **1131**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.5%** (over 1155 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 191 | 0 | 0 | 0 |
| `vote_threshold_long` | 189 | 0 | 0 | 0 |
| `score_strength_scaling` | 189 | 0 | 0 | 0 |
| `min_signal_strength` | 188 | 0 | 0 | 0 |
| `volume_confirm_mode` | 187 | 0 | 1 | 0 |
| `stop_atr_mult` | 187 | 0 | 0 | 0 |
| `entry_confirmation_days` | 187 | 0 | 0 | 0 |
| `ma_filter_period` | 187 | 0 | 1 | 0 |
| `time_stop_bars` | 186 | 0 | 0 | 0 |
| `vote_threshold_short` | 186 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 185 | 0 | 0 | 0 |
| `z_threshold` | 185 | 0 | 0 | 0 |
| `entry_aggressiveness` | 168 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 197 | 11% | 1 |
| `score_percentile_trigger` | 20 | 191 | 10% | 0 |
| `momentum_confirm_days` | 18 | 192 | 9% | 0 |
| `partial_take_level` | 8 | 198 | 4% | 1 |
| `signal_ema_span` | 7 | 190 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 189 | 3% | 0 |
| `entry_score_threshold` | 6 | 200 | 3% | 0 |
| `regime_threshold` | 6 | 207 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 186 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 197 | 3% | 0 |
| `ma_filter_mode` | 5 | 197 | 3% | 0 |
| `partial_take_pct` | 4 | 191 | 2% | 0 |
| `support_broken_gate` | 2 | 166 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 186 | 1% | 0 |
| `trailing_stop_mode` | 2 | 188 | 1% | 0 |
| `partial_take_pct_2` | 2 | 190 | 1% | 0 |
| `stop_tighten_factor` | 2 | 192 | 1% | 0 |
| `partial_take_level_2` | 2 | 193 | 1% | 0 |
| `resistance_overext_gate` | 1 | 166 | 1% | 0 |
| `vol_regime_mode` | 1 | 189 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-28T07:53:38+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
