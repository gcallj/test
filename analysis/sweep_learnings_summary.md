...
_Generated: 2026-06-04T05:30:50+00:00_
...
- Total sweeps seen: **1251**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.5%** (over 1275 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 211 | 0 | 0 | 0 |
| `vote_threshold_long` | 209 | 0 | 0 | 0 |
| `score_strength_scaling` | 209 | 0 | 0 | 0 |
| `min_signal_strength` | 208 | 0 | 0 | 0 |
| `stop_atr_mult` | 207 | 0 | 0 | 0 |
| `entry_confirmation_days` | 207 | 0 | 0 | 0 |
| `volume_confirm_mode` | 207 | 0 | 1 | 0 |
| `ma_filter_period` | 207 | 0 | 1 | 0 |
| `time_stop_bars` | 206 | 0 | 0 | 0 |
| `vote_threshold_short` | 206 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 205 | 0 | 0 | 0 |
| `z_threshold` | 205 | 0 | 0 | 0 |
| `entry_aggressiveness` | 188 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 217 | 10% | 1 |
| `score_percentile_trigger` | 20 | 211 | 9% | 0 |
| `momentum_confirm_days` | 18 | 212 | 8% | 0 |
| `partial_take_level` | 8 | 218 | 4% | 1 |
| `signal_ema_span` | 7 | 210 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 209 | 3% | 0 |
| `entry_score_threshold` | 6 | 220 | 3% | 0 |
| `regime_threshold` | 6 | 227 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 206 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 217 | 2% | 0 |
| `ma_filter_mode` | 5 | 217 | 2% | 0 |
| `partial_take_pct` | 4 | 211 | 2% | 0 |
| `support_broken_gate` | 2 | 186 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 206 | 1% | 0 |
| `trailing_stop_mode` | 2 | 208 | 1% | 0 |
| `partial_take_pct_2` | 2 | 210 | 1% | 0 |
| `stop_tighten_factor` | 2 | 212 | 1% | 0 |
| `partial_take_level_2` | 2 | 213 | 1% | 0 |
| `resistance_overext_gate` | 1 | 186 | 1% | 0 |
| `vol_regime_mode` | 1 | 209 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-04T05:30:49+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
