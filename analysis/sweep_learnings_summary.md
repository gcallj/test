...
_Generated: 2026-05-19T09:16:12+00:00_
...
- Total sweeps seen: **431**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **26.6%** (over 455 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 74 | 0 | 0 | 0 |
| `vote_threshold_long` | 72 | 0 | 0 | 0 |
| `score_strength_scaling` | 72 | 0 | 0 | 0 |
| `stop_atr_mult` | 71 | 0 | 0 | 0 |
| `min_signal_strength` | 71 | 0 | 0 | 0 |
| `time_stop_bars` | 70 | 0 | 0 | 0 |
| `entry_confirmation_days` | 70 | 0 | 0 | 0 |
| `volume_confirm_mode` | 70 | 0 | 1 | 0 |
| `ma_filter_period` | 70 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 69 | 0 | 0 | 0 |
| `vote_threshold_short` | 69 | 0 | 1 | 0 |
| `z_threshold` | 68 | 0 | 0 | 0 |
| `entry_aggressiveness` | 51 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 81 | 26% | 1 |
| `score_percentile_trigger` | 20 | 74 | 27% | 0 |
| `momentum_confirm_days` | 18 | 75 | 24% | 0 |
| `partial_take_level` | 8 | 81 | 10% | 1 |
| `signal_ema_span` | 7 | 73 | 10% | 0 |
| `max_loss_per_trade_pct` | 6 | 73 | 8% | 0 |
| `entry_score_threshold` | 6 | 83 | 7% | 0 |
| `regime_threshold` | 6 | 90 | 7% | 1 |
| `equity_drawdown_stop_pct` | 5 | 70 | 7% | 0 |
| `volatility_filter_percentile` | 5 | 80 | 6% | 0 |
| `ma_filter_mode` | 5 | 80 | 6% | 0 |
| `partial_take_pct` | 4 | 74 | 5% | 0 |
| `support_broken_gate` | 2 | 49 | 4% | 0 |
| `entry_discount_atr_frac` | 2 | 69 | 3% | 0 |
| `trailing_stop_mode` | 2 | 71 | 3% | 0 |
| `partial_take_pct_2` | 2 | 73 | 3% | 0 |
| `stop_tighten_factor` | 2 | 76 | 3% | 0 |
| `partial_take_level_2` | 2 | 76 | 3% | 0 |
| `resistance_overext_gate` | 1 | 49 | 2% | 0 |
| `vol_regime_mode` | 1 | 72 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-19T09:16:11+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
