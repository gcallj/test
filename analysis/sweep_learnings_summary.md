...
_Generated: 2026-09-08T20:32:16+00:00_
...
- Total sweeps seen: **1774**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **6.7%** (over 1798 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 298 | 0 | 0 | 0 |
| `vote_threshold_long` | 298 | 0 | 0 | 0 |
| `score_strength_scaling` | 298 | 0 | 0 | 0 |
| `min_signal_strength` | 297 | 0 | 0 | 0 |
| `entry_confirmation_days` | 296 | 0 | 0 | 0 |
| `vote_threshold_short` | 295 | 0 | 1 | 0 |
| `time_stop_bars` | 294 | 0 | 0 | 0 |
| `z_threshold` | 294 | 0 | 0 | 0 |
| `volume_confirm_mode` | 294 | 0 | 1 | 0 |
| `ma_filter_period` | 294 | 0 | 1 | 0 |
| `stop_atr_mult` | 292 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 290 | 0 | 0 | 0 |
| `entry_aggressiveness` | 277 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 305 | 7% | 1 |
| `score_percentile_trigger` | 20 | 300 | 7% | 0 |
| `momentum_confirm_days` | 18 | 299 | 6% | 0 |
| `partial_take_level` | 8 | 305 | 3% | 1 |
| `signal_ema_span` | 7 | 299 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 294 | 2% | 0 |
| `entry_score_threshold` | 6 | 309 | 2% | 0 |
| `regime_threshold` | 6 | 314 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 291 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 304 | 2% | 0 |
| `ma_filter_mode` | 5 | 304 | 2% | 0 |
| `partial_take_pct` | 4 | 298 | 1% | 0 |
| `support_broken_gate` | 2 | 273 | 1% | 0 |
| `trailing_stop_mode` | 2 | 295 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 295 | 1% | 0 |
| `stop_tighten_factor` | 2 | 297 | 1% | 0 |
| `partial_take_pct_2` | 2 | 297 | 1% | 0 |
| `partial_take_level_2` | 2 | 300 | 1% | 0 |
| `resistance_overext_gate` | 1 | 273 | 0% | 0 |
| `vol_regime_mode` | 1 | 296 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-09-08T20:32:14+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
