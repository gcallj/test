...
_Generated: 2026-09-10T19:10:57+00:00_
...
- Total sweeps seen: **1786**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **6.7%** (over 1810 total attempts)
...
|---|---:|---:|---:|---:|
| `vote_threshold_long` | 300 | 0 | 0 | 0 |
| `score_strength_scaling` | 300 | 0 | 0 | 0 |
| `reward_risk_ratio` | 300 | 0 | 0 | 0 |
| `min_signal_strength` | 299 | 0 | 0 | 0 |
| `entry_confirmation_days` | 298 | 0 | 0 | 0 |
| `vote_threshold_short` | 297 | 0 | 1 | 0 |
| `z_threshold` | 296 | 0 | 0 | 0 |
| `time_stop_bars` | 296 | 0 | 0 | 0 |
| `volume_confirm_mode` | 296 | 0 | 1 | 0 |
| `ma_filter_period` | 296 | 0 | 1 | 0 |
| `stop_atr_mult` | 294 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 292 | 0 | 0 | 0 |
| `entry_aggressiveness` | 279 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 307 | 7% | 1 |
| `score_percentile_trigger` | 20 | 302 | 7% | 0 |
| `momentum_confirm_days` | 18 | 301 | 6% | 0 |
| `partial_take_level` | 8 | 307 | 3% | 1 |
| `signal_ema_span` | 7 | 301 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 296 | 2% | 0 |
| `entry_score_threshold` | 6 | 311 | 2% | 0 |
| `regime_threshold` | 6 | 316 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 293 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 306 | 2% | 0 |
| `ma_filter_mode` | 5 | 306 | 2% | 0 |
| `partial_take_pct` | 4 | 300 | 1% | 0 |
| `support_broken_gate` | 2 | 275 | 1% | 0 |
| `trailing_stop_mode` | 2 | 297 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 297 | 1% | 0 |
| `stop_tighten_factor` | 2 | 299 | 1% | 0 |
| `partial_take_pct_2` | 2 | 299 | 1% | 0 |
| `partial_take_level_2` | 2 | 302 | 1% | 0 |
| `resistance_overext_gate` | 1 | 275 | 0% | 0 |
| `vol_regime_mode` | 1 | 298 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-09-10T19:10:56+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
