...
_Generated: 2026-09-01T03:52:11+00:00_
...
- Total sweeps seen: **1702**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.0%** (over 1726 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 286 | 0 | 0 | 0 |
| `vote_threshold_long` | 286 | 0 | 0 | 0 |
| `score_strength_scaling` | 286 | 0 | 0 | 0 |
| `min_signal_strength` | 285 | 0 | 0 | 0 |
| `entry_confirmation_days` | 284 | 0 | 0 | 0 |
| `vote_threshold_short` | 283 | 0 | 1 | 0 |
| `time_stop_bars` | 282 | 0 | 0 | 0 |
| `volume_confirm_mode` | 282 | 0 | 1 | 0 |
| `z_threshold` | 282 | 0 | 0 | 0 |
| `ma_filter_period` | 282 | 0 | 1 | 0 |
| `stop_atr_mult` | 280 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 278 | 0 | 0 | 0 |
| `entry_aggressiveness` | 265 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 293 | 7% | 1 |
| `score_percentile_trigger` | 20 | 288 | 7% | 0 |
| `momentum_confirm_days` | 18 | 287 | 6% | 0 |
| `partial_take_level` | 8 | 293 | 3% | 1 |
| `signal_ema_span` | 7 | 287 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 282 | 2% | 0 |
| `entry_score_threshold` | 6 | 297 | 2% | 0 |
| `regime_threshold` | 6 | 302 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 279 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 292 | 2% | 0 |
| `ma_filter_mode` | 5 | 292 | 2% | 0 |
| `partial_take_pct` | 4 | 286 | 1% | 0 |
| `support_broken_gate` | 2 | 261 | 1% | 0 |
| `trailing_stop_mode` | 2 | 283 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 283 | 1% | 0 |
| `stop_tighten_factor` | 2 | 285 | 1% | 0 |
| `partial_take_pct_2` | 2 | 285 | 1% | 0 |
| `partial_take_level_2` | 2 | 288 | 1% | 0 |
| `resistance_overext_gate` | 1 | 261 | 0% | 0 |
| `vol_regime_mode` | 1 | 284 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-09-01T03:52:10+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
