...
_Generated: 2026-05-23T07:36:57+00:00_
...
- Total sweeps seen: **923**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.8%** (over 947 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 156 | 0 | 0 | 0 |
| `vote_threshold_long` | 154 | 0 | 0 | 0 |
| `score_strength_scaling` | 154 | 0 | 0 | 0 |
| `min_signal_strength` | 153 | 0 | 0 | 0 |
| `stop_atr_mult` | 153 | 0 | 0 | 0 |
| `entry_confirmation_days` | 152 | 0 | 0 | 0 |
| `volume_confirm_mode` | 152 | 0 | 1 | 0 |
| `time_stop_bars` | 152 | 0 | 0 | 0 |
| `ma_filter_period` | 152 | 0 | 1 | 0 |
| `vote_threshold_short` | 151 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 151 | 0 | 0 | 0 |
| `z_threshold` | 150 | 0 | 0 | 0 |
| `entry_aggressiveness` | 133 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 163 | 13% | 1 |
| `score_percentile_trigger` | 20 | 156 | 13% | 0 |
| `momentum_confirm_days` | 18 | 157 | 11% | 0 |
| `partial_take_level` | 8 | 163 | 5% | 1 |
| `signal_ema_span` | 7 | 155 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 155 | 4% | 0 |
| `entry_score_threshold` | 6 | 165 | 4% | 0 |
| `regime_threshold` | 6 | 172 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 152 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 162 | 3% | 0 |
| `ma_filter_mode` | 5 | 162 | 3% | 0 |
| `partial_take_pct` | 4 | 156 | 3% | 0 |
| `support_broken_gate` | 2 | 131 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 151 | 1% | 0 |
| `trailing_stop_mode` | 2 | 153 | 1% | 0 |
| `partial_take_pct_2` | 2 | 155 | 1% | 0 |
| `stop_tighten_factor` | 2 | 158 | 1% | 0 |
| `partial_take_level_2` | 2 | 158 | 1% | 0 |
| `resistance_overext_gate` | 1 | 131 | 1% | 0 |
| `vol_regime_mode` | 1 | 154 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T07:36:56+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
