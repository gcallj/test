...
_Generated: 2026-05-26T08:11:26+00:00_
...
- Total sweeps seen: **1107**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.7%** (over 1131 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 187 | 0 | 0 | 0 |
| `vote_threshold_long` | 185 | 0 | 0 | 0 |
| `score_strength_scaling` | 185 | 0 | 0 | 0 |
| `min_signal_strength` | 184 | 0 | 0 | 0 |
| `stop_atr_mult` | 183 | 0 | 0 | 0 |
| `entry_confirmation_days` | 183 | 0 | 0 | 0 |
| `volume_confirm_mode` | 183 | 0 | 1 | 0 |
| `ma_filter_period` | 183 | 0 | 1 | 0 |
| `time_stop_bars` | 182 | 0 | 0 | 0 |
| `vote_threshold_short` | 182 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 181 | 0 | 0 | 0 |
| `z_threshold` | 181 | 0 | 0 | 0 |
| `entry_aggressiveness` | 164 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 193 | 11% | 1 |
| `score_percentile_trigger` | 20 | 187 | 11% | 0 |
| `momentum_confirm_days` | 18 | 188 | 10% | 0 |
| `partial_take_level` | 8 | 194 | 4% | 1 |
| `signal_ema_span` | 7 | 186 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 185 | 3% | 0 |
| `entry_score_threshold` | 6 | 196 | 3% | 0 |
| `regime_threshold` | 6 | 203 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 182 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 193 | 3% | 0 |
| `ma_filter_mode` | 5 | 193 | 3% | 0 |
| `partial_take_pct` | 4 | 187 | 2% | 0 |
| `support_broken_gate` | 2 | 162 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 182 | 1% | 0 |
| `trailing_stop_mode` | 2 | 184 | 1% | 0 |
| `partial_take_pct_2` | 2 | 186 | 1% | 0 |
| `stop_tighten_factor` | 2 | 188 | 1% | 0 |
| `partial_take_level_2` | 2 | 189 | 1% | 0 |
| `resistance_overext_gate` | 1 | 162 | 1% | 0 |
| `vol_regime_mode` | 1 | 185 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-26T08:11:25+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
