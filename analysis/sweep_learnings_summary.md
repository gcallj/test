...
_Generated: 2026-05-20T00:29:42+00:00_
...
- Total sweeps seen: **515**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **22.4%** (over 539 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 88 | 0 | 0 | 0 |
| `vote_threshold_long` | 86 | 0 | 0 | 0 |
| `score_strength_scaling` | 86 | 0 | 0 | 0 |
| `stop_atr_mult` | 85 | 0 | 0 | 0 |
| `min_signal_strength` | 85 | 0 | 0 | 0 |
| `time_stop_bars` | 84 | 0 | 0 | 0 |
| `entry_confirmation_days` | 84 | 0 | 0 | 0 |
| `volume_confirm_mode` | 84 | 0 | 1 | 0 |
| `ma_filter_period` | 84 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 83 | 0 | 0 | 0 |
| `vote_threshold_short` | 83 | 0 | 1 | 0 |
| `z_threshold` | 82 | 0 | 0 | 0 |
| `entry_aggressiveness` | 65 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 95 | 22% | 1 |
| `score_percentile_trigger` | 20 | 88 | 23% | 0 |
| `momentum_confirm_days` | 18 | 89 | 20% | 0 |
| `partial_take_level` | 8 | 95 | 8% | 1 |
| `signal_ema_span` | 7 | 87 | 8% | 0 |
| `max_loss_per_trade_pct` | 6 | 87 | 7% | 0 |
| `entry_score_threshold` | 6 | 97 | 6% | 0 |
| `regime_threshold` | 6 | 104 | 6% | 1 |
| `equity_drawdown_stop_pct` | 5 | 84 | 6% | 0 |
| `volatility_filter_percentile` | 5 | 94 | 5% | 0 |
| `ma_filter_mode` | 5 | 94 | 5% | 0 |
| `partial_take_pct` | 4 | 88 | 5% | 0 |
| `support_broken_gate` | 2 | 63 | 3% | 0 |
| `entry_discount_atr_frac` | 2 | 83 | 2% | 0 |
| `trailing_stop_mode` | 2 | 85 | 2% | 0 |
| `partial_take_pct_2` | 2 | 87 | 2% | 0 |
| `stop_tighten_factor` | 2 | 90 | 2% | 0 |
| `partial_take_level_2` | 2 | 90 | 2% | 0 |
| `resistance_overext_gate` | 1 | 63 | 2% | 0 |
| `vol_regime_mode` | 1 | 86 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T00:29:41+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
