...
_Generated: 2026-05-18T17:39:53+00:00_
...
- Total sweeps seen: **341**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **33.2%** (over 365 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 59 | 0 | 0 | 0 |
| `vote_threshold_long` | 57 | 0 | 0 | 0 |
| `score_strength_scaling` | 57 | 0 | 0 | 0 |
| `stop_atr_mult` | 56 | 0 | 0 | 0 |
| `min_signal_strength` | 56 | 0 | 0 | 0 |
| `time_stop_bars` | 55 | 0 | 0 | 0 |
| `entry_confirmation_days` | 55 | 0 | 0 | 0 |
| `volume_confirm_mode` | 55 | 0 | 1 | 0 |
| `ma_filter_period` | 55 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 54 | 0 | 0 | 0 |
| `vote_threshold_short` | 54 | 0 | 1 | 0 |
| `z_threshold` | 53 | 0 | 0 | 0 |
| `entry_aggressiveness` | 36 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 66 | 32% | 1 |
| `score_percentile_trigger` | 20 | 59 | 34% | 0 |
| `momentum_confirm_days` | 18 | 60 | 30% | 0 |
| `partial_take_level` | 8 | 66 | 12% | 1 |
| `signal_ema_span` | 7 | 58 | 12% | 0 |
| `max_loss_per_trade_pct` | 6 | 58 | 10% | 0 |
| `entry_score_threshold` | 6 | 68 | 9% | 0 |
| `regime_threshold` | 6 | 75 | 8% | 1 |
| `equity_drawdown_stop_pct` | 5 | 55 | 9% | 0 |
| `volatility_filter_percentile` | 5 | 65 | 8% | 0 |
| `ma_filter_mode` | 5 | 65 | 8% | 0 |
| `partial_take_pct` | 4 | 59 | 7% | 0 |
| `support_broken_gate` | 2 | 34 | 6% | 0 |
| `entry_discount_atr_frac` | 2 | 54 | 4% | 0 |
| `trailing_stop_mode` | 2 | 56 | 4% | 0 |
| `partial_take_pct_2` | 2 | 58 | 3% | 0 |
| `stop_tighten_factor` | 2 | 61 | 3% | 0 |
| `partial_take_level_2` | 2 | 61 | 3% | 0 |
| `resistance_overext_gate` | 1 | 34 | 3% | 0 |
| `vol_regime_mode` | 1 | 57 | 2% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-18T17:39:52+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
