...
_Generated: 2026-05-21T23:36:28+00:00_
...
- Total sweeps seen: **755**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **15.5%** (over 779 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 128 | 0 | 0 | 0 |
| `vote_threshold_long` | 126 | 0 | 0 | 0 |
| `score_strength_scaling` | 126 | 0 | 0 | 0 |
| `min_signal_strength` | 125 | 0 | 0 | 0 |
| `stop_atr_mult` | 125 | 0 | 0 | 0 |
| `entry_confirmation_days` | 124 | 0 | 0 | 0 |
| `volume_confirm_mode` | 124 | 0 | 1 | 0 |
| `time_stop_bars` | 124 | 0 | 0 | 0 |
| `ma_filter_period` | 124 | 0 | 1 | 0 |
| `vote_threshold_short` | 123 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 123 | 0 | 0 | 0 |
| `z_threshold` | 122 | 0 | 0 | 0 |
| `entry_aggressiveness` | 105 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 135 | 16% | 1 |
| `score_percentile_trigger` | 20 | 128 | 16% | 0 |
| `momentum_confirm_days` | 18 | 129 | 14% | 0 |
| `partial_take_level` | 8 | 135 | 6% | 1 |
| `signal_ema_span` | 7 | 127 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 127 | 5% | 0 |
| `entry_score_threshold` | 6 | 137 | 4% | 0 |
| `regime_threshold` | 6 | 144 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 124 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 134 | 4% | 0 |
| `ma_filter_mode` | 5 | 134 | 4% | 0 |
| `partial_take_pct` | 4 | 128 | 3% | 0 |
| `support_broken_gate` | 2 | 103 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 123 | 2% | 0 |
| `trailing_stop_mode` | 2 | 125 | 2% | 0 |
| `partial_take_pct_2` | 2 | 127 | 2% | 0 |
| `stop_tighten_factor` | 2 | 130 | 2% | 0 |
| `partial_take_level_2` | 2 | 130 | 2% | 0 |
| `resistance_overext_gate` | 1 | 103 | 1% | 0 |
| `vol_regime_mode` | 1 | 126 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T23:36:27+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
