...
_Generated: 2026-06-01T04:19:32+00:00_
...
- Total sweeps seen: **1209**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.8%** (over 1233 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 204 | 0 | 0 | 0 |
| `vote_threshold_long` | 202 | 0 | 0 | 0 |
| `score_strength_scaling` | 202 | 0 | 0 | 0 |
| `min_signal_strength` | 201 | 0 | 0 | 0 |
| `entry_confirmation_days` | 200 | 0 | 0 | 0 |
| `stop_atr_mult` | 200 | 0 | 0 | 0 |
| `volume_confirm_mode` | 200 | 0 | 1 | 0 |
| `ma_filter_period` | 200 | 0 | 1 | 0 |
| `vote_threshold_short` | 199 | 0 | 1 | 0 |
| `time_stop_bars` | 199 | 0 | 0 | 0 |
| `z_threshold` | 198 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 198 | 0 | 0 | 0 |
| `entry_aggressiveness` | 181 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 210 | 10% | 1 |
| `score_percentile_trigger` | 20 | 204 | 10% | 0 |
| `momentum_confirm_days` | 18 | 205 | 9% | 0 |
| `partial_take_level` | 8 | 211 | 4% | 1 |
| `signal_ema_span` | 7 | 203 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 202 | 3% | 0 |
| `entry_score_threshold` | 6 | 213 | 3% | 0 |
| `regime_threshold` | 6 | 220 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 199 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 210 | 2% | 0 |
| `ma_filter_mode` | 5 | 210 | 2% | 0 |
| `partial_take_pct` | 4 | 204 | 2% | 0 |
| `support_broken_gate` | 2 | 179 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 199 | 1% | 0 |
| `trailing_stop_mode` | 2 | 201 | 1% | 0 |
| `partial_take_pct_2` | 2 | 203 | 1% | 0 |
| `stop_tighten_factor` | 2 | 205 | 1% | 0 |
| `partial_take_level_2` | 2 | 206 | 1% | 0 |
| `resistance_overext_gate` | 1 | 179 | 1% | 0 |
| `vol_regime_mode` | 1 | 202 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-01T04:19:31+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
