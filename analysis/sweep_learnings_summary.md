...
_Generated: 2026-08-01T07:35:02+00:00_
...
- Total sweeps seen: **1538**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.7%** (over 1562 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 259 | 0 | 0 | 0 |
| `vote_threshold_long` | 258 | 0 | 0 | 0 |
| `score_strength_scaling` | 258 | 0 | 0 | 0 |
| `min_signal_strength` | 257 | 0 | 0 | 0 |
| `entry_confirmation_days` | 256 | 0 | 0 | 0 |
| `volume_confirm_mode` | 255 | 0 | 1 | 0 |
| `vote_threshold_short` | 255 | 0 | 1 | 0 |
| `ma_filter_period` | 255 | 0 | 1 | 0 |
| `time_stop_bars` | 254 | 0 | 0 | 0 |
| `z_threshold` | 254 | 0 | 0 | 0 |
| `stop_atr_mult` | 253 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 251 | 0 | 0 | 0 |
| `entry_aggressiveness` | 237 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 265 | 8% | 1 |
| `score_percentile_trigger` | 20 | 260 | 8% | 0 |
| `momentum_confirm_days` | 18 | 260 | 7% | 0 |
| `partial_take_level` | 8 | 266 | 3% | 1 |
| `signal_ema_span` | 7 | 259 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 255 | 2% | 0 |
| `entry_score_threshold` | 6 | 269 | 2% | 0 |
| `regime_threshold` | 6 | 275 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 252 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 265 | 2% | 0 |
| `ma_filter_mode` | 5 | 265 | 2% | 0 |
| `partial_take_pct` | 4 | 259 | 2% | 0 |
| `support_broken_gate` | 2 | 234 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 255 | 1% | 0 |
| `trailing_stop_mode` | 2 | 256 | 1% | 0 |
| `stop_tighten_factor` | 2 | 258 | 1% | 0 |
| `partial_take_pct_2` | 2 | 258 | 1% | 0 |
| `partial_take_level_2` | 2 | 261 | 1% | 0 |
| `resistance_overext_gate` | 1 | 234 | 0% | 0 |
| `vol_regime_mode` | 1 | 257 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-01T07:35:00+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
