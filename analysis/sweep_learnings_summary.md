...
_Generated: 2026-05-19T17:57:06+00:00_
...
- Total sweeps seen: **473**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **24.3%** (over 497 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 81 | 0 | 0 | 0 |
| `vote_threshold_long` | 79 | 0 | 0 | 0 |
| `score_strength_scaling` | 79 | 0 | 0 | 0 |
| `stop_atr_mult` | 78 | 0 | 0 | 0 |
| `min_signal_strength` | 78 | 0 | 0 | 0 |
| `entry_confirmation_days` | 77 | 0 | 0 | 0 |
| `volume_confirm_mode` | 77 | 0 | 1 | 0 |
| `time_stop_bars` | 77 | 0 | 0 | 0 |
| `ma_filter_period` | 77 | 0 | 1 | 0 |
| `vote_threshold_short` | 76 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 76 | 0 | 0 | 0 |
| `z_threshold` | 75 | 0 | 0 | 0 |
| `entry_aggressiveness` | 58 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 88 | 24% | 1 |
| `score_percentile_trigger` | 20 | 81 | 25% | 0 |
| `momentum_confirm_days` | 18 | 82 | 22% | 0 |
| `partial_take_level` | 8 | 88 | 9% | 1 |
| `signal_ema_span` | 7 | 80 | 9% | 0 |
| `max_loss_per_trade_pct` | 6 | 80 | 8% | 0 |
| `entry_score_threshold` | 6 | 90 | 7% | 0 |
| `regime_threshold` | 6 | 97 | 6% | 1 |
| `equity_drawdown_stop_pct` | 5 | 77 | 6% | 0 |
| `volatility_filter_percentile` | 5 | 87 | 6% | 0 |
| `ma_filter_mode` | 5 | 87 | 6% | 0 |
| `partial_take_pct` | 4 | 81 | 5% | 0 |
| `support_broken_gate` | 2 | 56 | 4% | 0 |
| `entry_discount_atr_frac` | 2 | 76 | 3% | 0 |
| `trailing_stop_mode` | 2 | 78 | 3% | 0 |
| `partial_take_pct_2` | 2 | 80 | 2% | 0 |
| `stop_tighten_factor` | 2 | 83 | 2% | 0 |
| `partial_take_level_2` | 2 | 83 | 2% | 0 |
| `resistance_overext_gate` | 1 | 56 | 2% | 0 |
| `vol_regime_mode` | 1 | 79 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-19T17:57:05+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
