...
_Generated: 2026-05-22T11:13:34+00:00_
...
- Total sweeps seen: **815**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **14.4%** (over 839 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 138 | 0 | 0 | 0 |
| `vote_threshold_long` | 136 | 0 | 0 | 0 |
| `score_strength_scaling` | 136 | 0 | 0 | 0 |
| `stop_atr_mult` | 135 | 0 | 0 | 0 |
| `min_signal_strength` | 135 | 0 | 0 | 0 |
| `entry_confirmation_days` | 134 | 0 | 0 | 0 |
| `volume_confirm_mode` | 134 | 0 | 1 | 0 |
| `time_stop_bars` | 134 | 0 | 0 | 0 |
| `ma_filter_period` | 134 | 0 | 1 | 0 |
| `vote_threshold_short` | 133 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 133 | 0 | 0 | 0 |
| `z_threshold` | 132 | 0 | 0 | 0 |
| `entry_aggressiveness` | 115 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 145 | 14% | 1 |
| `score_percentile_trigger` | 20 | 138 | 14% | 0 |
| `momentum_confirm_days` | 18 | 139 | 13% | 0 |
| `partial_take_level` | 8 | 145 | 6% | 1 |
| `signal_ema_span` | 7 | 137 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 137 | 4% | 0 |
| `entry_score_threshold` | 6 | 147 | 4% | 0 |
| `regime_threshold` | 6 | 154 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 134 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 144 | 3% | 0 |
| `ma_filter_mode` | 5 | 144 | 3% | 0 |
| `partial_take_pct` | 4 | 138 | 3% | 0 |
| `support_broken_gate` | 2 | 113 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 133 | 2% | 0 |
| `trailing_stop_mode` | 2 | 135 | 1% | 0 |
| `partial_take_pct_2` | 2 | 137 | 1% | 0 |
| `stop_tighten_factor` | 2 | 140 | 1% | 0 |
| `partial_take_level_2` | 2 | 140 | 1% | 0 |
| `resistance_overext_gate` | 1 | 113 | 1% | 0 |
| `vol_regime_mode` | 1 | 136 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-22T11:13:33+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
