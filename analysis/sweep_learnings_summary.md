...
_Generated: 2026-06-10T16:11:43+00:00_
...
- Total sweeps seen: **1303**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.1%** (over 1327 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 220 | 0 | 0 | 0 |
| `vote_threshold_long` | 218 | 0 | 0 | 0 |
| `score_strength_scaling` | 218 | 0 | 0 | 0 |
| `min_signal_strength` | 217 | 0 | 0 | 0 |
| `entry_confirmation_days` | 216 | 0 | 0 | 0 |
| `volume_confirm_mode` | 216 | 0 | 1 | 0 |
| `ma_filter_period` | 216 | 0 | 1 | 0 |
| `stop_atr_mult` | 215 | 0 | 0 | 0 |
| `vote_threshold_short` | 215 | 0 | 1 | 0 |
| `time_stop_bars` | 214 | 0 | 0 | 0 |
| `z_threshold` | 214 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 213 | 0 | 0 | 0 |
| `entry_aggressiveness` | 197 | 0 | 0 | 0 |
...
| `score_percentile_trigger` | 20 | 220 | 9% | 0 |
| `momentum_confirm_days` | 18 | 221 | 8% | 0 |
| `partial_take_level` | 8 | 227 | 4% | 1 |
| `signal_ema_span` | 7 | 219 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 217 | 3% | 0 |
| `entry_score_threshold` | 6 | 229 | 3% | 0 |
| `regime_threshold` | 6 | 236 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 214 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 226 | 2% | 0 |
| `ma_filter_mode` | 5 | 226 | 2% | 0 |
| `partial_take_pct` | 4 | 220 | 2% | 0 |
| `support_broken_gate` | 2 | 195 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 215 | 1% | 0 |
| `trailing_stop_mode` | 2 | 217 | 1% | 0 |
| `partial_take_pct_2` | 2 | 219 | 1% | 0 |
| `stop_tighten_factor` | 2 | 220 | 1% | 0 |
| `partial_take_level_2` | 2 | 222 | 1% | 0 |
| `resistance_overext_gate` | 1 | 195 | 1% | 0 |
| `vol_regime_mode` | 1 | 218 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-10T16:11:41+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
