...
_Generated: 2026-05-30T16:51:44+00:00_
...
- Total sweeps seen: **1155**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.3%** (over 1179 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 195 | 0 | 0 | 0 |
| `vote_threshold_long` | 193 | 0 | 0 | 0 |
| `score_strength_scaling` | 193 | 0 | 0 | 0 |
| `min_signal_strength` | 192 | 0 | 0 | 0 |
| `stop_atr_mult` | 191 | 0 | 0 | 0 |
| `entry_confirmation_days` | 191 | 0 | 0 | 0 |
| `volume_confirm_mode` | 191 | 0 | 1 | 0 |
| `ma_filter_period` | 191 | 0 | 1 | 0 |
| `time_stop_bars` | 190 | 0 | 0 | 0 |
| `vote_threshold_short` | 190 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 189 | 0 | 0 | 0 |
| `z_threshold` | 189 | 0 | 0 | 0 |
| `entry_aggressiveness` | 172 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 201 | 10% | 1 |
| `score_percentile_trigger` | 20 | 195 | 10% | 0 |
| `momentum_confirm_days` | 18 | 196 | 9% | 0 |
| `partial_take_level` | 8 | 202 | 4% | 1 |
| `signal_ema_span` | 7 | 194 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 193 | 3% | 0 |
| `entry_score_threshold` | 6 | 204 | 3% | 0 |
| `regime_threshold` | 6 | 211 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 190 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 201 | 2% | 0 |
| `ma_filter_mode` | 5 | 201 | 2% | 0 |
| `partial_take_pct` | 4 | 195 | 2% | 0 |
| `support_broken_gate` | 2 | 170 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 190 | 1% | 0 |
| `trailing_stop_mode` | 2 | 192 | 1% | 0 |
| `partial_take_pct_2` | 2 | 194 | 1% | 0 |
| `stop_tighten_factor` | 2 | 196 | 1% | 0 |
| `partial_take_level_2` | 2 | 197 | 1% | 0 |
| `resistance_overext_gate` | 1 | 170 | 1% | 0 |
| `vol_regime_mode` | 1 | 193 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-30T16:51:43+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
