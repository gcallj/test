...
_Generated: 2026-05-23T13:15:19+00:00_
...
- Total sweeps seen: **952**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.4%** (over 976 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 161 | 0 | 0 | 0 |
| `vote_threshold_long` | 159 | 0 | 0 | 0 |
| `score_strength_scaling` | 159 | 0 | 0 | 0 |
| `min_signal_strength` | 158 | 0 | 0 | 0 |
| `stop_atr_mult` | 158 | 0 | 0 | 0 |
| `entry_confirmation_days` | 157 | 0 | 0 | 0 |
| `volume_confirm_mode` | 157 | 0 | 1 | 0 |
| `ma_filter_period` | 157 | 0 | 1 | 0 |
| `time_stop_bars` | 156 | 0 | 0 | 0 |
| `vote_threshold_short` | 156 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 156 | 0 | 0 | 0 |
| `z_threshold` | 155 | 0 | 0 | 0 |
| `entry_aggressiveness` | 138 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 167 | 13% | 1 |
| `score_percentile_trigger` | 20 | 161 | 12% | 0 |
| `momentum_confirm_days` | 18 | 162 | 11% | 0 |
| `partial_take_level` | 8 | 168 | 5% | 1 |
| `signal_ema_span` | 7 | 160 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 160 | 4% | 0 |
| `entry_score_threshold` | 6 | 170 | 4% | 0 |
| `regime_threshold` | 6 | 177 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 157 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 167 | 3% | 0 |
| `ma_filter_mode` | 5 | 167 | 3% | 0 |
| `partial_take_pct` | 4 | 161 | 2% | 0 |
| `support_broken_gate` | 2 | 136 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 156 | 1% | 0 |
| `trailing_stop_mode` | 2 | 158 | 1% | 0 |
| `partial_take_pct_2` | 2 | 160 | 1% | 0 |
| `stop_tighten_factor` | 2 | 163 | 1% | 0 |
| `partial_take_level_2` | 2 | 163 | 1% | 0 |
| `resistance_overext_gate` | 1 | 136 | 1% | 0 |
| `vol_regime_mode` | 1 | 159 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T13:15:18+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
