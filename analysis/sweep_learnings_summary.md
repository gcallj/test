...
_Generated: 2026-05-22T09:53:00+00:00_
...
- Total sweeps seen: **809**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **14.5%** (over 833 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 137 | 0 | 0 | 0 |
| `vote_threshold_long` | 135 | 0 | 0 | 0 |
| `score_strength_scaling` | 135 | 0 | 0 | 0 |
| `stop_atr_mult` | 134 | 0 | 0 | 0 |
| `min_signal_strength` | 134 | 0 | 0 | 0 |
| `time_stop_bars` | 133 | 0 | 0 | 0 |
| `entry_confirmation_days` | 133 | 0 | 0 | 0 |
| `volume_confirm_mode` | 133 | 0 | 1 | 0 |
| `ma_filter_period` | 133 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 132 | 0 | 0 | 0 |
| `vote_threshold_short` | 132 | 0 | 1 | 0 |
| `z_threshold` | 131 | 0 | 0 | 0 |
| `entry_aggressiveness` | 114 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 144 | 15% | 1 |
| `score_percentile_trigger` | 20 | 137 | 15% | 0 |
| `momentum_confirm_days` | 18 | 138 | 13% | 0 |
| `partial_take_level` | 8 | 144 | 6% | 1 |
| `signal_ema_span` | 7 | 136 | 5% | 0 |
| `max_loss_per_trade_pct` | 6 | 136 | 4% | 0 |
| `entry_score_threshold` | 6 | 146 | 4% | 0 |
| `regime_threshold` | 6 | 153 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 133 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 143 | 3% | 0 |
| `ma_filter_mode` | 5 | 143 | 3% | 0 |
| `partial_take_pct` | 4 | 137 | 3% | 0 |
| `support_broken_gate` | 2 | 112 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 132 | 2% | 0 |
| `trailing_stop_mode` | 2 | 134 | 1% | 0 |
| `partial_take_pct_2` | 2 | 136 | 1% | 0 |
| `stop_tighten_factor` | 2 | 139 | 1% | 0 |
| `partial_take_level_2` | 2 | 139 | 1% | 0 |
| `resistance_overext_gate` | 1 | 112 | 1% | 0 |
| `vol_regime_mode` | 1 | 135 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-22T09:52:59+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
