...
_Generated: 2026-06-18T14:56:31+00:00_
...
- Total sweeps seen: **1357**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.8%** (over 1381 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 229 | 0 | 0 | 0 |
| `score_strength_scaling` | 227 | 0 | 0 | 0 |
| `vote_threshold_long` | 227 | 0 | 0 | 0 |
| `min_signal_strength` | 226 | 0 | 0 | 0 |
| `volume_confirm_mode` | 225 | 0 | 1 | 0 |
| `entry_confirmation_days` | 225 | 0 | 0 | 0 |
| `ma_filter_period` | 225 | 0 | 1 | 0 |
| `stop_atr_mult` | 224 | 0 | 0 | 0 |
| `vote_threshold_short` | 224 | 0 | 1 | 0 |
| `time_stop_bars` | 223 | 0 | 0 | 0 |
| `z_threshold` | 223 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 222 | 0 | 0 | 0 |
| `entry_aggressiveness` | 206 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 234 | 9% | 1 |
| `score_percentile_trigger` | 20 | 229 | 9% | 0 |
| `momentum_confirm_days` | 18 | 230 | 8% | 0 |
| `partial_take_level` | 8 | 236 | 3% | 1 |
| `signal_ema_span` | 7 | 228 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 226 | 3% | 0 |
| `entry_score_threshold` | 6 | 238 | 3% | 0 |
| `regime_threshold` | 6 | 245 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 223 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 235 | 2% | 0 |
| `ma_filter_mode` | 5 | 235 | 2% | 0 |
| `partial_take_pct` | 4 | 229 | 2% | 0 |
| `support_broken_gate` | 2 | 204 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 224 | 1% | 0 |
| `trailing_stop_mode` | 2 | 226 | 1% | 0 |
| `partial_take_pct_2` | 2 | 228 | 1% | 0 |
| `stop_tighten_factor` | 2 | 229 | 1% | 0 |
| `partial_take_level_2` | 2 | 231 | 1% | 0 |
| `resistance_overext_gate` | 1 | 204 | 0% | 0 |
| `vol_regime_mode` | 1 | 227 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-18T14:56:30+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
