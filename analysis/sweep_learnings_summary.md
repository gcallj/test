...
_Generated: 2026-06-14T19:55:08+00:00_
...
- Total sweeps seen: **1327**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.0%** (over 1351 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 224 | 0 | 0 | 0 |
| `score_strength_scaling` | 222 | 0 | 0 | 0 |
| `vote_threshold_long` | 222 | 0 | 0 | 0 |
| `min_signal_strength` | 221 | 0 | 0 | 0 |
| `volume_confirm_mode` | 220 | 0 | 1 | 0 |
| `entry_confirmation_days` | 220 | 0 | 0 | 0 |
| `ma_filter_period` | 220 | 0 | 1 | 0 |
| `stop_atr_mult` | 219 | 0 | 0 | 0 |
| `vote_threshold_short` | 219 | 0 | 1 | 0 |
| `time_stop_bars` | 218 | 0 | 0 | 0 |
| `z_threshold` | 218 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 217 | 0 | 0 | 0 |
| `entry_aggressiveness` | 201 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 229 | 9% | 1 |
| `score_percentile_trigger` | 20 | 224 | 9% | 0 |
| `momentum_confirm_days` | 18 | 225 | 8% | 0 |
| `partial_take_level` | 8 | 231 | 3% | 1 |
| `signal_ema_span` | 7 | 223 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 221 | 3% | 0 |
| `entry_score_threshold` | 6 | 233 | 3% | 0 |
| `regime_threshold` | 6 | 240 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 218 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 230 | 2% | 0 |
| `ma_filter_mode` | 5 | 230 | 2% | 0 |
| `partial_take_pct` | 4 | 224 | 2% | 0 |
| `support_broken_gate` | 2 | 199 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 219 | 1% | 0 |
| `trailing_stop_mode` | 2 | 221 | 1% | 0 |
| `partial_take_pct_2` | 2 | 223 | 1% | 0 |
| `stop_tighten_factor` | 2 | 224 | 1% | 0 |
| `partial_take_level_2` | 2 | 226 | 1% | 0 |
| `resistance_overext_gate` | 1 | 199 | 1% | 0 |
| `vol_regime_mode` | 1 | 222 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-14T19:55:07+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
