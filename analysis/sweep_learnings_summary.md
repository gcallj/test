...
_Generated: 2026-05-21T15:53:14+00:00_
...
- Total sweeps seen: **713**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **16.4%** (over 737 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 121 | 0 | 0 | 0 |
| `vote_threshold_long` | 119 | 0 | 0 | 0 |
| `score_strength_scaling` | 119 | 0 | 0 | 0 |
| `stop_atr_mult` | 118 | 0 | 0 | 0 |
| `min_signal_strength` | 118 | 0 | 0 | 0 |
| `entry_confirmation_days` | 117 | 0 | 0 | 0 |
| `volume_confirm_mode` | 117 | 0 | 1 | 0 |
| `time_stop_bars` | 117 | 0 | 0 | 0 |
| `ma_filter_period` | 117 | 0 | 1 | 0 |
| `vote_threshold_short` | 116 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 116 | 0 | 0 | 0 |
| `z_threshold` | 115 | 0 | 0 | 0 |
| `entry_aggressiveness` | 98 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 128 | 16% | 1 |
| `score_percentile_trigger` | 20 | 121 | 17% | 0 |
| `momentum_confirm_days` | 18 | 122 | 15% | 0 |
| `partial_take_level` | 8 | 128 | 6% | 1 |
| `signal_ema_span` | 7 | 120 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 120 | 5% | 0 |
| `entry_score_threshold` | 6 | 130 | 5% | 0 |
| `regime_threshold` | 6 | 137 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 117 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 127 | 4% | 0 |
| `ma_filter_mode` | 5 | 127 | 4% | 0 |
| `partial_take_pct` | 4 | 121 | 3% | 0 |
| `support_broken_gate` | 2 | 96 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 116 | 2% | 0 |
| `trailing_stop_mode` | 2 | 118 | 2% | 0 |
| `partial_take_pct_2` | 2 | 120 | 2% | 0 |
| `stop_tighten_factor` | 2 | 123 | 2% | 0 |
| `partial_take_level_2` | 2 | 123 | 2% | 0 |
| `resistance_overext_gate` | 1 | 96 | 1% | 0 |
| `vol_regime_mode` | 1 | 119 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T15:53:14+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
