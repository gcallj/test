...
_Generated: 2026-06-10T20:15:14+00:00_
...
- Total sweeps seen: **1309**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.1%** (over 1333 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 221 | 0 | 0 | 0 |
| `score_strength_scaling` | 219 | 0 | 0 | 0 |
| `vote_threshold_long` | 219 | 0 | 0 | 0 |
| `min_signal_strength` | 218 | 0 | 0 | 0 |
| `volume_confirm_mode` | 217 | 0 | 1 | 0 |
| `entry_confirmation_days` | 217 | 0 | 0 | 0 |
| `ma_filter_period` | 217 | 0 | 1 | 0 |
| `stop_atr_mult` | 216 | 0 | 0 | 0 |
| `vote_threshold_short` | 216 | 0 | 1 | 0 |
| `time_stop_bars` | 215 | 0 | 0 | 0 |
| `z_threshold` | 215 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 214 | 0 | 0 | 0 |
| `entry_aggressiveness` | 198 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 226 | 9% | 1 |
| `score_percentile_trigger` | 20 | 221 | 9% | 0 |
| `momentum_confirm_days` | 18 | 222 | 8% | 0 |
| `partial_take_level` | 8 | 228 | 4% | 1 |
| `signal_ema_span` | 7 | 220 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 218 | 3% | 0 |
| `entry_score_threshold` | 6 | 230 | 3% | 0 |
| `regime_threshold` | 6 | 237 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 215 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 227 | 2% | 0 |
| `ma_filter_mode` | 5 | 227 | 2% | 0 |
| `partial_take_pct` | 4 | 221 | 2% | 0 |
| `support_broken_gate` | 2 | 196 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 216 | 1% | 0 |
| `trailing_stop_mode` | 2 | 218 | 1% | 0 |
| `partial_take_pct_2` | 2 | 220 | 1% | 0 |
| `stop_tighten_factor` | 2 | 221 | 1% | 0 |
| `partial_take_level_2` | 2 | 223 | 1% | 0 |
| `resistance_overext_gate` | 1 | 196 | 1% | 0 |
| `vol_regime_mode` | 1 | 219 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-10T20:15:13+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
