...
_Generated: 2026-06-14T23:32:30+00:00_
...
- Total sweeps seen: **1333**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.9%** (over 1357 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 225 | 0 | 0 | 0 |
| `score_strength_scaling` | 223 | 0 | 0 | 0 |
| `vote_threshold_long` | 223 | 0 | 0 | 0 |
| `min_signal_strength` | 222 | 0 | 0 | 0 |
| `volume_confirm_mode` | 221 | 0 | 1 | 0 |
| `entry_confirmation_days` | 221 | 0 | 0 | 0 |
| `ma_filter_period` | 221 | 0 | 1 | 0 |
| `stop_atr_mult` | 220 | 0 | 0 | 0 |
| `vote_threshold_short` | 220 | 0 | 1 | 0 |
| `time_stop_bars` | 219 | 0 | 0 | 0 |
| `z_threshold` | 219 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 218 | 0 | 0 | 0 |
| `entry_aggressiveness` | 202 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 230 | 9% | 1 |
| `score_percentile_trigger` | 20 | 225 | 9% | 0 |
| `momentum_confirm_days` | 18 | 226 | 8% | 0 |
| `partial_take_level` | 8 | 232 | 3% | 1 |
| `signal_ema_span` | 7 | 224 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 222 | 3% | 0 |
| `entry_score_threshold` | 6 | 234 | 3% | 0 |
| `regime_threshold` | 6 | 241 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 219 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 231 | 2% | 0 |
| `ma_filter_mode` | 5 | 231 | 2% | 0 |
| `partial_take_pct` | 4 | 225 | 2% | 0 |
| `support_broken_gate` | 2 | 200 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 220 | 1% | 0 |
| `trailing_stop_mode` | 2 | 222 | 1% | 0 |
| `partial_take_pct_2` | 2 | 224 | 1% | 0 |
| `stop_tighten_factor` | 2 | 225 | 1% | 0 |
| `partial_take_level_2` | 2 | 227 | 1% | 0 |
| `resistance_overext_gate` | 1 | 200 | 0% | 0 |
| `vol_regime_mode` | 1 | 223 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-14T23:32:29+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
