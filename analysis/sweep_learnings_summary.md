...
_Generated: 2026-05-20T09:27:16+00:00_
...
- Total sweeps seen: **557**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **20.8%** (over 581 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 95 | 0 | 0 | 0 |
| `vote_threshold_long` | 93 | 0 | 0 | 0 |
| `score_strength_scaling` | 93 | 0 | 0 | 0 |
| `stop_atr_mult` | 92 | 0 | 0 | 0 |
| `min_signal_strength` | 92 | 0 | 0 | 0 |
| `entry_confirmation_days` | 91 | 0 | 0 | 0 |
| `volume_confirm_mode` | 91 | 0 | 1 | 0 |
| `time_stop_bars` | 91 | 0 | 0 | 0 |
| `ma_filter_period` | 91 | 0 | 1 | 0 |
| `vote_threshold_short` | 90 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 90 | 0 | 0 | 0 |
| `z_threshold` | 89 | 0 | 0 | 0 |
| `entry_aggressiveness` | 72 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 102 | 21% | 1 |
| `score_percentile_trigger` | 20 | 95 | 21% | 0 |
| `momentum_confirm_days` | 18 | 96 | 19% | 0 |
| `partial_take_level` | 8 | 102 | 8% | 1 |
| `signal_ema_span` | 7 | 94 | 7% | 0 |
| `max_loss_per_trade_pct` | 6 | 94 | 6% | 0 |
| `entry_score_threshold` | 6 | 104 | 6% | 0 |
| `regime_threshold` | 6 | 111 | 5% | 1 |
| `equity_drawdown_stop_pct` | 5 | 91 | 5% | 0 |
| `volatility_filter_percentile` | 5 | 101 | 5% | 0 |
| `ma_filter_mode` | 5 | 101 | 5% | 0 |
| `partial_take_pct` | 4 | 95 | 4% | 0 |
| `support_broken_gate` | 2 | 70 | 3% | 0 |
| `entry_discount_atr_frac` | 2 | 90 | 2% | 0 |
| `trailing_stop_mode` | 2 | 92 | 2% | 0 |
| `partial_take_pct_2` | 2 | 94 | 2% | 0 |
| `stop_tighten_factor` | 2 | 97 | 2% | 0 |
| `partial_take_level_2` | 2 | 97 | 2% | 0 |
| `resistance_overext_gate` | 1 | 70 | 1% | 0 |
| `vol_regime_mode` | 1 | 93 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-20T09:27:16+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
