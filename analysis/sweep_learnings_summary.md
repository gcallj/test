...
_Generated: 2026-05-24T05:42:08+00:00_
...
- Total sweeps seen: **1017**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **11.6%** (over 1041 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 172 | 0 | 0 | 0 |
| `vote_threshold_long` | 170 | 0 | 0 | 0 |
| `score_strength_scaling` | 170 | 0 | 0 | 0 |
| `min_signal_strength` | 169 | 0 | 0 | 0 |
| `volume_confirm_mode` | 168 | 0 | 1 | 0 |
| `stop_atr_mult` | 168 | 0 | 0 | 0 |
| `entry_confirmation_days` | 168 | 0 | 0 | 0 |
| `ma_filter_period` | 168 | 0 | 1 | 0 |
| `time_stop_bars` | 167 | 0 | 0 | 0 |
| `vote_threshold_short` | 167 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 166 | 0 | 0 | 0 |
| `z_threshold` | 166 | 0 | 0 | 0 |
| `entry_aggressiveness` | 149 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 178 | 12% | 1 |
| `score_percentile_trigger` | 20 | 172 | 12% | 0 |
| `momentum_confirm_days` | 18 | 173 | 10% | 0 |
| `partial_take_level` | 8 | 179 | 4% | 1 |
| `signal_ema_span` | 7 | 171 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 170 | 4% | 0 |
| `entry_score_threshold` | 6 | 181 | 3% | 0 |
| `regime_threshold` | 6 | 188 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 167 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 178 | 3% | 0 |
| `ma_filter_mode` | 5 | 178 | 3% | 0 |
| `partial_take_pct` | 4 | 172 | 2% | 0 |
| `support_broken_gate` | 2 | 147 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 167 | 1% | 0 |
| `trailing_stop_mode` | 2 | 169 | 1% | 0 |
| `partial_take_pct_2` | 2 | 171 | 1% | 0 |
| `stop_tighten_factor` | 2 | 173 | 1% | 0 |
| `partial_take_level_2` | 2 | 174 | 1% | 0 |
| `resistance_overext_gate` | 1 | 147 | 1% | 0 |
| `vol_regime_mode` | 1 | 170 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-24T05:42:06+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
