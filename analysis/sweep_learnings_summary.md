...
_Generated: 2026-05-25T14:06:42+00:00_
...
- Total sweeps seen: **1077**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **11.0%** (over 1101 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 182 | 0 | 0 | 0 |
| `vote_threshold_long` | 180 | 0 | 0 | 0 |
| `score_strength_scaling` | 180 | 0 | 0 | 0 |
| `min_signal_strength` | 179 | 0 | 0 | 0 |
| `stop_atr_mult` | 178 | 0 | 0 | 0 |
| `entry_confirmation_days` | 178 | 0 | 0 | 0 |
| `volume_confirm_mode` | 178 | 0 | 1 | 0 |
| `ma_filter_period` | 178 | 0 | 1 | 0 |
| `vote_threshold_short` | 177 | 0 | 1 | 0 |
| `time_stop_bars` | 177 | 0 | 0 | 0 |
| `z_threshold` | 176 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 176 | 0 | 0 | 0 |
| `entry_aggressiveness` | 159 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 188 | 11% | 1 |
| `score_percentile_trigger` | 20 | 182 | 11% | 0 |
| `momentum_confirm_days` | 18 | 183 | 10% | 0 |
| `partial_take_level` | 8 | 189 | 4% | 1 |
| `signal_ema_span` | 7 | 181 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 180 | 3% | 0 |
| `entry_score_threshold` | 6 | 191 | 3% | 0 |
| `regime_threshold` | 6 | 198 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 177 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 188 | 3% | 0 |
| `ma_filter_mode` | 5 | 188 | 3% | 0 |
| `partial_take_pct` | 4 | 182 | 2% | 0 |
| `support_broken_gate` | 2 | 157 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 177 | 1% | 0 |
| `trailing_stop_mode` | 2 | 179 | 1% | 0 |
| `partial_take_pct_2` | 2 | 181 | 1% | 0 |
| `stop_tighten_factor` | 2 | 183 | 1% | 0 |
| `partial_take_level_2` | 2 | 184 | 1% | 0 |
| `resistance_overext_gate` | 1 | 157 | 1% | 0 |
| `vol_regime_mode` | 1 | 180 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-25T14:06:41+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
