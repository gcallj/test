...
_Generated: 2026-09-20T21:07:58+00:00_
...
- Total sweeps seen: **1822**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **6.6%** (over 1846 total attempts)
...
|---|---:|---:|---:|---:|
| `vote_threshold_long` | 306 | 0 | 0 | 0 |
| `score_strength_scaling` | 306 | 0 | 0 | 0 |
| `reward_risk_ratio` | 306 | 0 | 0 | 0 |
| `min_signal_strength` | 305 | 0 | 0 | 0 |
| `entry_confirmation_days` | 304 | 0 | 0 | 0 |
| `vote_threshold_short` | 303 | 0 | 1 | 0 |
| `z_threshold` | 302 | 0 | 0 | 0 |
| `time_stop_bars` | 302 | 0 | 0 | 0 |
| `volume_confirm_mode` | 302 | 0 | 1 | 0 |
| `ma_filter_period` | 302 | 0 | 1 | 0 |
| `stop_atr_mult` | 300 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 298 | 0 | 0 | 0 |
| `entry_aggressiveness` | 285 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 313 | 7% | 1 |
| `score_percentile_trigger` | 20 | 308 | 6% | 0 |
| `momentum_confirm_days` | 18 | 307 | 6% | 0 |
| `partial_take_level` | 8 | 313 | 3% | 1 |
| `signal_ema_span` | 7 | 307 | 2% | 0 |
| `max_loss_per_trade_pct` | 6 | 302 | 2% | 0 |
| `entry_score_threshold` | 6 | 317 | 2% | 0 |
| `regime_threshold` | 6 | 322 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 299 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 312 | 2% | 0 |
| `ma_filter_mode` | 5 | 312 | 2% | 0 |
| `partial_take_pct` | 4 | 306 | 1% | 0 |
| `support_broken_gate` | 2 | 281 | 1% | 0 |
| `trailing_stop_mode` | 2 | 303 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 303 | 1% | 0 |
| `stop_tighten_factor` | 2 | 305 | 1% | 0 |
| `partial_take_pct_2` | 2 | 305 | 1% | 0 |
| `partial_take_level_2` | 2 | 308 | 1% | 0 |
| `resistance_overext_gate` | 1 | 281 | 0% | 0 |
| `vol_regime_mode` | 1 | 304 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-09-20T21:07:56+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
