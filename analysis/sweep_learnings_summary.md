...
_Generated: 2026-05-19T04:46:32+00:00_
...
- Total sweeps seen: **413**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **27.7%** (over 437 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 71 | 0 | 0 | 0 |
| `vote_threshold_long` | 69 | 0 | 0 | 0 |
| `score_strength_scaling` | 69 | 0 | 0 | 0 |
| `stop_atr_mult` | 68 | 0 | 0 | 0 |
| `min_signal_strength` | 68 | 0 | 0 | 0 |
| `time_stop_bars` | 67 | 0 | 0 | 0 |
| `entry_confirmation_days` | 67 | 0 | 0 | 0 |
| `volume_confirm_mode` | 67 | 0 | 1 | 0 |
| `ma_filter_period` | 67 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 66 | 0 | 0 | 0 |
| `vote_threshold_short` | 66 | 0 | 1 | 0 |
| `z_threshold` | 65 | 0 | 0 | 0 |
| `entry_aggressiveness` | 48 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 78 | 27% | 1 |
| `score_percentile_trigger` | 20 | 71 | 28% | 0 |
| `momentum_confirm_days` | 18 | 72 | 25% | 0 |
| `partial_take_level` | 8 | 78 | 10% | 1 |
| `signal_ema_span` | 7 | 70 | 10% | 0 |
| `max_loss_per_trade_pct` | 6 | 70 | 9% | 0 |
| `entry_score_threshold` | 6 | 80 | 8% | 0 |
| `regime_threshold` | 6 | 87 | 7% | 1 |
| `equity_drawdown_stop_pct` | 5 | 67 | 7% | 0 |
| `volatility_filter_percentile` | 5 | 77 | 6% | 0 |
| `ma_filter_mode` | 5 | 77 | 6% | 0 |
| `partial_take_pct` | 4 | 71 | 6% | 0 |
| `support_broken_gate` | 2 | 46 | 4% | 0 |
| `entry_discount_atr_frac` | 2 | 66 | 3% | 0 |
| `trailing_stop_mode` | 2 | 68 | 3% | 0 |
| `partial_take_pct_2` | 2 | 70 | 3% | 0 |
| `stop_tighten_factor` | 2 | 73 | 3% | 0 |
| `partial_take_level_2` | 2 | 73 | 3% | 0 |
| `resistance_overext_gate` | 1 | 46 | 2% | 0 |
| `vol_regime_mode` | 1 | 69 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-19T04:46:32+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
