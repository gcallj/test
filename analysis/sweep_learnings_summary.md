...
_Generated: 2026-05-29T03:36:41+00:00_
...
- Total sweeps seen: **1137**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **10.4%** (over 1161 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 192 | 0 | 0 | 0 |
| `vote_threshold_long` | 190 | 0 | 0 | 0 |
| `score_strength_scaling` | 190 | 0 | 0 | 0 |
| `min_signal_strength` | 189 | 0 | 0 | 0 |
| `entry_confirmation_days` | 188 | 0 | 0 | 0 |
| `stop_atr_mult` | 188 | 0 | 0 | 0 |
| `volume_confirm_mode` | 188 | 0 | 1 | 0 |
| `ma_filter_period` | 188 | 0 | 1 | 0 |
| `vote_threshold_short` | 187 | 0 | 1 | 0 |
| `time_stop_bars` | 187 | 0 | 0 | 0 |
| `z_threshold` | 186 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 186 | 0 | 0 | 0 |
| `entry_aggressiveness` | 169 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 198 | 11% | 1 |
| `score_percentile_trigger` | 20 | 192 | 10% | 0 |
| `momentum_confirm_days` | 18 | 193 | 9% | 0 |
| `partial_take_level` | 8 | 199 | 4% | 1 |
| `signal_ema_span` | 7 | 191 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 190 | 3% | 0 |
| `entry_score_threshold` | 6 | 201 | 3% | 0 |
| `regime_threshold` | 6 | 208 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 187 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 198 | 3% | 0 |
| `ma_filter_mode` | 5 | 198 | 3% | 0 |
| `partial_take_pct` | 4 | 192 | 2% | 0 |
| `support_broken_gate` | 2 | 167 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 187 | 1% | 0 |
| `trailing_stop_mode` | 2 | 189 | 1% | 0 |
| `partial_take_pct_2` | 2 | 191 | 1% | 0 |
| `stop_tighten_factor` | 2 | 193 | 1% | 0 |
| `partial_take_level_2` | 2 | 194 | 1% | 0 |
| `resistance_overext_gate` | 1 | 167 | 1% | 0 |
| `vol_regime_mode` | 1 | 190 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-29T03:36:41+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
