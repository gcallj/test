...
_Generated: 2026-05-21T05:01:03+00:00_
...
- Total sweeps seen: **665**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **17.6%** (over 689 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 113 | 0 | 0 | 0 |
| `vote_threshold_long` | 111 | 0 | 0 | 0 |
| `score_strength_scaling` | 111 | 0 | 0 | 0 |
| `stop_atr_mult` | 110 | 0 | 0 | 0 |
| `min_signal_strength` | 110 | 0 | 0 | 0 |
| `entry_confirmation_days` | 109 | 0 | 0 | 0 |
| `volume_confirm_mode` | 109 | 0 | 1 | 0 |
| `time_stop_bars` | 109 | 0 | 0 | 0 |
| `ma_filter_period` | 109 | 0 | 1 | 0 |
| `vote_threshold_short` | 108 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 108 | 0 | 0 | 0 |
| `z_threshold` | 107 | 0 | 0 | 0 |
| `entry_aggressiveness` | 90 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 120 | 18% | 1 |
| `score_percentile_trigger` | 20 | 113 | 18% | 0 |
| `momentum_confirm_days` | 18 | 114 | 16% | 0 |
| `partial_take_level` | 8 | 120 | 7% | 1 |
| `signal_ema_span` | 7 | 112 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 112 | 5% | 0 |
| `entry_score_threshold` | 6 | 122 | 5% | 0 |
| `regime_threshold` | 6 | 129 | 5% | 1 |
| `equity_drawdown_stop_pct` | 5 | 109 | 5% | 0 |
| `volatility_filter_percentile` | 5 | 119 | 4% | 0 |
| `ma_filter_mode` | 5 | 119 | 4% | 0 |
| `partial_take_pct` | 4 | 113 | 4% | 0 |
| `support_broken_gate` | 2 | 88 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 108 | 2% | 0 |
| `trailing_stop_mode` | 2 | 110 | 2% | 0 |
| `partial_take_pct_2` | 2 | 112 | 2% | 0 |
| `stop_tighten_factor` | 2 | 115 | 2% | 0 |
| `partial_take_level_2` | 2 | 115 | 2% | 0 |
| `resistance_overext_gate` | 1 | 88 | 1% | 0 |
| `vol_regime_mode` | 1 | 111 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T05:01:02+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
