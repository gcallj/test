...
_Generated: 2026-05-24T06:54:33+00:00_
...
- Total sweeps seen: **1023**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **11.6%** (over 1047 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 173 | 0 | 0 | 0 |
| `vote_threshold_long` | 171 | 0 | 0 | 0 |
| `score_strength_scaling` | 171 | 0 | 0 | 0 |
| `min_signal_strength` | 170 | 0 | 0 | 0 |
| `entry_confirmation_days` | 169 | 0 | 0 | 0 |
| `volume_confirm_mode` | 169 | 0 | 1 | 0 |
| `stop_atr_mult` | 169 | 0 | 0 | 0 |
| `ma_filter_period` | 169 | 0 | 1 | 0 |
| `vote_threshold_short` | 168 | 0 | 1 | 0 |
| `time_stop_bars` | 168 | 0 | 0 | 0 |
| `z_threshold` | 167 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 167 | 0 | 0 | 0 |
| `entry_aggressiveness` | 150 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 179 | 12% | 1 |
| `score_percentile_trigger` | 20 | 173 | 12% | 0 |
| `momentum_confirm_days` | 18 | 174 | 10% | 0 |
| `partial_take_level` | 8 | 180 | 4% | 1 |
| `signal_ema_span` | 7 | 172 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 171 | 4% | 0 |
| `entry_score_threshold` | 6 | 182 | 3% | 0 |
| `regime_threshold` | 6 | 189 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 168 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 179 | 3% | 0 |
| `ma_filter_mode` | 5 | 179 | 3% | 0 |
| `partial_take_pct` | 4 | 173 | 2% | 0 |
| `support_broken_gate` | 2 | 148 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 168 | 1% | 0 |
| `trailing_stop_mode` | 2 | 170 | 1% | 0 |
| `partial_take_pct_2` | 2 | 172 | 1% | 0 |
| `stop_tighten_factor` | 2 | 174 | 1% | 0 |
| `partial_take_level_2` | 2 | 175 | 1% | 0 |
| `resistance_overext_gate` | 1 | 148 | 1% | 0 |
| `vol_regime_mode` | 1 | 171 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-24T06:54:32+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
