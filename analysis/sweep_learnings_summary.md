...
_Generated: 2026-06-05T00:09:46+00:00_
...
- Total sweeps seen: **1263**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.4%** (over 1287 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 213 | 0 | 0 | 0 |
| `vote_threshold_long` | 211 | 0 | 0 | 0 |
| `score_strength_scaling` | 211 | 0 | 0 | 0 |
| `min_signal_strength` | 210 | 0 | 0 | 0 |
| `stop_atr_mult` | 209 | 0 | 0 | 0 |
| `entry_confirmation_days` | 209 | 0 | 0 | 0 |
| `volume_confirm_mode` | 209 | 0 | 1 | 0 |
| `ma_filter_period` | 209 | 0 | 1 | 0 |
| `time_stop_bars` | 208 | 0 | 0 | 0 |
| `vote_threshold_short` | 208 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 207 | 0 | 0 | 0 |
| `z_threshold` | 207 | 0 | 0 | 0 |
| `entry_aggressiveness` | 190 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 219 | 10% | 1 |
| `score_percentile_trigger` | 20 | 213 | 9% | 0 |
| `momentum_confirm_days` | 18 | 214 | 8% | 0 |
| `partial_take_level` | 8 | 220 | 4% | 1 |
| `signal_ema_span` | 7 | 212 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 211 | 3% | 0 |
| `entry_score_threshold` | 6 | 222 | 3% | 0 |
| `regime_threshold` | 6 | 229 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 208 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 219 | 2% | 0 |
| `ma_filter_mode` | 5 | 219 | 2% | 0 |
| `partial_take_pct` | 4 | 213 | 2% | 0 |
| `support_broken_gate` | 2 | 188 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 208 | 1% | 0 |
| `trailing_stop_mode` | 2 | 210 | 1% | 0 |
| `partial_take_pct_2` | 2 | 212 | 1% | 0 |
| `stop_tighten_factor` | 2 | 214 | 1% | 0 |
| `partial_take_level_2` | 2 | 215 | 1% | 0 |
| `resistance_overext_gate` | 1 | 188 | 1% | 0 |
| `vol_regime_mode` | 1 | 211 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-05T00:09:45+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
