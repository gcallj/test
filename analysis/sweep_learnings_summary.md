...
_Generated: 2026-05-21T03:37:20+00:00_
...
- Total sweeps seen: **659**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **17.7%** (over 683 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 112 | 0 | 0 | 0 |
| `vote_threshold_long` | 110 | 0 | 0 | 0 |
| `score_strength_scaling` | 110 | 0 | 0 | 0 |
| `min_signal_strength` | 109 | 0 | 0 | 0 |
| `stop_atr_mult` | 109 | 0 | 0 | 0 |
| `entry_confirmation_days` | 108 | 0 | 0 | 0 |
| `volume_confirm_mode` | 108 | 0 | 1 | 0 |
| `time_stop_bars` | 108 | 0 | 0 | 0 |
| `ma_filter_period` | 108 | 0 | 1 | 0 |
| `vote_threshold_short` | 107 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 107 | 0 | 0 | 0 |
| `z_threshold` | 106 | 0 | 0 | 0 |
| `entry_aggressiveness` | 89 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 119 | 18% | 1 |
| `score_percentile_trigger` | 20 | 112 | 18% | 0 |
| `momentum_confirm_days` | 18 | 113 | 16% | 0 |
| `partial_take_level` | 8 | 119 | 7% | 1 |
| `signal_ema_span` | 7 | 111 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 111 | 5% | 0 |
| `entry_score_threshold` | 6 | 121 | 5% | 0 |
| `regime_threshold` | 6 | 128 | 5% | 1 |
| `equity_drawdown_stop_pct` | 5 | 108 | 5% | 0 |
| `volatility_filter_percentile` | 5 | 118 | 4% | 0 |
| `ma_filter_mode` | 5 | 118 | 4% | 0 |
| `partial_take_pct` | 4 | 112 | 4% | 0 |
| `support_broken_gate` | 2 | 87 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 107 | 2% | 0 |
| `trailing_stop_mode` | 2 | 109 | 2% | 0 |
| `partial_take_pct_2` | 2 | 111 | 2% | 0 |
| `stop_tighten_factor` | 2 | 114 | 2% | 0 |
| `partial_take_level_2` | 2 | 114 | 2% | 0 |
| `resistance_overext_gate` | 1 | 87 | 1% | 0 |
| `vol_regime_mode` | 1 | 110 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T03:37:20+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
