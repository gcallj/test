...
_Generated: 2026-07-17T12:14:57+00:00_
...
- Total sweeps seen: **1464**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.1%** (over 1488 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 247 | 0 | 0 | 0 |
| `vote_threshold_long` | 245 | 0 | 0 | 0 |
| `score_strength_scaling` | 245 | 0 | 0 | 0 |
| `min_signal_strength` | 244 | 0 | 0 | 0 |
| `volume_confirm_mode` | 243 | 0 | 1 | 0 |
| `entry_confirmation_days` | 243 | 0 | 0 | 0 |
| `ma_filter_period` | 243 | 0 | 1 | 0 |
| `vote_threshold_short` | 242 | 0 | 1 | 0 |
| `stop_atr_mult` | 241 | 0 | 0 | 0 |
| `time_stop_bars` | 241 | 0 | 0 | 0 |
| `z_threshold` | 241 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 239 | 0 | 0 | 0 |
| `entry_aggressiveness` | 224 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 252 | 8% | 1 |
| `score_percentile_trigger` | 20 | 247 | 8% | 0 |
| `momentum_confirm_days` | 18 | 248 | 7% | 0 |
| `partial_take_level` | 8 | 254 | 3% | 1 |
| `signal_ema_span` | 7 | 246 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 243 | 2% | 0 |
| `entry_score_threshold` | 6 | 256 | 2% | 0 |
| `regime_threshold` | 6 | 263 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 240 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 253 | 2% | 0 |
| `ma_filter_mode` | 5 | 253 | 2% | 0 |
| `partial_take_pct` | 4 | 247 | 2% | 0 |
| `support_broken_gate` | 2 | 222 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 242 | 1% | 0 |
| `trailing_stop_mode` | 2 | 244 | 1% | 0 |
| `stop_tighten_factor` | 2 | 246 | 1% | 0 |
| `partial_take_pct_2` | 2 | 246 | 1% | 0 |
| `partial_take_level_2` | 2 | 249 | 1% | 0 |
| `resistance_overext_gate` | 1 | 222 | 0% | 0 |
| `vol_regime_mode` | 1 | 245 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-07-17T12:14:56+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
