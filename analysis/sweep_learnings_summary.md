...
_Generated: 2026-05-23T17:43:10+00:00_
...
- Total sweeps seen: **975**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.1%** (over 999 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 165 | 0 | 0 | 0 |
| `vote_threshold_long` | 163 | 0 | 0 | 0 |
| `score_strength_scaling` | 163 | 0 | 0 | 0 |
| `min_signal_strength` | 162 | 0 | 0 | 0 |
| `volume_confirm_mode` | 161 | 0 | 1 | 0 |
| `stop_atr_mult` | 161 | 0 | 0 | 0 |
| `entry_confirmation_days` | 161 | 0 | 0 | 0 |
| `ma_filter_period` | 161 | 0 | 1 | 0 |
| `time_stop_bars` | 160 | 0 | 0 | 0 |
| `vote_threshold_short` | 160 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 159 | 0 | 0 | 0 |
| `z_threshold` | 159 | 0 | 0 | 0 |
| `entry_aggressiveness` | 142 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 171 | 12% | 1 |
| `score_percentile_trigger` | 20 | 165 | 12% | 0 |
| `momentum_confirm_days` | 18 | 166 | 11% | 0 |
| `partial_take_level` | 8 | 172 | 5% | 1 |
| `signal_ema_span` | 7 | 164 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 163 | 4% | 0 |
| `entry_score_threshold` | 6 | 174 | 3% | 0 |
| `regime_threshold` | 6 | 181 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 160 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 171 | 3% | 0 |
| `ma_filter_mode` | 5 | 171 | 3% | 0 |
| `partial_take_pct` | 4 | 165 | 2% | 0 |
| `support_broken_gate` | 2 | 140 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 160 | 1% | 0 |
| `trailing_stop_mode` | 2 | 162 | 1% | 0 |
| `partial_take_pct_2` | 2 | 164 | 1% | 0 |
| `stop_tighten_factor` | 2 | 166 | 1% | 0 |
| `partial_take_level_2` | 2 | 167 | 1% | 0 |
| `resistance_overext_gate` | 1 | 140 | 1% | 0 |
| `vol_regime_mode` | 1 | 163 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T17:43:09+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
