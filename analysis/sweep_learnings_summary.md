...
_Generated: 2026-08-08T13:42:13+00:00_
...
- Total sweeps seen: **1556**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.7%** (over 1580 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 262 | 0 | 0 | 0 |
| `vote_threshold_long` | 261 | 0 | 0 | 0 |
| `score_strength_scaling` | 261 | 0 | 0 | 0 |
| `min_signal_strength` | 260 | 0 | 0 | 0 |
| `entry_confirmation_days` | 259 | 0 | 0 | 0 |
| `volume_confirm_mode` | 258 | 0 | 1 | 0 |
| `vote_threshold_short` | 258 | 0 | 1 | 0 |
| `ma_filter_period` | 258 | 0 | 1 | 0 |
| `time_stop_bars` | 257 | 0 | 0 | 0 |
| `z_threshold` | 257 | 0 | 0 | 0 |
| `stop_atr_mult` | 256 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 254 | 0 | 0 | 0 |
| `entry_aggressiveness` | 240 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 268 | 8% | 1 |
| `score_percentile_trigger` | 20 | 263 | 8% | 0 |
| `momentum_confirm_days` | 18 | 263 | 7% | 0 |
| `partial_take_level` | 8 | 269 | 3% | 1 |
| `signal_ema_span` | 7 | 262 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 258 | 2% | 0 |
| `entry_score_threshold` | 6 | 272 | 2% | 0 |
| `regime_threshold` | 6 | 278 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 255 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 268 | 2% | 0 |
| `ma_filter_mode` | 5 | 268 | 2% | 0 |
| `partial_take_pct` | 4 | 262 | 2% | 0 |
| `support_broken_gate` | 2 | 237 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 258 | 1% | 0 |
| `trailing_stop_mode` | 2 | 259 | 1% | 0 |
| `stop_tighten_factor` | 2 | 261 | 1% | 0 |
| `partial_take_pct_2` | 2 | 261 | 1% | 0 |
| `partial_take_level_2` | 2 | 264 | 1% | 0 |
| `resistance_overext_gate` | 1 | 237 | 0% | 0 |
| `vol_regime_mode` | 1 | 260 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-08-08T13:42:12+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
