...
_Generated: 2026-06-13T07:50:17+00:00_
...
- Total sweeps seen: **1321**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.0%** (over 1345 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 223 | 0 | 0 | 0 |
| `vote_threshold_long` | 221 | 0 | 0 | 0 |
| `score_strength_scaling` | 221 | 0 | 0 | 0 |
| `min_signal_strength` | 220 | 0 | 0 | 0 |
| `entry_confirmation_days` | 219 | 0 | 0 | 0 |
| `volume_confirm_mode` | 219 | 0 | 1 | 0 |
| `ma_filter_period` | 219 | 0 | 1 | 0 |
| `stop_atr_mult` | 218 | 0 | 0 | 0 |
| `vote_threshold_short` | 218 | 0 | 1 | 0 |
| `time_stop_bars` | 217 | 0 | 0 | 0 |
| `z_threshold` | 217 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 216 | 0 | 0 | 0 |
| `entry_aggressiveness` | 200 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 228 | 9% | 1 |
| `score_percentile_trigger` | 20 | 223 | 9% | 0 |
| `momentum_confirm_days` | 18 | 224 | 8% | 0 |
| `partial_take_level` | 8 | 230 | 3% | 1 |
| `signal_ema_span` | 7 | 222 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 220 | 3% | 0 |
| `entry_score_threshold` | 6 | 232 | 3% | 0 |
| `regime_threshold` | 6 | 239 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 217 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 229 | 2% | 0 |
| `ma_filter_mode` | 5 | 229 | 2% | 0 |
| `partial_take_pct` | 4 | 223 | 2% | 0 |
| `support_broken_gate` | 2 | 198 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 218 | 1% | 0 |
| `trailing_stop_mode` | 2 | 220 | 1% | 0 |
| `partial_take_pct_2` | 2 | 222 | 1% | 0 |
| `stop_tighten_factor` | 2 | 223 | 1% | 0 |
| `partial_take_level_2` | 2 | 225 | 1% | 0 |
| `resistance_overext_gate` | 1 | 198 | 1% | 0 |
| `vol_regime_mode` | 1 | 221 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-13T07:50:16+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
