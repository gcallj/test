...
_Generated: 2026-06-22T01:26:18+00:00_
...
- Total sweeps seen: **1369**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.7%** (over 1393 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 231 | 0 | 0 | 0 |
| `score_strength_scaling` | 229 | 0 | 0 | 0 |
| `vote_threshold_long` | 229 | 0 | 0 | 0 |
| `min_signal_strength` | 228 | 0 | 0 | 0 |
| `volume_confirm_mode` | 227 | 0 | 1 | 0 |
| `entry_confirmation_days` | 227 | 0 | 0 | 0 |
| `ma_filter_period` | 227 | 0 | 1 | 0 |
| `stop_atr_mult` | 226 | 0 | 0 | 0 |
| `vote_threshold_short` | 226 | 0 | 1 | 0 |
| `time_stop_bars` | 225 | 0 | 0 | 0 |
| `z_threshold` | 225 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 224 | 0 | 0 | 0 |
| `entry_aggressiveness` | 208 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 236 | 9% | 1 |
| `score_percentile_trigger` | 20 | 231 | 9% | 0 |
| `momentum_confirm_days` | 18 | 232 | 8% | 0 |
| `partial_take_level` | 8 | 238 | 3% | 1 |
| `signal_ema_span` | 7 | 230 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 228 | 3% | 0 |
| `entry_score_threshold` | 6 | 240 | 2% | 0 |
| `regime_threshold` | 6 | 247 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 225 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 237 | 2% | 0 |
| `ma_filter_mode` | 5 | 237 | 2% | 0 |
| `partial_take_pct` | 4 | 231 | 2% | 0 |
| `support_broken_gate` | 2 | 206 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 226 | 1% | 0 |
| `trailing_stop_mode` | 2 | 228 | 1% | 0 |
| `partial_take_pct_2` | 2 | 230 | 1% | 0 |
| `stop_tighten_factor` | 2 | 231 | 1% | 0 |
| `partial_take_level_2` | 2 | 233 | 1% | 0 |
| `resistance_overext_gate` | 1 | 206 | 0% | 0 |
| `vol_regime_mode` | 1 | 229 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-22T01:26:17+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
