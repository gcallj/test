...
_Generated: 2026-07-26T23:40:15+00:00_
...
- Total sweeps seen: **1514**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **7.9%** (over 1538 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 255 | 0 | 0 | 0 |
| `vote_threshold_long` | 254 | 0 | 0 | 0 |
| `score_strength_scaling` | 254 | 0 | 0 | 0 |
| `min_signal_strength` | 253 | 0 | 0 | 0 |
| `entry_confirmation_days` | 252 | 0 | 0 | 0 |
| `volume_confirm_mode` | 251 | 0 | 1 | 0 |
| `vote_threshold_short` | 251 | 0 | 1 | 0 |
| `ma_filter_period` | 251 | 0 | 1 | 0 |
| `time_stop_bars` | 250 | 0 | 0 | 0 |
| `z_threshold` | 250 | 0 | 0 | 0 |
| `stop_atr_mult` | 249 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 247 | 0 | 0 | 0 |
| `entry_aggressiveness` | 233 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 261 | 8% | 1 |
| `score_percentile_trigger` | 20 | 256 | 8% | 0 |
| `momentum_confirm_days` | 18 | 256 | 7% | 0 |
| `partial_take_level` | 8 | 262 | 3% | 1 |
| `signal_ema_span` | 7 | 255 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 251 | 2% | 0 |
| `entry_score_threshold` | 6 | 265 | 2% | 0 |
| `regime_threshold` | 6 | 271 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 248 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 261 | 2% | 0 |
| `ma_filter_mode` | 5 | 261 | 2% | 0 |
| `partial_take_pct` | 4 | 255 | 2% | 0 |
| `support_broken_gate` | 2 | 230 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 251 | 1% | 0 |
| `trailing_stop_mode` | 2 | 252 | 1% | 0 |
| `stop_tighten_factor` | 2 | 254 | 1% | 0 |
| `partial_take_pct_2` | 2 | 254 | 1% | 0 |
| `partial_take_level_2` | 2 | 257 | 1% | 0 |
| `resistance_overext_gate` | 1 | 230 | 0% | 0 |
| `vol_regime_mode` | 1 | 253 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-07-26T23:40:14+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
