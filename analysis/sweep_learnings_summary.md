...
_Generated: 2026-05-07T13:52:48+00:00_
...
- Total sweeps seen: **293**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **38.2%** (over 317 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 51 | 0 | 0 | 0 |
| `score_strength_scaling` | 49 | 0 | 0 | 0 |
| `vote_threshold_long` | 49 | 0 | 0 | 0 |
| `stop_atr_mult` | 48 | 0 | 0 | 0 |
| `min_signal_strength` | 48 | 0 | 0 | 0 |
| `time_stop_bars` | 47 | 0 | 0 | 0 |
| `volume_confirm_mode` | 47 | 0 | 1 | 0 |
| `entry_confirmation_days` | 47 | 0 | 0 | 0 |
| `ma_filter_period` | 47 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 46 | 0 | 0 | 0 |
| `vote_threshold_short` | 46 | 0 | 1 | 0 |
| `z_threshold` | 45 | 0 | 0 | 0 |
| `entry_aggressiveness` | 28 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 58 | 36% | 1 |
| `score_percentile_trigger` | 20 | 51 | 39% | 0 |
| `momentum_confirm_days` | 18 | 52 | 35% | 0 |
| `partial_take_level` | 8 | 58 | 14% | 1 |
| `signal_ema_span` | 7 | 50 | 14% | 0 |
| `max_loss_per_trade_pct` | 6 | 50 | 12% | 0 |
| `entry_score_threshold` | 6 | 60 | 10% | 0 |
| `regime_threshold` | 6 | 67 | 9% | 1 |
| `equity_drawdown_stop_pct` | 5 | 47 | 11% | 0 |
| `volatility_filter_percentile` | 5 | 57 | 9% | 0 |
| `ma_filter_mode` | 5 | 57 | 9% | 0 |
| `partial_take_pct` | 4 | 51 | 8% | 0 |
| `support_broken_gate` | 2 | 26 | 8% | 0 |
| `entry_discount_atr_frac` | 2 | 46 | 4% | 0 |
| `trailing_stop_mode` | 2 | 48 | 4% | 0 |
| `partial_take_pct_2` | 2 | 50 | 4% | 0 |
| `stop_tighten_factor` | 2 | 53 | 4% | 0 |
| `partial_take_level_2` | 2 | 53 | 4% | 0 |
| `resistance_overext_gate` | 1 | 26 | 4% | 0 |
| `vol_regime_mode` | 1 | 49 | 2% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-07T13:52:47+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
