...
_Generated: 2026-05-18T18:41:36+00:00_
...
- Total sweeps seen: **347**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **32.6%** (over 371 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 60 | 0 | 0 | 0 |
| `vote_threshold_long` | 58 | 0 | 0 | 0 |
| `score_strength_scaling` | 58 | 0 | 0 | 0 |
| `stop_atr_mult` | 57 | 0 | 0 | 0 |
| `min_signal_strength` | 57 | 0 | 0 | 0 |
| `time_stop_bars` | 56 | 0 | 0 | 0 |
| `entry_confirmation_days` | 56 | 0 | 0 | 0 |
| `volume_confirm_mode` | 56 | 0 | 1 | 0 |
| `ma_filter_period` | 56 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 55 | 0 | 0 | 0 |
| `vote_threshold_short` | 55 | 0 | 1 | 0 |
| `z_threshold` | 54 | 0 | 0 | 0 |
| `entry_aggressiveness` | 37 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 67 | 31% | 1 |
| `score_percentile_trigger` | 20 | 60 | 33% | 0 |
| `momentum_confirm_days` | 18 | 61 | 30% | 0 |
| `partial_take_level` | 8 | 67 | 12% | 1 |
| `signal_ema_span` | 7 | 59 | 12% | 0 |
| `max_loss_per_trade_pct` | 6 | 59 | 10% | 0 |
| `entry_score_threshold` | 6 | 69 | 9% | 0 |
| `regime_threshold` | 6 | 76 | 8% | 1 |
| `equity_drawdown_stop_pct` | 5 | 56 | 9% | 0 |
| `volatility_filter_percentile` | 5 | 66 | 8% | 0 |
| `ma_filter_mode` | 5 | 66 | 8% | 0 |
| `partial_take_pct` | 4 | 60 | 7% | 0 |
| `support_broken_gate` | 2 | 35 | 6% | 0 |
| `entry_discount_atr_frac` | 2 | 55 | 4% | 0 |
| `trailing_stop_mode` | 2 | 57 | 4% | 0 |
| `partial_take_pct_2` | 2 | 59 | 3% | 0 |
| `stop_tighten_factor` | 2 | 62 | 3% | 0 |
| `partial_take_level_2` | 2 | 62 | 3% | 0 |
| `resistance_overext_gate` | 1 | 35 | 3% | 0 |
| `vol_regime_mode` | 1 | 58 | 2% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-18T18:41:36+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
