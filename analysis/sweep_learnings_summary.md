...
_Generated: 2026-06-15T16:29:32+00:00_
...
- Total sweeps seen: **1339**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **8.9%** (over 1363 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 226 | 0 | 0 | 0 |
| `vote_threshold_long` | 224 | 0 | 0 | 0 |
| `score_strength_scaling` | 224 | 0 | 0 | 0 |
| `min_signal_strength` | 223 | 0 | 0 | 0 |
| `entry_confirmation_days` | 222 | 0 | 0 | 0 |
| `volume_confirm_mode` | 222 | 0 | 1 | 0 |
| `ma_filter_period` | 222 | 0 | 1 | 0 |
| `stop_atr_mult` | 221 | 0 | 0 | 0 |
| `vote_threshold_short` | 221 | 0 | 1 | 0 |
| `time_stop_bars` | 220 | 0 | 0 | 0 |
| `z_threshold` | 220 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 219 | 0 | 0 | 0 |
| `entry_aggressiveness` | 203 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 231 | 9% | 1 |
| `score_percentile_trigger` | 20 | 226 | 9% | 0 |
| `momentum_confirm_days` | 18 | 227 | 8% | 0 |
| `partial_take_level` | 8 | 233 | 3% | 1 |
| `signal_ema_span` | 7 | 225 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 223 | 3% | 0 |
| `entry_score_threshold` | 6 | 235 | 3% | 0 |
| `regime_threshold` | 6 | 242 | 2% | 1 |
| `equity_drawdown_stop_pct` | 5 | 220 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 232 | 2% | 0 |
| `ma_filter_mode` | 5 | 232 | 2% | 0 |
| `partial_take_pct` | 4 | 226 | 2% | 0 |
| `support_broken_gate` | 2 | 201 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 221 | 1% | 0 |
| `trailing_stop_mode` | 2 | 223 | 1% | 0 |
| `partial_take_pct_2` | 2 | 225 | 1% | 0 |
| `stop_tighten_factor` | 2 | 226 | 1% | 0 |
| `partial_take_level_2` | 2 | 228 | 1% | 0 |
| `resistance_overext_gate` | 1 | 201 | 0% | 0 |
| `vol_regime_mode` | 1 | 224 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-15T16:29:31+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
