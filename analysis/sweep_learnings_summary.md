...
_Generated: 2026-05-23T09:57:55+00:00_
...
- Total sweeps seen: **935**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **12.6%** (over 959 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 158 | 0 | 0 | 0 |
| `vote_threshold_long` | 156 | 0 | 0 | 0 |
| `score_strength_scaling` | 156 | 0 | 0 | 0 |
| `min_signal_strength` | 155 | 0 | 0 | 0 |
| `stop_atr_mult` | 155 | 0 | 0 | 0 |
| `entry_confirmation_days` | 154 | 0 | 0 | 0 |
| `volume_confirm_mode` | 154 | 0 | 1 | 0 |
| `time_stop_bars` | 154 | 0 | 0 | 0 |
| `ma_filter_period` | 154 | 0 | 1 | 0 |
| `vote_threshold_short` | 153 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 153 | 0 | 0 | 0 |
| `z_threshold` | 152 | 0 | 0 | 0 |
| `entry_aggressiveness` | 135 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 165 | 13% | 1 |
| `score_percentile_trigger` | 20 | 158 | 13% | 0 |
| `momentum_confirm_days` | 18 | 159 | 11% | 0 |
| `partial_take_level` | 8 | 165 | 5% | 1 |
| `signal_ema_span` | 7 | 157 | 4% | 0 |
| `max_loss_per_trade_pct` | 6 | 157 | 4% | 0 |
| `entry_score_threshold` | 6 | 167 | 4% | 0 |
| `regime_threshold` | 6 | 174 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 154 | 3% | 0 |
| `volatility_filter_percentile` | 5 | 164 | 3% | 0 |
| `ma_filter_mode` | 5 | 164 | 3% | 0 |
| `partial_take_pct` | 4 | 158 | 3% | 0 |
| `support_broken_gate` | 2 | 133 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 153 | 1% | 0 |
| `trailing_stop_mode` | 2 | 155 | 1% | 0 |
| `partial_take_pct_2` | 2 | 157 | 1% | 0 |
| `stop_tighten_factor` | 2 | 160 | 1% | 0 |
| `partial_take_level_2` | 2 | 160 | 1% | 0 |
| `resistance_overext_gate` | 1 | 133 | 1% | 0 |
| `vol_regime_mode` | 1 | 156 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-23T09:57:54+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
