...
_Generated: 2026-05-21T18:19:55+00:00_
...
- Total sweeps seen: **725**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **16.2%** (over 749 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 123 | 0 | 0 | 0 |
| `vote_threshold_long` | 121 | 0 | 0 | 0 |
| `score_strength_scaling` | 121 | 0 | 0 | 0 |
| `stop_atr_mult` | 120 | 0 | 0 | 0 |
| `min_signal_strength` | 120 | 0 | 0 | 0 |
| `time_stop_bars` | 119 | 0 | 0 | 0 |
| `entry_confirmation_days` | 119 | 0 | 0 | 0 |
| `volume_confirm_mode` | 119 | 0 | 1 | 0 |
| `ma_filter_period` | 119 | 0 | 1 | 0 |
| `stop_tighten_after_bars` | 118 | 0 | 0 | 0 |
| `vote_threshold_short` | 118 | 0 | 1 | 0 |
| `z_threshold` | 117 | 0 | 0 | 0 |
| `entry_aggressiveness` | 100 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 130 | 16% | 1 |
| `score_percentile_trigger` | 20 | 123 | 16% | 0 |
| `momentum_confirm_days` | 18 | 124 | 15% | 0 |
| `partial_take_level` | 8 | 130 | 6% | 1 |
| `signal_ema_span` | 7 | 122 | 6% | 0 |
| `max_loss_per_trade_pct` | 6 | 122 | 5% | 0 |
| `entry_score_threshold` | 6 | 132 | 5% | 0 |
| `regime_threshold` | 6 | 139 | 4% | 1 |
| `equity_drawdown_stop_pct` | 5 | 119 | 4% | 0 |
| `volatility_filter_percentile` | 5 | 129 | 4% | 0 |
| `ma_filter_mode` | 5 | 129 | 4% | 0 |
| `partial_take_pct` | 4 | 123 | 3% | 0 |
| `support_broken_gate` | 2 | 98 | 2% | 0 |
| `entry_discount_atr_frac` | 2 | 118 | 2% | 0 |
| `trailing_stop_mode` | 2 | 120 | 2% | 0 |
| `partial_take_pct_2` | 2 | 122 | 2% | 0 |
| `stop_tighten_factor` | 2 | 125 | 2% | 0 |
| `partial_take_level_2` | 2 | 125 | 2% | 0 |
| `resistance_overext_gate` | 1 | 98 | 1% | 0 |
| `vol_regime_mode` | 1 | 121 | 1% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-05-21T18:19:55+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
