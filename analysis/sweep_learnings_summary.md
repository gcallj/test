...
_Generated: 2026-06-06T17:49:48+00:00_
...
- Total sweeps seen: **1281**
- Total promotions: **121** (including 1 from codex log)
- Promotion rate: **9.3%** (over 1305 total attempts)
...
|---|---:|---:|---:|---:|
| `reward_risk_ratio` | 216 | 0 | 0 | 0 |
| `vote_threshold_long` | 214 | 0 | 0 | 0 |
| `score_strength_scaling` | 214 | 0 | 0 | 0 |
| `min_signal_strength` | 213 | 0 | 0 | 0 |
| `entry_confirmation_days` | 212 | 0 | 0 | 0 |
| `stop_atr_mult` | 212 | 0 | 0 | 0 |
| `volume_confirm_mode` | 212 | 0 | 1 | 0 |
| `ma_filter_period` | 212 | 0 | 1 | 0 |
| `vote_threshold_short` | 211 | 0 | 1 | 0 |
| `time_stop_bars` | 211 | 0 | 0 | 0 |
| `z_threshold` | 210 | 0 | 0 | 0 |
| `stop_tighten_after_bars` | 210 | 0 | 0 | 0 |
| `entry_aggressiveness` | 193 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|
| `consecutive_loss_cooldown` | 21 | 222 | 9% | 1 |
| `score_percentile_trigger` | 20 | 216 | 9% | 0 |
| `momentum_confirm_days` | 18 | 217 | 8% | 0 |
| `partial_take_level` | 8 | 223 | 4% | 1 |
| `signal_ema_span` | 7 | 215 | 3% | 0 |
| `max_loss_per_trade_pct` | 6 | 214 | 3% | 0 |
| `entry_score_threshold` | 6 | 225 | 3% | 0 |
| `regime_threshold` | 6 | 232 | 3% | 1 |
| `equity_drawdown_stop_pct` | 5 | 211 | 2% | 0 |
| `volatility_filter_percentile` | 5 | 222 | 2% | 0 |
| `ma_filter_mode` | 5 | 222 | 2% | 0 |
| `partial_take_pct` | 4 | 216 | 2% | 0 |
| `support_broken_gate` | 2 | 191 | 1% | 0 |
| `entry_discount_atr_frac` | 2 | 211 | 1% | 0 |
| `trailing_stop_mode` | 2 | 213 | 1% | 0 |
| `partial_take_pct_2` | 2 | 215 | 1% | 0 |
| `stop_tighten_factor` | 2 | 217 | 1% | 0 |
| `partial_take_level_2` | 2 | 218 | 1% | 0 |
| `resistance_overext_gate` | 1 | 191 | 1% | 0 |
| `vol_regime_mode` | 1 | 214 | 0% | 0 |
...
Parsed `codex_attempts_source.md` at 2026-06-06T17:49:47+00:00. Total attempts: **24**, promoted: **11**. Updates via `python analysis/codex_attempts_sync.py` at the start of every continuous cycle (auto) or on demand.
