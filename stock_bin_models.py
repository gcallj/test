...
def run_bin_models():
    ...
    Original file is located at
        https://colab.research.google.com/drive/1nHoQhS96t1GjEOPiGGenApea8rrTtVCE
    """
    ...
    for tk in tqdm(tickers, desc="Building sampled LONG (low-ram)"):
        ...
        y_up = to_float32_safe(clean_binary_target(y_up_raw))
        y_dd = to_float32_safe(clean_binary_target(y_dd_raw))
    ...
    if need_train:
        ...
        HIST_SAVE = True
        HIST_PATH = "./output/ensemble_signals_history_with_trust.parquet"
    ...
    if "lgbm" in RUN_MODELS and "buy__lgbm" in apply_df_display.columns and "proba_target_up20__lgbm" in apply_df_display.columns and "proba_target_dd5__lgbm" in apply_df_display.columns:
    ...
    # %%colab
    RUN_NOTEBOOK_EXTRA_ENSEMBLES = False
    ...
    MODEL_DIR = globals().get("MODEL_DIR", "./output/data/models")
    ...
    # SETTINGS (saídas)
    # =========================
    APPLY_SIGNALS_PATH = "./output/apply_ensemble_signals.csv"
    APPLY_DEBUG_PATH   = "./output/apply_ensemble_signals_debug.csv"
    HIST_PATH          = "./output/ensemble_signals_history.parquet"
    ...
    def save_hist_out_minimal(hist_out: pd.DataFrame, out_path: str | Path):
        ...
        if out_path.suffix.lower() == ".parquet":
            df_min = normalize_before_save(df_min)
    ...
    import numpy as np
    import pandas as pd
    PATH = "./output/data/expanded_stock_reduced.parquet"
